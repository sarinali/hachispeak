...
var ort = (() => {
  ...
  var E = (a, t) => () => (a && (t = a((a = 0))), t);
  var me = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports),
    sr = (a, t) => {
      for (var o in t) Dn(a, o, { get: t[o], enumerable: !0 });
    },
    qa = (a, t, o, e) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let r of Pd(t))
          !Dd.call(a, r) &&
            r !== o &&
            Dn(a, r, { get: () => t[r], enumerable: !(e = Ad(t, r)) || e.enumerable });
      return a;
    };
  var Dr = (a, t, o) => (
      (o = a != null ? Sd(Ed(a)) : {}),
      qa(t || !a || !a.__esModule ? Dn(o, "default", { value: a, enumerable: !0 }) : o, a)
    ),
    jt = (a) => qa(Dn({}, "__esModule", { value: !0 }), a);
  var Ln,
    ur,
    lr,
    Ld,
      ...
      (Ln = new Map()),
        ...
        (lr = (a, t, o) => {
          if (
            ...
            let e = Ln.get(a);
            if (e === void 0) Ln.set(a, { backend: t, priority: o });
            else {
        ...
        (Fn = async (a) => {
          ...
          if (!r)
            throw new Error(
              `no available backend found. ERR: ${n.map((u) => `[${u.name}] ${u.err}`).join(", ")}`
            );
          ...
          return [
            r,
            new Proxy(a, { get: (u, l) => (l === "executionProviders" ? i : Reflect.get(u, l)) }),
          ];
        });
    });
  var ja = E(() => {
    ...
    es = E(() => {
      ...
      (Za = (a, t) => {
        ...
        if (e != null) {
          ...
          for (let w = 0; w < n; w++)
            for (let I = 0; I < r; I++) {
              let L = (a.data[p++] - l[0]) * u[0],
                F = (a.data[d++] - l[1]) * u[1],
                C = (a.data[T++] - l[2]) * u[2],
                Y = v === -1 ? 255 : (a.data[v++] - l[3]) * u[3];
              (e.fillStyle = "rgba(" + L + "," + F + "," + C + "," + Y + ")"),
                e.fillRect(I, w, 1, 1);
            }
        ...
        (Qa = (a, t) => {
          ...
          if (o != null) {
            ...
            for (let j = 0; j < n * r; T += d, v += d, w += d, I += d, j++)
              (e.data[T] = (a.data[L++] - f[0]) * l[0]),
                (e.data[v] = (a.data[F++] - f[1]) * l[1]),
                (e.data[w] = (a.data[C++] - f[2]) * l[2]),
                (e.data[I] = Y === -1 ? 255 : (a.data[Y++] - f[3]) * l[3]);
          } else throw new Error("Can not access image data");
          return e;
        });
    });
    ...
    is = E(() => {
      ...
      (qo = (a, t) => {
        ...
        let i = t.format !== void 0 ? t.format : "RGBA",
          ...
          F = l * 2,
          C = -1;
        i === "RGB" && ((p = 3), (d = 0), (T = 1), (v = 2), (w = -1)),
          u === "RGBA"
            ? (C = l * 3)
            : u === "RBG"
              ? ((I = 0), (F = l), (L = l * 2))
              : u === "BGR" && ((F = 0), (L = l), (I = l * 2));
        for (let j = 0; j < l; j++, d += p, v += p, T += p, w += p)
          (f[I++] = (a[d] + s[0]) / n[0]),
            (f[L++] = (a[T] + s[1]) / n[1]),
            (f[F++] = (a[v] + s[2]) / n[2]),
            C !== -1 && w !== -1 && (f[C++] = (a[w] + s[3]) / n[3]);
        return u === "RGBA"
          ? new Xe("float32", f, [1, 4, o, e])
          : new Xe("float32", f, [1, 3, o, e]);
      }),
        (ts = async (a, t) => {
          let o = typeof HTMLImageElement < "u" && a instanceof HTMLImageElement,
            ...
            l = (f) =>
              f instanceof HTMLCanvasElement || f instanceof OffscreenCanvas
                ? f.getContext("2d")
                : null;
          if (o) {
            let f = u();
            ...
            if (
              (t !== void 0 && t.resizedWidth !== void 0 && t.resizedHeight !== void 0
                ? ((f = t.resizedHeight), (p = t.resizedWidth))
                : ((f = a.height), (p = a.width)),
              t !== void 0 && (i = t),
              (i.format = "RGBA"),
              (i.height = f),
              (i.width = p),
              ...
              let T = l(d);
              if (T != null) T.putImageData(a, 0, 0), (s = T.getImageData(0, 0, p, f).data);
              else throw new Error("Can not access image data");
            } else s = a.data;
          } else if (r) {
            if (t === void 0)
              ...
              return new Promise((f, p) => {
                ...
                (v.crossOrigin = "Anonymous"),
                  ...
                  (v.onload = () => {
                    (d.width = v.width),
                      (d.height = v.height),
                      T.drawImage(v, 0, 0, d.width, d.height);
        ...
        (os = (a, t, o) =>
          new Xe({ location: "cpu-pinned", type: a, data: t, dims: o ?? [t.length] }));
    });
  var fr,
    tn,
    as,
      ...
      (fr = new Map([
        ...
        (ss = () => {
          if (!as) {
            ...
            a && (fr.set("int64", BigInt64Array), tn.set(BigInt64Array, "int64")),
              t && (fr.set("uint64", BigUint64Array), tn.set(BigUint64Array, "uint64")),
              o
                ? (fr.set("float16", Float16Array), tn.set(Float16Array, "float16"))
                : fr.set("float16", Uint16Array);
          }
        });
    });
  var ls,
    ...
    cs = E(() => {
      ...
      (ls = (a) => {
        ...
        (fs = (a, t) => {
          switch (a.location) {
            case "cpu":
              return new Xe(a.type, a.data, t);
            case "cpu-pinned":
              return new Xe({ location: "cpu-pinned", data: a.data, type: a.type, dims: t });
            case "texture":
              return new Xe({ location: "texture", texture: a.texture, type: a.type, dims: t });
            case "gpu-buffer":
              return new Xe({
                location: "gpu-buffer",
  ...
  var jo,
    ...
    Yo = E(() => {
      ...
      Ho();
      (jo = (a, t) => {
        (typeof it.trace > "u" ? !it.wasm.trace : !it.trace) ||
        ...
        (Yt = (a) => {
          (typeof it.trace > "u" ? !it.wasm.trace : !it.trace) || ps("BEGIN", a);
        }),
        (Xt = (a) => {
          (typeof it.trace > "u" ? !it.wasm.trace : !it.trace) || ps("END", a);
        });
    });
  var Bn,
    ds = E(() => {
      ...
      Bn = class a {
        ...
        async run(t, o, e) {
          ...
          let r = {},
            n = {};
          if (typeof t != "object" || t === null || t instanceof Be || Array.isArray(t))
            throw new TypeError(
          ...
          if (typeof o == "object") {
            ...
            if (o instanceof Be) throw new TypeError("'fetches' cannot be a Tensor");
            if (Array.isArray(o)) {
              ...
              for (let p of this.outputNames)
                if (f.indexOf(p) !== -1) {
                  let d = o[p];
                  (d === null || d instanceof Be) && ((l = !0), (s = !1), (r[p] = d));
                }
              if (l) {
                if (typeof e == "object" && e !== null) n = e;
                else if (typeof e < "u") throw new TypeError("'options' must be an object.");
          ...
          for (let l in i)
            if (Object.hasOwnProperty.call(i, l)) {
              let f = i[l];
              f instanceof Be ? (u[l] = f) : (u[l] = new Be(f.type, f.data, f.dims));
            }
          return Xt(), u;
        }
        async release() {
            ...
            if (typeof o == "object" && o !== null) s = o;
              ...
              if (((d = t.byteLength - p), typeof e == "number")) {
                ...
                if (d <= 0 || p + d > f.byteLength)
                  throw new RangeError(`'byteLength' is out of range (0, ${f.byteLength - p}].`);
      ...
      (Fd =
        ...
        (Nn = class a {
          ...
          static async create(t, o) {
            ...
            } else throw new Error(Fd);
          }
          typeNarrowingForRunStep(t, o, e, r, n) {
            let s = {},
              i = {};
            if (typeof e != "object" || e === null || e instanceof Be || Array.isArray(e))
              throw new TypeError(
                "'feeds' must be an object that use input names as keys and OnnxValue as corresponding values."
              );
            let u = !0;
            if (typeof r == "object") {
              ...
              if (r instanceof Be) throw new TypeError("'fetches' cannot be a Tensor");
              if (Array.isArray(r)) {
                ...
                for (let p of o)
                  if (f.indexOf(p) !== -1) {
                    let d = r[p];
                    (d === null || d instanceof Be) && ((l = !0), (u = !1), (s[p] = d));
                  }
                if (l) {
                  if (typeof n == "object" && n !== null) i = n;
                  else if (typeof n < "u") throw new TypeError("'options' must be an object.");
              ...
              throw new TypeError("Unexpected argument[1]: must be 'fetches' or 'options'.");
            for (let l of t)
              if (typeof e[l] > "u") throw new Error(`input '${l}' is missing in 'feeds'.`);
          ...
          convertHandlerReturnTypeToMapOfTensors(t) {
            ...
            for (let e in t)
              if (Object.hasOwnProperty.call(t, e)) {
                let r = t[e];
                r instanceof Be ? (o[e] = r) : (o[e] = new Be(r.type, r.data, r.dims));
              }
            return o;
          }
          async lazyResetGrad() {
  ...
  function Kt(a, t, o, e) {
    if (t === void 0) return $d(a);
    if (o === void 0) Rn(a, t, 1);
    else if (typeof o == "number" && e === void 0) Rn(a, t, o);
    else if (typeof o == "string" && e === void 0) Rn(a, o, 1, t);
    else if (typeof o == "string" && typeof e == "number") Rn(a, o, e, t);
    else throw new TypeError("input is valid");
  }
  function $d(a) {
    return {
      verbose: Kt.verbose.bind(null, a),
      info: Kt.info.bind(null, a),
      warning: Kt.warning.bind(null, a),
      error: Kt.error.bind(null, a),
      fatal: Kt.fatal.bind(null, a),
    };
  }
  function Rn(a, t, o, e) {
    let r = rn[e || ""] || rn[""];
  ...
  var Ko,
    ...
    at = E(() => {
      ...
      (Ko = class {
        ...
        (Os = { verbose: 1e3, info: 2e3, warning: 4e3, error: 5e3, fatal: 6e3 }),
        (Cd = { none: new Ko(), console: new Jo() }),
        (Is = {
          provider: "console",
        ...
        function s(l, f) {
          if (l === "*") n(f);
            ...
            rn[l] = {
              ...
              logSourceLocation:
                f.logSourceLocation === void 0 ? p.logSourceLocation : f.logSourceLocation,
            };
          }
        }
        u.set = s;
        ...
        (zn = class {
          ...
          async end(t) {
            ...
            this._timingEvents.length < this._maxNumberEvents &&
              (this._timingEvents.push(new Un(t.category, t.name, t.startTime, o)), this.flush(o));
          }
          endSync(t) {
            let o = Mn();
            this._timingEvents.length < this._maxNumberEvents &&
  ...
  function Ss(a, t, o) {
    for (let e of o) {
      ...
      if (a.opType === r) {
        for (let l of t)
          if ((l.domain === n || (l.domain === "ai.onnx" && n === "")) && kd(l.version, s))
            return { opImpl: i, opInit: u };
      }
    }
    throw new TypeError(
      `cannot resolve operator '${a.opType}' with opsets: ${t.map((e) => `${e.domain || "ai.onnx"} v${e.version}`).join(", ")}`
    );
  }
  function kd(a, t) {
    if (t.endsWith("+")) {
  ...
  function cr(a, t) {
    ...
    return t
      ? ((a >>>= 0),
        (r = 0 <= a && a < 256) && ((e = Ls[a]), e) ? e : ((o = le(a, 0, !0)), r && (Ls[a] = o), o))
      : ((a |= 0),
        (r = -128 <= a && a < 128) && ((e = Ds[a]), e)
          ? e
          : ((o = le(a, a < 0 ? -1 : 0, !1)), r && (Ds[a] = o), o));
  }
  function ut(a, t) {
    if (isNaN(a)) return t ? Vt : xt;
    if (t) {
      if (a < 0) return Vt;
      if (a >= ks) return Rs;
    } else {
    ...
    return a < 0 ? ut(-a, t).neg() : le(a % Fr | 0, (a / Fr) | 0, t);
  }
  function le(a, t, o) {
    return new be(a, t, o);
  }
  function ei(a, t, o) {
    ...
    if (e === 0) return ei(a.substring(1), t, o).neg();
    for (var r = ut(Vn(o, 8)), n = xt, s = 0; s < a.length; s += 8) {
    ...
    ti = E(() => {
      ...
      $.add = function (t) {
        ...
        return (
          ...
          (f += o + s),
          (f &= 65535),
          le((d << 16) | T, (f << 16) | p, this.unsigned)
        );
      };
      $.subtract = function (t) {
      ...
      $.multiply = function (t) {
        ...
        if (this.lt($s) && t.lt($s)) return ut(this.toNumber() * t.toNumber(), this.unsigned);
        var e = this.high >>> 16,
          r = this.high & 65535,
          n = this.low >>> 16,
          s = this.low & 65535,
        ...
        return (
          ...
          (p += e * f + r * l + n * u + s * i),
          (p &= 65535),
          le((T << 16) | v, (p << 16) | d, this.unsigned)
        );
      };
      $.mul = $.multiply;
      $.divide = function (t) {
        ...
        if (this.unsigned) {
          ...
          if (t.gt(this.shru(1))) return Bs;
          n = Vt;
        } else {
          if (this.eq(tt)) {
            if (t.eq(Lr) || t.eq(Qo)) return tt;
        ...
        for (r = this; r.gte(t); ) {
          ...
          for (
            ...
            (e -= u), (l = ut(e, this.unsigned)), (f = l.mul(t));
      ...
      $.shiftLeft = function (t) {
        return (
          ...
          (t &= 63) === 0
            ? this
            : t < 32
              ? le(this.low << t, (this.high << t) | (this.low >>> (32 - t)), this.unsigned)
      ...
      $.shiftRight = function (t) {
        return (
          ...
          (t &= 63) === 0
            ? this
            : t < 32
              ? le((this.low >>> t) | (this.high << (32 - t)), this.high >> t, this.unsigned)
  ...
  var O,
    Wn = E(() => {
      ...
      O.Long.create = function (a, t) {
        return a == 0 && t == 0 ? O.Long.ZERO : new O.Long(a, t);
      };
      O.Long.prototype.toFloat64 = function () {
        return (this.low >>> 0) + this.high * 4294967296;
      };
      O.Long.prototype.equals = function (a) {
        return this.low == a.low && this.high == a.high;
      };
      O.Long.ZERO = new O.Long(0, 0);
      O.Builder = function (a) {
        if (a) var t = a;
        else var t = 1024;
        (this.bb = O.ByteBuffer.allocate(t)),
          (this.space = t),
          (this.minalign = 1),
          (this.vtable = null),
      ...
      O.Builder.prototype.forceDefaults = function (a) {
      ...
      O.Builder.prototype.prep = function (a, t) {
      ...
      O.Builder.prototype.pad = function (a) {
        for (var t = 0; t < a; t++) this.bb.writeInt8(--this.space, 0);
      };
      O.Builder.prototype.writeInt8 = function (a) {
        this.bb.writeInt8((this.space -= 1), a);
      };
      O.Builder.prototype.writeInt16 = function (a) {
        this.bb.writeInt16((this.space -= 2), a);
      };
      O.Builder.prototype.writeInt32 = function (a) {
        this.bb.writeInt32((this.space -= 4), a);
      };
      O.Builder.prototype.writeInt64 = function (a) {
        this.bb.writeInt64((this.space -= 8), a);
      };
      O.Builder.prototype.writeFloat32 = function (a) {
        this.bb.writeFloat32((this.space -= 4), a);
      };
      O.Builder.prototype.writeFloat64 = function (a) {
        this.bb.writeFloat64((this.space -= 8), a);
      };
      O.Builder.prototype.addInt8 = function (a) {
        this.prep(1, 0), this.writeInt8(a);
      };
      O.Builder.prototype.addInt16 = function (a) {
        this.prep(2, 0), this.writeInt16(a);
      };
      O.Builder.prototype.addInt32 = function (a) {
        this.prep(4, 0), this.writeInt32(a);
      };
      O.Builder.prototype.addInt64 = function (a) {
        this.prep(8, 0), this.writeInt64(a);
      };
      O.Builder.prototype.addFloat32 = function (a) {
        this.prep(4, 0), this.writeFloat32(a);
      };
      O.Builder.prototype.addFloat64 = function (a) {
        this.prep(8, 0), this.writeFloat64(a);
      };
      O.Builder.prototype.addFieldInt8 = function (a, t, o) {
        (this.force_defaults || t != o) && (this.addInt8(t), this.slot(a));
      };
      O.Builder.prototype.addFieldInt16 = function (a, t, o) {
        (this.force_defaults || t != o) && (this.addInt16(t), this.slot(a));
      };
      O.Builder.prototype.addFieldInt32 = function (a, t, o) {
        (this.force_defaults || t != o) && (this.addInt32(t), this.slot(a));
      };
      O.Builder.prototype.addFieldInt64 = function (a, t, o) {
        (this.force_defaults || !t.equals(o)) && (this.addInt64(t), this.slot(a));
      };
      O.Builder.prototype.addFieldFloat32 = function (a, t, o) {
        (this.force_defaults || t != o) && (this.addFloat32(t), this.slot(a));
      };
      O.Builder.prototype.addFieldFloat64 = function (a, t, o) {
        (this.force_defaults || t != o) && (this.addFloat64(t), this.slot(a));
      };
      O.Builder.prototype.addFieldOffset = function (a, t, o) {
        (this.force_defaults || t != o) && (this.addOffset(t), this.slot(a));
      };
      O.Builder.prototype.addFieldStruct = function (a, t, o) {
        t != o && (this.nested(t), this.slot(a));
      };
      O.Builder.prototype.nested = function (a) {
      ...
      O.Builder.prototype.slot = function (a) {
        this.vtable[a] = this.offset();
      };
      O.Builder.prototype.offset = function () {
        return this.bb.capacity() - this.space;
      };
      O.Builder.growByteBuffer = function (a) {
        var t = a.capacity();
        if (t & 3221225472) throw new Error("FlatBuffers: cannot grow buffer beyond 2 gigabytes.");
        var o = t << 1,
          e = O.ByteBuffer.allocate(o);
        return e.setPosition(o - t), e.bytes().set(a.bytes(), o - t), e;
      };
      O.Builder.prototype.addOffset = function (a) {
        this.prep(O.SIZEOF_INT, 0), this.writeInt32(this.offset() - a + O.SIZEOF_INT);
      };
      O.Builder.prototype.startObject = function (a) {
      ...
      O.Builder.prototype.endObject = function () {
        ...
        e: for (t = 0; t < this.vtables.length; t++) {
          ...
          if (r == this.bb.readInt16(i)) {
            for (var u = O.SIZEOF_SHORT; u < r; u += O.SIZEOF_SHORT)
              if (this.bb.readInt16(s + u) != this.bb.readInt16(i + u)) continue e;
            n = this.vtables[t];
            break;
          }
        }
        return (
          n
            ? ((this.space = this.bb.capacity() - a), this.bb.writeInt32(this.space, n - a))
      ...
      O.Builder.prototype.finish = function (a, t, o) {
        var e = o ? O.SIZE_PREFIX_LENGTH : 0;
        if (t) {
          var r = t;
          if (
            (this.prep(this.minalign, O.SIZEOF_INT + O.FILE_IDENTIFIER_LENGTH + e),
            r.length != O.FILE_IDENTIFIER_LENGTH)
          )
            throw new Error(
              "FlatBuffers: file identifier must be length " + O.FILE_IDENTIFIER_LENGTH
            );
          for (var n = O.FILE_IDENTIFIER_LENGTH - 1; n >= 0; n--) this.writeInt8(r.charCodeAt(n));
        }
        this.prep(this.minalign, O.SIZEOF_INT + e),
          this.addOffset(a),
          e && this.addInt32(this.bb.capacity() - this.space),
          this.bb.setPosition(this.space);
      };
      O.Builder.prototype.finishSizePrefixed = function (a, t) {
        this.finish(a, t, !0);
      };
      O.Builder.prototype.requiredField = function (a, t) {
      ...
      O.Builder.prototype.startVector = function (a, t, o) {
        this.notNested(),
          (this.vector_num_elems = t),
          this.prep(O.SIZEOF_INT, a * t),
          this.prep(o, a * t);
      };
      O.Builder.prototype.endVector = function () {
        return this.writeInt32(this.vector_num_elems), this.offset();
      };
      O.Builder.prototype.createString = function (a) {
      ...
      O.Builder.prototype.createLong = function (a, t) {
        return O.Long.create(a, t);
      };
      O.ByteBuffer = function (a) {
        (this.bytes_ = a), (this.position_ = 0);
      };
      O.ByteBuffer.allocate = function (a) {
        return new O.ByteBuffer(new Uint8Array(a));
      };
      ...
      O.ByteBuffer.prototype.setPosition = function (a) {
        this.position_ = a;
      };
      O.ByteBuffer.prototype.capacity = function () {
        return this.bytes_.length;
      };
      O.ByteBuffer.prototype.readInt8 = function (a) {
        return (this.readUint8(a) << 24) >> 24;
      };
      O.ByteBuffer.prototype.readUint8 = function (a) {
        return this.bytes_[a];
      };
      O.ByteBuffer.prototype.readInt16 = function (a) {
        return (this.readUint16(a) << 16) >> 16;
      };
      O.ByteBuffer.prototype.readUint16 = function (a) {
        return this.bytes_[a] | (this.bytes_[a + 1] << 8);
      };
      O.ByteBuffer.prototype.readInt32 = function (a) {
        return (
          this.bytes_[a] |
          (this.bytes_[a + 1] << 8) |
          (this.bytes_[a + 2] << 16) |
      ...
      O.ByteBuffer.prototype.readUint32 = function (a) {
        return this.readInt32(a) >>> 0;
      };
      O.ByteBuffer.prototype.readInt64 = function (a) {
        return new O.Long(this.readInt32(a), this.readInt32(a + 4));
      };
      O.ByteBuffer.prototype.readUint64 = function (a) {
        return new O.Long(this.readUint32(a), this.readUint32(a + 4));
      };
      O.ByteBuffer.prototype.readFloat32 = function (a) {
        return (O.int32[0] = this.readInt32(a)), O.float32[0];
      };
      O.ByteBuffer.prototype.readFloat64 = function (a) {
        return (
          (O.int32[O.isLittleEndian ? 0 : 1] = this.readInt32(a)),
          (O.int32[O.isLittleEndian ? 1 : 0] = this.readInt32(a + 4)),
          O.float64[0]
        );
      };
      O.ByteBuffer.prototype.writeInt8 = function (a, t) {
        this.bytes_[a] = t;
      };
      O.ByteBuffer.prototype.writeUint8 = function (a, t) {
        this.bytes_[a] = t;
      };
      O.ByteBuffer.prototype.writeInt16 = function (a, t) {
        (this.bytes_[a] = t), (this.bytes_[a + 1] = t >> 8);
      };
      O.ByteBuffer.prototype.writeUint16 = function (a, t) {
        (this.bytes_[a] = t), (this.bytes_[a + 1] = t >> 8);
      };
      O.ByteBuffer.prototype.writeInt32 = function (a, t) {
        (this.bytes_[a] = t),
          (this.bytes_[a + 1] = t >> 8),
          (this.bytes_[a + 2] = t >> 16),
          (this.bytes_[a + 3] = t >> 24);
      };
      O.ByteBuffer.prototype.writeUint32 = function (a, t) {
        (this.bytes_[a] = t),
          (this.bytes_[a + 1] = t >> 8),
          (this.bytes_[a + 2] = t >> 16),
          (this.bytes_[a + 3] = t >> 24);
      };
      O.ByteBuffer.prototype.writeInt64 = function (a, t) {
        this.writeInt32(a, t.low), this.writeInt32(a + 4, t.high);
      };
      O.ByteBuffer.prototype.writeUint64 = function (a, t) {
        this.writeUint32(a, t.low), this.writeUint32(a + 4, t.high);
      };
      O.ByteBuffer.prototype.writeFloat32 = function (a, t) {
        (O.float32[0] = t), this.writeInt32(a, O.int32[0]);
      };
      O.ByteBuffer.prototype.writeFloat64 = function (a, t) {
        (O.float64[0] = t),
          this.writeInt32(a, O.int32[O.isLittleEndian ? 0 : 1]),
          this.writeInt32(a + 4, O.int32[O.isLittleEndian ? 1 : 0]);
      };
      O.ByteBuffer.prototype.getBufferIdentifier = function () {
        ...
        for (var a = "", t = 0; t < O.FILE_IDENTIFIER_LENGTH; t++)
          a += String.fromCharCode(this.readInt8(this.position_ + O.SIZEOF_INT + t));
        return a;
      };
      O.ByteBuffer.prototype.__offset = function (a, t) {
        var o = a - this.readInt32(a);
        return t < this.readInt16(o) ? this.readInt16(o + t) : 0;
      };
      O.ByteBuffer.prototype.__union = function (a, t) {
        return (a.bb_pos = t + this.readInt32(t)), (a.bb = this), a;
      };
      O.ByteBuffer.prototype.__string = function (a, t) {
        a += this.readInt32(a);
        var o = this.readInt32(a),
          e = "",
          r = 0;
        if (((a += O.SIZEOF_INT), t === O.Encoding.UTF8_BYTES))
        ...
        for (; r < o; ) {
          ...
          n < 65536
            ...
            : ((n -= 65536),
              (e += String.fromCharCode((n >> 10) + 55296, (n & (1024 - 1)) + 56320)));
        }
        return e;
      };
      O.ByteBuffer.prototype.__indirect = function (a) {
        return a + this.readInt32(a);
      };
      O.ByteBuffer.prototype.__vector = function (a) {
        return a + this.readInt32(a) + O.SIZEOF_INT;
      };
      O.ByteBuffer.prototype.__vector_len = function (a) {
        return this.readInt32(a + this.readInt32(a));
      };
      O.ByteBuffer.prototype.__has_identifier = function (a) {
        if (a.length != O.FILE_IDENTIFIER_LENGTH)
          throw new Error(
            "FlatBuffers: file identifier must be length " + O.FILE_IDENTIFIER_LENGTH
          );
        for (var t = 0; t < O.FILE_IDENTIFIER_LENGTH; t++)
          if (a.charCodeAt(t) != this.readInt8(this.position_ + O.SIZEOF_INT + t)) return !1;
        return !0;
      };
      O.ByteBuffer.prototype.createLong = function (a, t) {
        return O.Long.create(a, t);
      };
    });
  var W,
    nn = E(() => {
        ...
        ((e) => {
          ...
          ((n) => {
            ...
            ((C) => (
              ...
              (C[(C.FLOATS = 6)] = "FLOATS"),
              (C[(C.INTS = 7)] = "INTS"),
              (C[(C.STRINGS = 8)] = "STRINGS"),
              (C[(C.TENSORS = 9)] = "TENSORS"),
              (C[(C.GRAPHS = 10)] = "GRAPHS"),
              (C[(C.SPARSE_TENSOR = 11)] = "SPARSE_TENSOR"),
              (C[(C.SPARSE_TENSORS = 12)] = "SPARSE_TENSORS")
            ))((r = n.AttributeType ||= {}));
          })((o = e.fbs ||= {}));
        })((a = t.experimental ||= {}));
      })((W ||= {}));
        ...
        ((e) => {
          ...
          ((n) => {
            ...
            ((V) => (
              ...
              (V[(V.STRING = 8)] = "STRING"),
              (V[(V.BOOL = 9)] = "BOOL"),
              (V[(V.FLOAT16 = 10)] = "FLOAT16"),
              (V[(V.DOUBLE = 11)] = "DOUBLE"),
              (V[(V.UINT32 = 12)] = "UINT32"),
              (V[(V.UINT64 = 13)] = "UINT64"),
              (V[(V.COMPLEX64 = 14)] = "COMPLEX64"),
              (V[(V.COMPLEX128 = 15)] = "COMPLEX128"),
              (V[(V.BFLOAT16 = 16)] = "BFLOAT16"),
              (V[(V.FLOAT8E4M3FN = 17)] = "FLOAT8E4M3FN"),
              (V[(V.FLOAT8E4M3FNUZ = 18)] = "FLOAT8E4M3FNUZ"),
              (V[(V.FLOAT8E5M2 = 19)] = "FLOAT8E5M2"),
              (V[(V.FLOAT8E5M2FNUZ = 20)] = "FLOAT8E5M2FNUZ")
            ))((r = n.TensorDataType ||= {}));
          })((o = e.fbs ||= {}));
        })((a = t.experimental ||= {}));
      })((W ||= {}));
      ((t) => {
        ...
        ((e) => {
          ...
          ((n) => {
            let r;
            ((u) => ((u[(u.Primitive = 0)] = "Primitive"), (u[(u.Fused = 1)] = "Fused")))(
              (r = n.NodeType ||= {})
            );
          })((o = e.fbs ||= {}));
        })((a = t.experimental ||= {}));
          ...
          ((n) => {
            class r {
              ...
              static getSizePrefixedRootAsShape(i, u) {
                return (
                  i.setPosition(i.position() + O.SIZE_PREFIX_LENGTH),
                  (u || new r()).__init(i.readInt32(i.position()) + i.position(), i)
                );
              }
              dim(i, u) {
                ...
                return l
                  ? (u || new t.experimental.fbs.Dimension()).__init(
                      this.bb.__indirect(this.bb.__vector(this.bb_pos + l) + i * 4),
                      this.bb
                    )
                  : null;
              }
          ...
          ((n) => {
            class r {
              ...
              static createDimension(i, u, l) {
                return (
                  r.startDimension(i), r.addValue(i, u), r.addDenotation(i, l), r.endDimension(i)
                );
              }
            }
            n.Dimension = r;
            ...
            class r {
              ...
              static createNode(i, u, l, f, p, d, T, v, w, I, L, F, C, Y) {
                return (
                  ...
                  r.addOpType(i, T),
                  r.addType(i, v),
                  r.addExecutionProviderType(i, w),
                  r.addInputs(i, I),
                  r.addOutputs(i, L),
                  r.addAttributes(i, F),
                  r.addInputArgCounts(i, C),
                  r.addImplicitInputs(i, Y),
                  r.endNode(i)
                );
              }
            }
  ...
  var Gs = me((Sy, Ms) => {
    ...
    Ms.exports = Rd;
    function Rd(a, t) {
      for (var o = new Array(arguments.length - 1), e = 0, r = 2, n = !0; r < arguments.length; )
        o[e++] = arguments[r++];
  ...
  var Ws = me((Vs) => {
    ...
    var Cr = new Array(64),
      zs = new Array(123);
    for (vt = 0; vt < 64; )
      zs[(Cr[vt] = vt < 26 ? vt + 65 : vt < 52 ? vt + 71 : vt < 62 ? vt - 4 : (vt - 59) | 43)] =
        vt++;
    var vt;
    Hn.encode = function (t, o, e) {
      ...
      return (
        i && ((n[s++] = Cr[u]), (n[s++] = 61), i === 1 && (n[s++] = 61)),
        r
          ? (s && r.push(String.fromCharCode.apply(String, n.slice(0, s))), r.join(""))
          : String.fromCharCode.apply(String, n.slice(0, s))
      );
    };
    var Us = "invalid encoding";
    Hn.decode = function (t, o, e) {
      for (var r = e, n = 0, s, i = 0; i < t.length; ) {
        var u = t.charCodeAt(i++);
        if (u === 61 && n > 1) break;
        if ((u = zs[u]) === void 0) throw Error(Us);
        switch (n) {
          case 0:
            (s = u), (n = 1);
            break;
  ...
  var qs = me((Py, Hs) => {
    ...
    qn.prototype.on = function (t, o, e) {
      return (
        (this._listeners[t] || (this._listeners[t] = [])).push({ fn: o, ctx: e || this }), this
      );
    };
      ...
      return (
          ...
          : (function () {
              function t(e, r, n, s) {
                ...
                if ((i && (r = -r), r === 0)) e(1 / r > 0 ? 0 : 2147483648, n, s);
                  ...
                  e(((i << 31) | Math.round(r / 1401298464324817e-60)) >>> 0, n, s);
                else {
              ...
              (a.writeFloatLE = t.bind(null, Ys)), (a.writeFloatBE = t.bind(null, Xs));
              function o(e, r, n) {
                var s = e(r, n),
                  i = (s >> 31) * 2 + 1,
                  u = (s >>> 23) & 255,
              ...
              (a.readFloatLE = o.bind(null, Ks)), (a.readFloatBE = o.bind(null, Js));
            })(),
        typeof Float64Array < "u"
          ...
          : (function () {
              function t(e, r, n, s, i, u) {
                ...
                if ((l && (s = -s), s === 0))
                  ...
                  if (s < 22250738585072014e-324)
                    (f = s / 5e-324),
                      e(f >>> 0, i, u + r),
                      e(((l << 31) | (f / 4294967296)) >>> 0, i, u + n);
                  else {
                    var p = Math.floor(Math.log(s) / Math.LN2);
                    p === 1024 && (p = 1023),
                      (f = s * Math.pow(2, -p)),
                      e((f * 4503599627370496) >>> 0, i, u + r),
                      e(
                        ((l << 31) | ((p + 1023) << 20) | ((f * 1048576) & 1048575)) >>> 0,
                        i,
                        u + n
                      );
                  }
              ...
              (a.writeDoubleLE = t.bind(null, Ys, 0, 4)),
                (a.writeDoubleBE = t.bind(null, Xs, 4, 0));
              ...
              (a.readDoubleLE = o.bind(null, Ks, 0, 4)), (a.readDoubleBE = o.bind(null, Js, 4, 0));
            })(),
        a
      );
    }
    ...
    ri.read = function (t, o, e) {
      ...
      for (var n = null, s = [], i = 0, u; o < e; )
        (u = t[o++]),
          ...
          i > 8191 && ((n || (n = [])).push(String.fromCharCode.apply(String, s)), (i = 0));
      return n
        ? (i && n.push(String.fromCharCode.apply(String, s.slice(0, i))), n.join(""))
        : String.fromCharCode.apply(String, s.slice(0, i));
    };
    ri.write = function (t, o, e) {
        ...
        (n = t.charCodeAt(i)),
          n < 128
            ...
            : n < 2048
              ...
              : (n & 64512) === 55296 && ((s = t.charCodeAt(i + 1)) & 64512) === 56320
  ...
  var au = me((Fy, iu) => {
    ...
    Me.from = function (t) {
      ...
      if (on.isString(t))
        if (on.Long) t = on.Long.fromString(t);
        else return Me.fromNumber(parseInt(t, 10));
      return t.low || t.high ? new Me(t.low >>> 0, t.high >>> 0) : pr;
    };
    ...
    Me.prototype.toLong = function (t) {
      return on.Long
        ? new on.Long(this.lo | 0, this.hi | 0, !!t)
        : { low: this.lo | 0, high: this.hi | 0, unsigned: !!t };
    };
    var Jt = String.prototype.charCodeAt;
  ...
  var Zt = me((ni) => {
    ...
    H.global =
      (H.isNode && global) || (typeof window < "u" && window) || (typeof self < "u" && self) || ni;
  ...
  var fi = me(($y, pu) => {
    ...
    function se() {
      (this.len = 0), (this.head = new an(ai, 0, 0)), (this.tail = this.head), (this.states = null);
    }
    var cu = function () {
      return lt.Buffer
        ? function () {
    ...
    ui.prototype = Object.create(an.prototype);
    ui.prototype.fn = zd;
    ...
    se.prototype.int32 = function (t) {
      return t < 0 ? this._push(li, 10, jn.fromNumber(t)) : this.uint32(t);
    };
    ...
    se.prototype.uint64 = function (t) {
      var o = jn.from(t);
      return this._push(li, o.length(), o);
    };
    ...
    se.prototype.bytes = function (t) {
      var o = t.length >>> 0;
      if (!o) return this._push(si, 1, 0);
      if (lt.isString(t)) {
        var e = se.alloc((o = lu.length(t)));
        lu.decode(t, e, 0), (t = e);
      }
    ...
    se.prototype.string = function (t) {
      var o = fu.length(t);
      return o ? this.uint32(o)._push(fu.write, o, t) : this._push(si, 1, 0);
    };
    se.prototype.fork = function () {
      return (
        (this.states = new Ud(this)),
        (this.head = this.tail = new an(ai, 0, 0)),
        (this.len = 0),
        this
      );
    };
    se.prototype.reset = function () {
      return (
        this.states
          ...
          : ((this.head = this.tail = new an(ai, 0, 0)), (this.len = 0)),
        this
      );
    };
    ...
    se._configure = function (a) {
      (oi = a), (se.create = cu()), oi._configure();
    };
  });
  var mu = me((ky, hu) => {
    "use strict";
    hu.exports = Ct;
    var du = fi();
    (Ct.prototype = Object.create(du.prototype)).constructor = Ct;
    var Qt = Zt();
    function Ct() {
      du.call(this);
    }
    Ct._configure = function () {
      (Ct.alloc = Qt._Buffer_allocUnsafe),
        (Ct.writeBytesBuffer =
          Qt.Buffer &&
          Qt.Buffer.prototype instanceof Uint8Array &&
          Qt.Buffer.prototype.set.name === "set"
            ? function (t, o, e) {
                o.set(t, e);
              }
            : function (t, o, e) {
    ...
    function Wd(a, t, o) {
      a.length < 40 ? Qt.utf8.write(a, t, o) : t.utf8Write ? t.utf8Write(a, o) : t.write(a, o);
    }
    Ct.prototype.string = function (t) {
      var o = Qt.Buffer.byteLength(t);
  ...
  var di = me((By, xu) => {
        ...
        return $t.Buffer
          ? function (o) {
              return (Pe.create = function (r) {
                return $t.Buffer.isBuffer(r) ? new pi(r) : bu(r);
              })(o);
            }
          : bu;
      };
    ...
    function gu() {
      ...
      return new yu(Yn(this.buf, (this.pos += 4)), Yn(this.buf, (this.pos += 4)));
    }
    ...
    Pe.prototype.skip = function (t) {
      if (typeof t == "number") {
        ...
        do if (this.pos >= this.len) throw _t(this);
        while (this.buf[this.pos++] & 128);
      return this;
    };
    Pe.prototype.skipType = function (a) {
      switch (a) {
        case 0:
          this.skip();
          break;
    ...
    Pe._configure = function (a) {
      (pi = a), (Pe.create = Tu()), pi._configure();
      var t = $t.Long ? "toLong" : "toNumber";
      $t.merge(Pe.prototype, {
        int64: function () {
          return ci.call(this)[t](!1);
        },
        uint64: function () {
          return ci.call(this)[t](!0);
        },
        sint64: function () {
          return ci.call(this).zzDecode()[t](!1);
        },
        fixed64: function () {
          return gu.call(this)[t](!0);
        },
        sfixed64: function () {
          return gu.call(this)[t](!1);
        },
      });
    };
  });
  var Ou = me((Ny, _u) => {
    ...
    _u.exports = dr;
    var vu = di();
    (dr.prototype = Object.create(vu.prototype)).constructor = dr;
    var wu = Zt();
    function dr(a) {
      vu.call(this, a);
    }
    dr._configure = function () {
      wu.Buffer && (dr.prototype._slice = wu.Buffer.prototype.slice);
    };
  ...
  var Su = me((Ry, Iu) => {
    ...
    Iu.exports = sn;
    var hi = Zt();
    (sn.prototype = Object.create(hi.EventEmitter.prototype)).constructor = sn;
    function sn(a, t, o) {
      if (typeof a != "function") throw TypeError("rpcImpl must be a function");
      hi.EventEmitter.call(this),
        (this.rpcImpl = a),
        (this.requestDelimited = !!t),
        (this.responseDelimited = !!o);
    }
    sn.prototype.rpcCall = function a(t, o, e, r, n) {
      if (!r) throw TypeError("request must be specified");
      var s = this;
      if (!n) return hi.asPromise(a, s, t, o, e, r);
      if (!s.rpcImpl) {
        setTimeout(function () {
  ...
  var Cu = me((Fu) => {
    ...
    function Lu() {
      rt.util._configure(),
        rt.Writer._configure(rt.BufferWriter),
        rt.Reader._configure(rt.BufferReader);
    }
    Lu();
  });
  var ku = me((zy, $u) => {
  ...
  var $r = me((Vy, Bu) => {
    ...
    var ge = ku(),
      ...
      Ee = ge.Writer,
      y = ge.util,
      m = ge.roots.default || (ge.roots.default = {});
    m.onnx = (function () {
      var a = {};
      return (
        (a.Version = (function () {
        ...
        (a.AttributeProto = (function () {
          ...
          return (
            ...
            (t.prototype.type = 0),
            (t.prototype.f = 0),
            (t.prototype.i = y.Long ? y.Long.fromBits(0, 0, !1) : 0),
            (t.prototype.s = y.newBuffer([])),
            (t.prototype.t = null),
            (t.prototype.g = null),
            (t.prototype.sparseTensor = null),
            (t.prototype.tp = null),
            (t.prototype.floats = y.emptyArray),
            (t.prototype.ints = y.emptyArray),
            (t.prototype.strings = y.emptyArray),
            (t.prototype.tensors = y.emptyArray),
            (t.prototype.graphs = y.emptyArray),
            (t.prototype.sparseTensors = y.emptyArray),
            (t.prototype.typeProtos = y.emptyArray),
            (t.create = function (e) {
              return new t(e);
            }),
            (t.encode = function (e, r) {
              if (
                ...
                e.t != null &&
                  ...
                  m.onnx.TensorProto.encode(e.t, r.uint32(42).fork()).ldelim(),
                e.g != null &&
                  Object.hasOwnProperty.call(e, "g") &&
                  m.onnx.GraphProto.encode(e.g, r.uint32(50).fork()).ldelim(),
              ...
              if (e.strings != null && e.strings.length)
                for (var n = 0; n < e.strings.length; ++n) r.uint32(74).bytes(e.strings[n]);
              if (e.tensors != null && e.tensors.length)
                for (var n = 0; n < e.tensors.length; ++n)
                  m.onnx.TensorProto.encode(e.tensors[n], r.uint32(82).fork()).ldelim();
              if (e.graphs != null && e.graphs.length)
                for (var n = 0; n < e.graphs.length; ++n)
                  m.onnx.GraphProto.encode(e.graphs[n], r.uint32(90).fork()).ldelim();
              if (
                (e.docString != null &&
                ...
                e.tp != null &&
                  ...
                  m.onnx.TypeProto.encode(e.tp, r.uint32(114).fork()).ldelim(),
                e.typeProtos != null && e.typeProtos.length)
              )
                for (var n = 0; n < e.typeProtos.length; ++n)
                  m.onnx.TypeProto.encode(e.typeProtos[n], r.uint32(122).fork()).ldelim();
              if (
                (e.type != null &&
                ...
                e.sparseTensor != null &&
                  ...
                  m.onnx.SparseTensorProto.encode(e.sparseTensor, r.uint32(178).fork()).ldelim(),
                e.sparseTensors != null && e.sparseTensors.length)
              )
                for (var n = 0; n < e.sparseTensors.length; ++n)
                  m.onnx.SparseTensorProto.encode(
                    e.sparseTensors[n],
                    r.uint32(186).fork()
                  ).ldelim();
              return r;
            ...
            (t.decode = function (e, r) {
              ...
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.AttributeProto();
                e.pos < n;
                ...
                switch (i >>> 3) {
                  ...
                  case 7: {
                    if (((s.floats && s.floats.length) || (s.floats = []), (i & 7) === 2))
                      for (var u = e.uint32() + e.pos; e.pos < u; ) s.floats.push(e.float());
                    else s.floats.push(e.float());
                    break;
                  }
                  case 8: {
                    if (((s.ints && s.ints.length) || (s.ints = []), (i & 7) === 2))
                      for (var u = e.uint32() + e.pos; e.pos < u; ) s.ints.push(e.int64());
                  ...
                  case 10: {
                    (s.tensors && s.tensors.length) || (s.tensors = []),
                      s.tensors.push(m.onnx.TensorProto.decode(e, e.uint32()));
                    break;
                  }
                  case 11: {
                    (s.graphs && s.graphs.length) || (s.graphs = []),
                      s.graphs.push(m.onnx.GraphProto.decode(e, e.uint32()));
                    break;
                  }
                  case 23: {
                    (s.sparseTensors && s.sparseTensors.length) || (s.sparseTensors = []),
                      s.sparseTensors.push(m.onnx.SparseTensorProto.decode(e, e.uint32()));
                    break;
                  }
                  case 15: {
                    (s.typeProtos && s.typeProtos.length) || (s.typeProtos = []),
                      s.typeProtos.push(m.onnx.TypeProto.decode(e, e.uint32()));
                    break;
                  }
                  default:
                    e.skipType(i & 7);
            ...
            (t.verify = function (e) {
              ...
              if (e.name != null && e.hasOwnProperty("name") && !y.isString(e.name))
                return "name: string expected";
              if (
                e.refAttrName != null &&
                e.hasOwnProperty("refAttrName") &&
                !y.isString(e.refAttrName)
              )
                return "refAttrName: string expected";
              if (e.docString != null && e.hasOwnProperty("docString") && !y.isString(e.docString))
              ...
              if (
                ...
                e.hasOwnProperty("i") &&
                !y.isInteger(e.i) &&
                !(e.i && y.isInteger(e.i.low) && y.isInteger(e.i.high))
              )
                return "i: integer|Long expected";
              if (
                e.s != null &&
                e.hasOwnProperty("s") &&
                !((e.s && typeof e.s.length == "number") || y.isString(e.s))
              )
              ...
              if (e.floats != null && e.hasOwnProperty("floats")) {
                ...
                for (var n = 0; n < e.floats.length; ++n)
                  if (typeof e.floats[n] != "number") return "floats: number[] expected";
              }
              if (e.ints != null && e.hasOwnProperty("ints")) {
                if (!Array.isArray(e.ints)) return "ints: array expected";
                for (var n = 0; n < e.ints.length; ++n)
                  if (
                    !y.isInteger(e.ints[n]) &&
                    !(e.ints[n] && y.isInteger(e.ints[n].low) && y.isInteger(e.ints[n].high))
                  )
            ...
            (t.fromObject = function (e) {
              ...
              if (
                ...
                e.i != null &&
                  (y.Long
                    ? ((r.i = y.Long.fromValue(e.i)).unsigned = !1)
                    : typeof e.i == "string"
                      ? (r.i = parseInt(e.i, 10))
                      : typeof e.i == "number"
                        ? (r.i = e.i)
                        : typeof e.i == "object" &&
                          (r.i = new y.LongBits(e.i.low >>> 0, e.i.high >>> 0).toNumber())),
                e.s != null &&
                  (typeof e.s == "string"
                    ? y.base64.decode(e.s, (r.s = y.newBuffer(y.base64.length(e.s))), 0)
              ...
              if (e.strings) {
                ...
                for (var n = 0; n < e.strings.length; ++n)
                  typeof e.strings[n] == "string"
                    ? y.base64.decode(
                        e.strings[n],
                        (r.strings[n] = y.newBuffer(y.base64.length(e.strings[n]))),
                        0
                      )
            ...
            (t.toObject = function (e, r) {
              ...
              if (
                ...
                r.bytes === String
                  ? (n.s = "")
                  : ((n.s = []), r.bytes !== Array && (n.s = y.newBuffer(n.s))),
                  (n.t = null),
                  (n.g = null),
                  (n.docString = ""),
                  (n.tp = null),
              ...
              if (
                ...
                e.i != null &&
                  ...
                  (typeof e.i == "number"
                    ...
                    : (n.i =
                        r.longs === String
                          ? y.Long.prototype.toString.call(e.i)
                          : r.longs === Number
                            ? new y.LongBits(e.i.low >>> 0, e.i.high >>> 0).toNumber()
                            : e.i)),
                e.s != null &&
                  e.hasOwnProperty("s") &&
                  (n.s =
                    r.bytes === String
                      ? y.base64.encode(e.s, 0, e.s.length)
                      : r.bytes === Array
                        ? Array.prototype.slice.call(e.s)
                        : e.s),
                e.t != null && e.hasOwnProperty("t") && (n.t = m.onnx.TensorProto.toObject(e.t, r)),
                e.g != null && e.hasOwnProperty("g") && (n.g = m.onnx.GraphProto.toObject(e.g, r)),
                e.floats && e.floats.length)
              ) {
                n.floats = [];
                for (var i = 0; i < e.floats.length; ++i)
                  n.floats[i] =
                    r.json && !isFinite(e.floats[i]) ? String(e.floats[i]) : e.floats[i];
              }
              if (e.ints && e.ints.length) {
                n.ints = [];
                for (var i = 0; i < e.ints.length; ++i)
                  typeof e.ints[i] == "number"
                    ? (n.ints[i] = r.longs === String ? String(e.ints[i]) : e.ints[i])
                    : (n.ints[i] =
                        r.longs === String
                          ? y.Long.prototype.toString.call(e.ints[i])
                          : r.longs === Number
                            ? new y.LongBits(e.ints[i].low >>> 0, e.ints[i].high >>> 0).toNumber()
                            : e.ints[i]);
              }
              if (e.strings && e.strings.length) {
                ...
                for (var i = 0; i < e.strings.length; ++i)
                  n.strings[i] =
                    r.bytes === String
                      ? y.base64.encode(e.strings[i], 0, e.strings[i].length)
                      : r.bytes === Array
              ...
              if (e.tensors && e.tensors.length) {
                ...
                for (var i = 0; i < e.tensors.length; ++i)
                  n.tensors[i] = m.onnx.TensorProto.toObject(e.tensors[i], r);
              }
              if (e.graphs && e.graphs.length) {
                n.graphs = [];
                for (var i = 0; i < e.graphs.length; ++i)
                  n.graphs[i] = m.onnx.GraphProto.toObject(e.graphs[i], r);
              }
              if (
                (e.docString != null &&
                ...
                e.tp != null &&
                  e.hasOwnProperty("tp") &&
                  (n.tp = m.onnx.TypeProto.toObject(e.tp, r)),
                e.typeProtos && e.typeProtos.length)
              ) {
                n.typeProtos = [];
                for (var i = 0; i < e.typeProtos.length; ++i)
                  n.typeProtos[i] = m.onnx.TypeProto.toObject(e.typeProtos[i], r);
              }
              if (
                (e.type != null &&
                  ...
                  (n.type =
                    r.enums === String
                      ? m.onnx.AttributeProto.AttributeType[e.type] === void 0
                        ? e.type
                        : m.onnx.AttributeProto.AttributeType[e.type]
                      : e.type),
                e.refAttrName != null &&
                  e.hasOwnProperty("refAttrName") &&
                ...
                e.sparseTensor != null &&
                  ...
                  (n.sparseTensor = m.onnx.SparseTensorProto.toObject(e.sparseTensor, r)),
                e.sparseTensors && e.sparseTensors.length)
              ) {
                n.sparseTensors = [];
                for (var i = 0; i < e.sparseTensors.length; ++i)
                  n.sparseTensors[i] = m.onnx.SparseTensorProto.toObject(e.sparseTensors[i], r);
              }
              return n;
            }),
          ...
          return (
            ...
            (t.encode = function (e, r) {
              return (
                ...
                e.type != null &&
                  Object.hasOwnProperty.call(e, "type") &&
                  m.onnx.TypeProto.encode(e.type, r.uint32(18).fork()).ldelim(),
                e.docString != null &&
                  Object.hasOwnProperty.call(e, "docString") &&
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.ValueInfoProto();
                e.pos < n;
            ...
            (t.toObject = function (e, r) {
              ...
              var n = {};
              return (
                r.defaults && ((n.name = ""), (n.type = null), (n.docString = "")),
                e.name != null && e.hasOwnProperty("name") && (n.name = e.name),
                e.type != null &&
                  e.hasOwnProperty("type") &&
                  (n.type = m.onnx.TypeProto.toObject(e.type, r)),
                e.docString != null && e.hasOwnProperty("docString") && (n.docString = e.docString),
                n
              );
            }),
            (t.prototype.toJSON = function () {
        ...
        (a.NodeProto = (function () {
          ...
          return (
            (t.prototype.input = y.emptyArray),
            (t.prototype.output = y.emptyArray),
            (t.prototype.name = ""),
            (t.prototype.opType = ""),
            (t.prototype.domain = ""),
            (t.prototype.attribute = y.emptyArray),
            (t.prototype.docString = ""),
            (t.create = function (e) {
              return new t(e);
            }),
            (t.encode = function (e, r) {
              if ((r || (r = Ee.create()), e.input != null && e.input.length))
                for (var n = 0; n < e.input.length; ++n) r.uint32(10).string(e.input[n]);
              if (e.output != null && e.output.length)
                for (var n = 0; n < e.output.length; ++n) r.uint32(18).string(e.output[n]);
              if (
                (e.name != null &&
                  Object.hasOwnProperty.call(e, "name") &&
                ...
                for (var n = 0; n < e.attribute.length; ++n)
                  m.onnx.AttributeProto.encode(e.attribute[n], r.uint32(42).fork()).ldelim();
              return (
                e.docString != null &&
                  Object.hasOwnProperty.call(e, "docString") &&
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.NodeProto();
                e.pos < n;
                ...
                switch (i >>> 3) {
                  ...
                  case 5: {
                    (s.attribute && s.attribute.length) || (s.attribute = []),
                      s.attribute.push(m.onnx.AttributeProto.decode(e, e.uint32()));
                    break;
                  }
                  case 6: {
                    s.docString = e.string();
            ...
            (t.verify = function (e) {
              ...
              if (e.input != null && e.hasOwnProperty("input")) {
                ...
                for (var r = 0; r < e.input.length; ++r)
                  if (!y.isString(e.input[r])) return "input: string[] expected";
              }
              if (e.output != null && e.hasOwnProperty("output")) {
                ...
                for (var r = 0; r < e.output.length; ++r)
                  if (!y.isString(e.output[r])) return "output: string[] expected";
              }
              if (e.name != null && e.hasOwnProperty("name") && !y.isString(e.name))
                return "name: string expected";
              if (e.opType != null && e.hasOwnProperty("opType") && !y.isString(e.opType))
                return "opType: string expected";
              if (e.domain != null && e.hasOwnProperty("domain") && !y.isString(e.domain))
            ...
            (t.toObject = function (e, r) {
              ...
              var n = {};
              if (
                ((r.arrays || r.defaults) && ((n.input = []), (n.output = []), (n.attribute = [])),
                r.defaults && ((n.name = ""), (n.opType = ""), (n.docString = ""), (n.domain = "")),
              ...
              if (
                (e.name != null && e.hasOwnProperty("name") && (n.name = e.name),
                e.opType != null && e.hasOwnProperty("opType") && (n.opType = e.opType),
                e.attribute && e.attribute.length)
              ) {
                n.attribute = [];
                for (var s = 0; s < e.attribute.length; ++s)
                  n.attribute[s] = m.onnx.AttributeProto.toObject(e.attribute[s], r);
              }
              return (
                e.docString != null && e.hasOwnProperty("docString") && (n.docString = e.docString),
                e.domain != null && e.hasOwnProperty("domain") && (n.domain = e.domain),
                n
              );
            }),
            (t.prototype.toJSON = function () {
        ...
        (a.TrainingInfoProto = (function () {
          ...
          return (
            ...
            (t.prototype.initializationBinding = y.emptyArray),
            (t.prototype.updateBinding = y.emptyArray),
            (t.create = function (e) {
              return new t(e);
            }),
            (t.encode = function (e, r) {
              if (
                ...
                e.initialization != null &&
                  ...
                  m.onnx.GraphProto.encode(e.initialization, r.uint32(10).fork()).ldelim(),
                e.algorithm != null &&
                  Object.hasOwnProperty.call(e, "algorithm") &&
                  m.onnx.GraphProto.encode(e.algorithm, r.uint32(18).fork()).ldelim(),
                e.initializationBinding != null && e.initializationBinding.length)
              )
                for (var n = 0; n < e.initializationBinding.length; ++n)
                  m.onnx.StringStringEntryProto.encode(
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.TrainingInfoProto();
                e.pos < n;
                  ...
                  case 3: {
                    (s.initializationBinding && s.initializationBinding.length) ||
                      ...
                      s.initializationBinding.push(
                        m.onnx.StringStringEntryProto.decode(e, e.uint32())
                      );
                    break;
                  }
                  case 4: {
                    (s.updateBinding && s.updateBinding.length) || (s.updateBinding = []),
                      s.updateBinding.push(m.onnx.StringStringEntryProto.decode(e, e.uint32()));
                    break;
                  }
                  default:
                    e.skipType(i & 7);
            ...
            (t.fromObject = function (e) {
              ...
              if (e.initializationBinding) {
                ...
                for (var n = 0; n < e.initializationBinding.length; ++n) {
                  ...
                  r.initializationBinding[n] = m.onnx.StringStringEntryProto.fromObject(
                    e.initializationBinding[n]
                  );
                }
              }
            ...
            (t.toObject = function (e, r) {
              ...
              if (
                ...
                e.initialization != null &&
                  ...
                  (n.initialization = m.onnx.GraphProto.toObject(e.initialization, r)),
                e.algorithm != null &&
                  e.hasOwnProperty("algorithm") &&
                  (n.algorithm = m.onnx.GraphProto.toObject(e.algorithm, r)),
                ...
                for (var s = 0; s < e.initializationBinding.length; ++s)
                  n.initializationBinding[s] = m.onnx.StringStringEntryProto.toObject(
              ...
              if (e.updateBinding && e.updateBinding.length) {
                ...
                for (var s = 0; s < e.updateBinding.length; ++s)
                  n.updateBinding[s] = m.onnx.StringStringEntryProto.toObject(
                    e.updateBinding[s],
                    r
                  );
              }
        ...
        (a.ModelProto = (function () {
          ...
          return (
            (t.prototype.irVersion = y.Long ? y.Long.fromBits(0, 0, !1) : 0),
            (t.prototype.opsetImport = y.emptyArray),
            (t.prototype.producerName = ""),
            (t.prototype.producerVersion = ""),
            (t.prototype.domain = ""),
            (t.prototype.modelVersion = y.Long ? y.Long.fromBits(0, 0, !1) : 0),
            (t.prototype.docString = ""),
            (t.prototype.graph = null),
            (t.prototype.metadataProps = y.emptyArray),
            (t.prototype.trainingInfo = y.emptyArray),
            (t.prototype.functions = y.emptyArray),
            (t.create = function (e) {
              return new t(e);
            }),
            (t.encode = function (e, r) {
              if (
                ...
                e.graph != null &&
                  ...
                  m.onnx.GraphProto.encode(e.graph, r.uint32(58).fork()).ldelim(),
                e.opsetImport != null && e.opsetImport.length)
              )
                for (var n = 0; n < e.opsetImport.length; ++n)
                  m.onnx.OperatorSetIdProto.encode(e.opsetImport[n], r.uint32(66).fork()).ldelim();
              ...
              if (e.trainingInfo != null && e.trainingInfo.length)
                for (var n = 0; n < e.trainingInfo.length; ++n)
                  m.onnx.TrainingInfoProto.encode(e.trainingInfo[n], r.uint32(162).fork()).ldelim();
              if (e.functions != null && e.functions.length)
                for (var n = 0; n < e.functions.length; ++n)
                  m.onnx.FunctionProto.encode(e.functions[n], r.uint32(202).fork()).ldelim();
              return r;
            }),
            (t.encodeDelimited = function (e, r) {
              return this.encode(e, r).ldelim();
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.ModelProto();
                e.pos < n;
                ...
                switch (i >>> 3) {
                  ...
                  case 8: {
                    (s.opsetImport && s.opsetImport.length) || (s.opsetImport = []),
                      s.opsetImport.push(m.onnx.OperatorSetIdProto.decode(e, e.uint32()));
                    break;
                  }
                  case 2: {
                  ...
                  case 14: {
                    (s.metadataProps && s.metadataProps.length) || (s.metadataProps = []),
                      s.metadataProps.push(m.onnx.StringStringEntryProto.decode(e, e.uint32()));
                    break;
                  }
                  case 20: {
                    (s.trainingInfo && s.trainingInfo.length) || (s.trainingInfo = []),
                      s.trainingInfo.push(m.onnx.TrainingInfoProto.decode(e, e.uint32()));
                    break;
                  }
                  case 25: {
                    (s.functions && s.functions.length) || (s.functions = []),
                      s.functions.push(m.onnx.FunctionProto.decode(e, e.uint32()));
                    break;
                  }
                  default:
                    e.skipType(i & 7);
            ...
            (t.verify = function (e) {
              ...
              if (
                ...
                !y.isInteger(e.irVersion) &&
                !(e.irVersion && y.isInteger(e.irVersion.low) && y.isInteger(e.irVersion.high))
              )
              ...
              if (
                ...
                !y.isString(e.producerName)
              )
                return "producerName: string expected";
              if (
                e.producerVersion != null &&
                e.hasOwnProperty("producerVersion") &&
                !y.isString(e.producerVersion)
              )
              ...
              if (
                ...
                !(
                  e.modelVersion &&
                  y.isInteger(e.modelVersion.low) &&
                  y.isInteger(e.modelVersion.high)
                )
              )
            ...
            (t.fromObject = function (e) {
              ...
              if (
                (e.irVersion != null &&
                  (y.Long
                    ? ((r.irVersion = y.Long.fromValue(e.irVersion)).unsigned = !1)
              ...
              if (
                ...
                e.modelVersion != null &&
                  (y.Long
                    ? ((r.modelVersion = y.Long.fromValue(e.modelVersion)).unsigned = !1)
            ...
            (t.toObject = function (e, r) {
              ...
              if (
                ...
                if (y.Long) {
                  var s = new y.Long(0, 0, !1);
                  n.irVersion =
                    r.longs === String ? s.toString() : r.longs === Number ? s.toNumber() : s;
              ...
              if (
                (e.irVersion != null &&
                  e.hasOwnProperty("irVersion") &&
                  (typeof e.irVersion == "number"
                    ? (n.irVersion = r.longs === String ? String(e.irVersion) : e.irVersion)
                    : (n.irVersion =
                        r.longs === String
                          ? y.Long.prototype.toString.call(e.irVersion)
                          : r.longs === Number
                            ? new y.LongBits(
                                e.irVersion.low >>> 0,
                                e.irVersion.high >>> 0
                ...
                e.modelVersion != null &&
                  ...
                  (typeof e.modelVersion == "number"
                    ...
                    : (n.modelVersion =
                        r.longs === String
                          ? y.Long.prototype.toString.call(e.modelVersion)
                          : r.longs === Number
                            ? new y.LongBits(
                                e.modelVersion.low >>> 0,
                                e.modelVersion.high >>> 0
                ...
                e.graph != null &&
                  ...
                  (n.graph = m.onnx.GraphProto.toObject(e.graph, r)),
                e.opsetImport && e.opsetImport.length)
              ) {
                n.opsetImport = [];
                for (var i = 0; i < e.opsetImport.length; ++i)
                  n.opsetImport[i] = m.onnx.OperatorSetIdProto.toObject(e.opsetImport[i], r);
              }
              if (e.metadataProps && e.metadataProps.length) {
                n.metadataProps = [];
                for (var i = 0; i < e.metadataProps.length; ++i)
                  n.metadataProps[i] = m.onnx.StringStringEntryProto.toObject(
                    e.metadataProps[i],
                    r
                  );
              }
              if (e.trainingInfo && e.trainingInfo.length) {
                ...
                for (var i = 0; i < e.trainingInfo.length; ++i)
                  n.trainingInfo[i] = m.onnx.TrainingInfoProto.toObject(e.trainingInfo[i], r);
              }
              if (e.functions && e.functions.length) {
                n.functions = [];
                for (var i = 0; i < e.functions.length; ++i)
                  n.functions[i] = m.onnx.FunctionProto.toObject(e.functions[i], r);
              }
              return n;
            }),
            (t.prototype.toJSON = function () {
        ...
        (a.StringStringEntryProto = (function () {
          ...
          return (
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.StringStringEntryProto();
                e.pos < n;
            ...
            (t.verify = function (e) {
              return typeof e != "object" || e === null
                ? "object expected"
                : e.key != null && e.hasOwnProperty("key") && !y.isString(e.key)
                  ? "key: string expected"
                  : e.value != null && e.hasOwnProperty("value") && !y.isString(e.value)
            ...
            (t.toObject = function (e, r) {
              ...
              return (
                ...
                e.value != null && e.hasOwnProperty("value") && (n.value = e.value),
                n
              );
            }),
            (t.prototype.toJSON = function () {
            ...
            (t.getTypeUrl = function (e) {
              return (
                e === void 0 && (e = "type.googleapis.com"), e + "/onnx.StringStringEntryProto"
              );
            }),
            t
          );
        ...
        (a.TensorAnnotation = (function () {
          ...
          return (
            ...
            (t.prototype.quantParameterTensorNames = y.emptyArray),
            (t.create = function (e) {
              return new t(e);
            }),
            (t.encode = function (e, r) {
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.TensorAnnotation();
                e.pos < n;
                ...
                switch (i >>> 3) {
                  ...
                  case 2: {
                    (s.quantParameterTensorNames && s.quantParameterTensorNames.length) ||
            ...
            (t.fromObject = function (e) {
              ...
              if (
                ...
                for (var n = 0; n < e.quantParameterTensorNames.length; ++n) {
                  ...
                  r.quantParameterTensorNames[n] = m.onnx.StringStringEntryProto.fromObject(
                    e.quantParameterTensorNames[n]
                  );
                }
              }
            ...
            (t.toObject = function (e, r) {
              ...
              if (
                ...
                for (var s = 0; s < e.quantParameterTensorNames.length; ++s)
                  n.quantParameterTensorNames[s] = m.onnx.StringStringEntryProto.toObject(
        ...
        (a.GraphProto = (function () {
          ...
          return (
            (t.prototype.node = y.emptyArray),
            (t.prototype.name = ""),
            (t.prototype.initializer = y.emptyArray),
            (t.prototype.sparseInitializer = y.emptyArray),
            (t.prototype.docString = ""),
            (t.prototype.input = y.emptyArray),
            (t.prototype.output = y.emptyArray),
            (t.prototype.valueInfo = y.emptyArray),
            (t.prototype.quantizationAnnotation = y.emptyArray),
            (t.create = function (e) {
              return new t(e);
            }),
            (t.encode = function (e, r) {
              if ((r || (r = Ee.create()), e.node != null && e.node.length))
                for (var n = 0; n < e.node.length; ++n)
                  m.onnx.NodeProto.encode(e.node[n], r.uint32(10).fork()).ldelim();
              if (
                (e.name != null &&
                  Object.hasOwnProperty.call(e, "name") &&
                ...
                for (var n = 0; n < e.initializer.length; ++n)
                  m.onnx.TensorProto.encode(e.initializer[n], r.uint32(42).fork()).ldelim();
              if (
                (e.docString != null &&
                  Object.hasOwnProperty.call(e, "docString") &&
                ...
                for (var n = 0; n < e.input.length; ++n)
                  m.onnx.ValueInfoProto.encode(e.input[n], r.uint32(90).fork()).ldelim();
              if (e.output != null && e.output.length)
                for (var n = 0; n < e.output.length; ++n)
                  m.onnx.ValueInfoProto.encode(e.output[n], r.uint32(98).fork()).ldelim();
              if (e.valueInfo != null && e.valueInfo.length)
                for (var n = 0; n < e.valueInfo.length; ++n)
                  m.onnx.ValueInfoProto.encode(e.valueInfo[n], r.uint32(106).fork()).ldelim();
              if (e.quantizationAnnotation != null && e.quantizationAnnotation.length)
                for (var n = 0; n < e.quantizationAnnotation.length; ++n)
                  m.onnx.TensorAnnotation.encode(
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.GraphProto();
                e.pos < n;
                ...
                switch (i >>> 3) {
                  case 1: {
                    (s.node && s.node.length) || (s.node = []),
                      s.node.push(m.onnx.NodeProto.decode(e, e.uint32()));
                    break;
                  }
                  case 2: {
                    s.name = e.string();
                  ...
                  case 5: {
                    (s.initializer && s.initializer.length) || (s.initializer = []),
                      s.initializer.push(m.onnx.TensorProto.decode(e, e.uint32()));
                    break;
                  }
                  case 15: {
                    (s.sparseInitializer && s.sparseInitializer.length) ||
                      (s.sparseInitializer = []),
                      s.sparseInitializer.push(m.onnx.SparseTensorProto.decode(e, e.uint32()));
                    break;
                  }
                  case 10: {
                    s.docString = e.string();
                  ...
                  case 11: {
                    (s.input && s.input.length) || (s.input = []),
                      s.input.push(m.onnx.ValueInfoProto.decode(e, e.uint32()));
                    break;
                  }
                  case 12: {
                    (s.output && s.output.length) || (s.output = []),
                      s.output.push(m.onnx.ValueInfoProto.decode(e, e.uint32()));
                    break;
                  }
                  case 13: {
                    (s.valueInfo && s.valueInfo.length) || (s.valueInfo = []),
                      s.valueInfo.push(m.onnx.ValueInfoProto.decode(e, e.uint32()));
                    break;
                  }
                  case 14: {
                    (s.quantizationAnnotation && s.quantizationAnnotation.length) ||
                      (s.quantizationAnnotation = []),
                      s.quantizationAnnotation.push(m.onnx.TensorAnnotation.decode(e, e.uint32()));
                    break;
                  }
                  default:
                    e.skipType(i & 7);
            ...
            (t.fromObject = function (e) {
              ...
              if (e.sparseInitializer) {
                ...
                for (var n = 0; n < e.sparseInitializer.length; ++n) {
                  ...
                  r.sparseInitializer[n] = m.onnx.SparseTensorProto.fromObject(
                    e.sparseInitializer[n]
                  );
                }
              }
              ...
              if (e.quantizationAnnotation) {
                ...
                for (var n = 0; n < e.quantizationAnnotation.length; ++n) {
                  ...
                  r.quantizationAnnotation[n] = m.onnx.TensorAnnotation.fromObject(
                    e.quantizationAnnotation[n]
                  );
                }
              }
            ...
            (t.toObject = function (e, r) {
              ...
              if (
                ...
                for (var s = 0; s < e.node.length; ++s)
                  n.node[s] = m.onnx.NodeProto.toObject(e.node[s], r);
              }
              if (
                (e.name != null && e.hasOwnProperty("name") && (n.name = e.name),
                ...
                for (var s = 0; s < e.initializer.length; ++s)
                  n.initializer[s] = m.onnx.TensorProto.toObject(e.initializer[s], r);
              }
              if (
                (e.docString != null &&
                  e.hasOwnProperty("docString") &&
                ...
                for (var s = 0; s < e.input.length; ++s)
                  n.input[s] = m.onnx.ValueInfoProto.toObject(e.input[s], r);
              }
              if (e.output && e.output.length) {
                n.output = [];
                for (var s = 0; s < e.output.length; ++s)
                  n.output[s] = m.onnx.ValueInfoProto.toObject(e.output[s], r);
              }
              if (e.valueInfo && e.valueInfo.length) {
                n.valueInfo = [];
                for (var s = 0; s < e.valueInfo.length; ++s)
                  n.valueInfo[s] = m.onnx.ValueInfoProto.toObject(e.valueInfo[s], r);
              }
              if (e.quantizationAnnotation && e.quantizationAnnotation.length) {
                n.quantizationAnnotation = [];
                for (var s = 0; s < e.quantizationAnnotation.length; ++s)
                  n.quantizationAnnotation[s] = m.onnx.TensorAnnotation.toObject(
              ...
              if (e.sparseInitializer && e.sparseInitializer.length) {
                ...
                for (var s = 0; s < e.sparseInitializer.length; ++s)
                  n.sparseInitializer[s] = m.onnx.SparseTensorProto.toObject(
        ...
        (a.TensorProto = (function () {
          ...
          return (
            (t.prototype.dims = y.emptyArray),
            (t.prototype.dataType = 0),
            (t.prototype.segment = null),
            (t.prototype.floatData = y.emptyArray),
            (t.prototype.int32Data = y.emptyArray),
            (t.prototype.stringData = y.emptyArray),
            (t.prototype.int64Data = y.emptyArray),
            (t.prototype.name = ""),
            (t.prototype.docString = ""),
            (t.prototype.rawData = y.newBuffer([])),
            (t.prototype.externalData = y.emptyArray),
            (t.prototype.dataLocation = 0),
            (t.prototype.doubleData = y.emptyArray),
            (t.prototype.uint64Data = y.emptyArray),
            (t.create = function (e) {
              return new t(e);
            }),
            (t.encode = function (e, r) {
              ...
              if (
                ...
                e.segment != null &&
                  ...
                  m.onnx.TensorProto.Segment.encode(e.segment, r.uint32(26).fork()).ldelim(),
              ...
              if (e.stringData != null && e.stringData.length)
                for (var n = 0; n < e.stringData.length; ++n) r.uint32(50).bytes(e.stringData[n]);
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.TensorProto();
                e.pos < n;
                ...
                switch (i >>> 3) {
                  case 1: {
                    if (((s.dims && s.dims.length) || (s.dims = []), (i & 7) === 2))
                      for (var u = e.uint32() + e.pos; e.pos < u; ) s.dims.push(e.int64());
                  ...
                  case 4: {
                    if (((s.floatData && s.floatData.length) || (s.floatData = []), (i & 7) === 2))
                      for (var u = e.uint32() + e.pos; e.pos < u; ) s.floatData.push(e.float());
                    else s.floatData.push(e.float());
                    break;
                  }
                  case 5: {
                    if (((s.int32Data && s.int32Data.length) || (s.int32Data = []), (i & 7) === 2))
                      for (var u = e.uint32() + e.pos; e.pos < u; ) s.int32Data.push(e.int32());
                  ...
                  case 7: {
                    if (((s.int64Data && s.int64Data.length) || (s.int64Data = []), (i & 7) === 2))
                      for (var u = e.uint32() + e.pos; e.pos < u; ) s.int64Data.push(e.int64());
                  ...
                  case 13: {
                    (s.externalData && s.externalData.length) || (s.externalData = []),
                      s.externalData.push(m.onnx.StringStringEntryProto.decode(e, e.uint32()));
                    break;
                  }
                  case 14: {
                  ...
                  case 10: {
                    if (
                      ((s.doubleData && s.doubleData.length) || (s.doubleData = []), (i & 7) === 2)
                    )
                      for (var u = e.uint32() + e.pos; e.pos < u; ) s.doubleData.push(e.double());
                    else s.doubleData.push(e.double());
                    break;
                  }
                  case 11: {
                    if (
                      ((s.uint64Data && s.uint64Data.length) || (s.uint64Data = []), (i & 7) === 2)
                    )
                      for (var u = e.uint32() + e.pos; e.pos < u; ) s.uint64Data.push(e.uint64());
            ...
            (t.verify = function (e) {
              ...
              if (e.dims != null && e.hasOwnProperty("dims")) {
                ...
                for (var r = 0; r < e.dims.length; ++r)
                  if (
                    !y.isInteger(e.dims[r]) &&
                    !(e.dims[r] && y.isInteger(e.dims[r].low) && y.isInteger(e.dims[r].high))
                  )
                    return "dims: integer|Long[] expected";
              }
              if (e.dataType != null && e.hasOwnProperty("dataType") && !y.isInteger(e.dataType))
              ...
              if (e.int32Data != null && e.hasOwnProperty("int32Data")) {
                ...
                for (var r = 0; r < e.int32Data.length; ++r)
                  if (!y.isInteger(e.int32Data[r])) return "int32Data: integer[] expected";
              }
              ...
              if (e.int64Data != null && e.hasOwnProperty("int64Data")) {
                ...
                for (var r = 0; r < e.int64Data.length; ++r)
                  if (
                    !y.isInteger(e.int64Data[r]) &&
                    !(
                      e.int64Data[r] &&
                      y.isInteger(e.int64Data[r].low) &&
                      y.isInteger(e.int64Data[r].high)
                    )
                  )
              ...
              if (
                ...
                !((e.rawData && typeof e.rawData.length == "number") || y.isString(e.rawData))
              )
              ...
              if (e.uint64Data != null && e.hasOwnProperty("uint64Data")) {
                ...
                for (var r = 0; r < e.uint64Data.length; ++r)
                  if (
                    !y.isInteger(e.uint64Data[r]) &&
                    !(
                      e.uint64Data[r] &&
                      y.isInteger(e.uint64Data[r].low) &&
                      y.isInteger(e.uint64Data[r].high)
                    )
                  )
            ...
            (t.fromObject = function (e) {
              ...
              if (e.stringData) {
                ...
                for (var n = 0; n < e.stringData.length; ++n)
                  typeof e.stringData[n] == "string"
                    ? y.base64.decode(
                        e.stringData[n],
                        (r.stringData[n] = y.newBuffer(y.base64.length(e.stringData[n]))),
                        0
                      )
                    : e.stringData[n].length >= 0 && (r.stringData[n] = e.stringData[n]);
              }
              if (e.int64Data) {
                ...
                for (var n = 0; n < e.int64Data.length; ++n)
                  y.Long
                    ? ((r.int64Data[n] = y.Long.fromValue(e.int64Data[n])).unsigned = !1)
              ...
              if (
                ...
                e.rawData != null &&
                  (typeof e.rawData == "string"
                    ? y.base64.decode(
                        e.rawData,
                        (r.rawData = y.newBuffer(y.base64.length(e.rawData))),
                        0
                      )
              ...
              if (e.uint64Data) {
                ...
                for (var n = 0; n < e.uint64Data.length; ++n)
                  y.Long
                    ? ((r.uint64Data[n] = y.Long.fromValue(e.uint64Data[n])).unsigned = !0)
            ...
            (t.toObject = function (e, r) {
              ...
              if (
                ...
                r.defaults &&
                  ...
                  r.bytes === String
                    ? (n.rawData = "")
                    : ((n.rawData = []), r.bytes !== Array && (n.rawData = y.newBuffer(n.rawData))),
                  (n.docString = ""),
                ...
                for (var s = 0; s < e.dims.length; ++s)
                  typeof e.dims[s] == "number"
                    ? (n.dims[s] = r.longs === String ? String(e.dims[s]) : e.dims[s])
                    : (n.dims[s] =
                        r.longs === String
                          ? y.Long.prototype.toString.call(e.dims[s])
                          : r.longs === Number
                            ? new y.LongBits(e.dims[s].low >>> 0, e.dims[s].high >>> 0).toNumber()
                            : e.dims[s]);
              }
              if (
                (e.dataType != null && e.hasOwnProperty("dataType") && (n.dataType = e.dataType),
                e.segment != null &&
                  e.hasOwnProperty("segment") &&
                  (n.segment = m.onnx.TensorProto.Segment.toObject(e.segment, r)),
                e.floatData && e.floatData.length)
              ) {
                n.floatData = [];
                for (var s = 0; s < e.floatData.length; ++s)
                  n.floatData[s] =
                    r.json && !isFinite(e.floatData[s]) ? String(e.floatData[s]) : e.floatData[s];
              }
              ...
              if (e.stringData && e.stringData.length) {
                ...
                for (var s = 0; s < e.stringData.length; ++s)
                  n.stringData[s] =
                    r.bytes === String
                      ? y.base64.encode(e.stringData[s], 0, e.stringData[s].length)
                      : r.bytes === Array
              ...
              if (e.int64Data && e.int64Data.length) {
                ...
                for (var s = 0; s < e.int64Data.length; ++s)
                  typeof e.int64Data[s] == "number"
                    ? (n.int64Data[s] =
                        r.longs === String ? String(e.int64Data[s]) : e.int64Data[s])
                    : (n.int64Data[s] =
                        r.longs === String
                          ? y.Long.prototype.toString.call(e.int64Data[s])
                          : r.longs === Number
                            ? new y.LongBits(
                                e.int64Data[s].low >>> 0,
              ...
              if (
                ...
                e.rawData != null &&
                  ...
                  (n.rawData =
                    r.bytes === String
                      ? y.base64.encode(e.rawData, 0, e.rawData.length)
                      : r.bytes === Array
              ...
              if (e.uint64Data && e.uint64Data.length) {
                ...
                for (var s = 0; s < e.uint64Data.length; ++s)
                  typeof e.uint64Data[s] == "number"
                    ? (n.uint64Data[s] =
                        r.longs === String ? String(e.uint64Data[s]) : e.uint64Data[s])
                    : (n.uint64Data[s] =
                        r.longs === String
                          ? y.Long.prototype.toString.call(e.uint64Data[s])
                          : r.longs === Number
                            ? new y.LongBits(
              ...
              if (
                ...
                for (var s = 0; s < e.externalData.length; ++s)
                  n.externalData[s] = m.onnx.StringStringEntryProto.toObject(e.externalData[s], r);
              }
              return (
                e.dataLocation != null &&
                  ...
                  (n.dataLocation =
                    r.enums === String
                      ? m.onnx.TensorProto.DataLocation[e.dataLocation] === void 0
                        ? e.dataLocation
            ...
            (t.Segment = (function () {
              ...
              return (
                (o.prototype.begin = y.Long ? y.Long.fromBits(0, 0, !1) : 0),
                (o.prototype.end = y.Long ? y.Long.fromBits(0, 0, !1) : 0),
                (o.create = function (r) {
                  return new o(r);
                }),
                ...
                (o.decode = function (r, n) {
                  ...
                  for (
                    var s = n === void 0 ? r.len : r.pos + n, i = new m.onnx.TensorProto.Segment();
                    r.pos < s;
                ...
                (o.verify = function (r) {
                  return typeof r != "object" || r === null
                    ...
                    : r.begin != null &&
                        ...
                        !y.isInteger(r.begin) &&
                        !(r.begin && y.isInteger(r.begin.low) && y.isInteger(r.begin.high))
                      ? "begin: integer|Long expected"
                      : r.end != null &&
                          r.hasOwnProperty("end") &&
                          !y.isInteger(r.end) &&
                          !(r.end && y.isInteger(r.end.low) && y.isInteger(r.end.high))
                ...
                (o.fromObject = function (r) {
                  ...
                  return (
                    r.begin != null &&
                      (y.Long
                        ? ((n.begin = y.Long.fromValue(r.begin)).unsigned = !1)
                        : typeof r.begin == "string"
                          ? (n.begin = parseInt(r.begin, 10))
                          : typeof r.begin == "number"
                            ? (n.begin = r.begin)
                            : typeof r.begin == "object" &&
                              (n.begin = new y.LongBits(
                                r.begin.low >>> 0,
                                r.begin.high >>> 0
                              ).toNumber())),
                    r.end != null &&
                      (y.Long
                        ? ((n.end = y.Long.fromValue(r.end)).unsigned = !1)
                        : typeof r.end == "string"
                          ? (n.end = parseInt(r.end, 10))
                          : typeof r.end == "number"
                            ? (n.end = r.end)
                            : typeof r.end == "object" &&
                              (n.end = new y.LongBits(
                                r.end.low >>> 0,
                                r.end.high >>> 0
                              ).toNumber())),
                    n
                ...
                (o.toObject = function (r, n) {
                  ...
                  return (
                    r.begin != null &&
                      r.hasOwnProperty("begin") &&
                      (typeof r.begin == "number"
                        ? (s.begin = n.longs === String ? String(r.begin) : r.begin)
                        : (s.begin =
                            n.longs === String
                              ? y.Long.prototype.toString.call(r.begin)
                              : n.longs === Number
                                ? new y.LongBits(r.begin.low >>> 0, r.begin.high >>> 0).toNumber()
                                : r.begin)),
                    r.end != null &&
                      r.hasOwnProperty("end") &&
                      (typeof r.end == "number"
                        ...
                        : (s.end =
                            n.longs === String
                              ? y.Long.prototype.toString.call(r.end)
                              : n.longs === Number
                                ? new y.LongBits(r.end.low >>> 0, r.end.high >>> 0).toNumber()
                                : r.end)),
                    s
                  );
                }),
                ...
                (o.getTypeUrl = function (r) {
                  return (
                    r === void 0 && (r = "type.googleapis.com"), r + "/onnx.TensorProto.Segment"
                  );
                }),
                o
              );
        ...
        (a.SparseTensorProto = (function () {
          ...
          return (
            ...
            (t.encode = function (e, r) {
              if (
                ...
                e.values != null &&
                  ...
                  m.onnx.TensorProto.encode(e.values, r.uint32(10).fork()).ldelim(),
                e.indices != null &&
                  Object.hasOwnProperty.call(e, "indices") &&
                  m.onnx.TensorProto.encode(e.indices, r.uint32(18).fork()).ldelim(),
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.SparseTensorProto();
                e.pos < n;
            ...
            (t.verify = function (e) {
              ...
              if (e.dims != null && e.hasOwnProperty("dims")) {
                ...
                for (var n = 0; n < e.dims.length; ++n)
                  if (
                    !y.isInteger(e.dims[n]) &&
                    !(e.dims[n] && y.isInteger(e.dims[n].low) && y.isInteger(e.dims[n].high))
                  )
                    return "dims: integer|Long[] expected";
              }
              return null;
            ...
            (t.toObject = function (e, r) {
              ...
              if (
                ...
                e.values != null &&
                  ...
                  (n.values = m.onnx.TensorProto.toObject(e.values, r)),
                e.indices != null &&
                  e.hasOwnProperty("indices") &&
                  (n.indices = m.onnx.TensorProto.toObject(e.indices, r)),
                e.dims && e.dims.length)
              ) {
                n.dims = [];
                for (var s = 0; s < e.dims.length; ++s)
        ...
        (a.TensorShapeProto = (function () {
          ...
          return (
            (t.prototype.dim = y.emptyArray),
            (t.create = function (e) {
              return new t(e);
            }),
            (t.encode = function (e, r) {
              if ((r || (r = Ee.create()), e.dim != null && e.dim.length))
                for (var n = 0; n < e.dim.length; ++n)
                  m.onnx.TensorShapeProto.Dimension.encode(e.dim[n], r.uint32(10).fork()).ldelim();
              return r;
            }),
            (t.encodeDelimited = function (e, r) {
              return this.encode(e, r).ldelim();
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.TensorShapeProto();
                e.pos < n;
                ...
                switch (i >>> 3) {
                  case 1: {
                    (s.dim && s.dim.length) || (s.dim = []),
                      s.dim.push(m.onnx.TensorShapeProto.Dimension.decode(e, e.uint32()));
                    break;
                  }
                  default:
                    e.skipType(i & 7);
            ...
            (t.toObject = function (e, r) {
              ...
              if (((r.arrays || r.defaults) && (n.dim = []), e.dim && e.dim.length)) {
                ...
                for (var s = 0; s < e.dim.length; ++s)
                  n.dim[s] = m.onnx.TensorShapeProto.Dimension.toObject(e.dim[s], r);
              }
              return n;
            }),
            (t.prototype.toJSON = function () {
            ...
            (t.Dimension = (function () {
              ...
              return (
                Object.defineProperty(o.prototype, "value", {
                  get: y.oneOfGetter((e = ["dimValue", "dimParam"])),
                  set: y.oneOfSetter(e),
                }),
                (o.create = function (n) {
                  return new o(n);
                ...
                (o.decode = function (n, s) {
                  ...
                  for (
                    var i = s === void 0 ? n.len : n.pos + s,
                      u = new m.onnx.TensorShapeProto.Dimension();
                    n.pos < i;
                ...
                (o.fromObject = function (n) {
                  ...
                  return (
                    n.dimValue != null &&
                      (y.Long
                        ? ((s.dimValue = y.Long.fromValue(n.dimValue)).unsigned = !1)
                ...
                (o.toObject = function (n, s) {
                  ...
                  return (
                    ...
                    n.dimValue != null &&
                      n.hasOwnProperty("dimValue") &&
                      (typeof n.dimValue == "number"
                        ? (i.dimValue = s.longs === String ? String(n.dimValue) : n.dimValue)
                        : (i.dimValue =
                            s.longs === String
                              ? y.Long.prototype.toString.call(n.dimValue)
                              : s.longs === Number
                                ? new y.LongBits(
                                    n.dimValue.low >>> 0,
                                    n.dimValue.high >>> 0
                    ...
                    n.dimParam != null &&
                      ...
                      ((i.dimParam = n.dimParam), s.oneofs && (i.value = "dimParam")),
                    n.denotation != null &&
                      n.hasOwnProperty("denotation") &&
        ...
        (a.TypeProto = (function () {
          ...
          return (
            Object.defineProperty(t.prototype, "value", {
              get: y.oneOfGetter(
                (o = ["tensorType", "sequenceType", "mapType", "optionalType", "sparseTensorType"])
              ),
              set: y.oneOfSetter(o),
            }),
            (t.create = function (r) {
            ...
            (t.encode = function (r, n) {
              return (
                ...
                r.tensorType != null &&
                  ...
                  m.onnx.TypeProto.Tensor.encode(r.tensorType, n.uint32(10).fork()).ldelim(),
                r.sequenceType != null &&
                  Object.hasOwnProperty.call(r, "sequenceType") &&
                  m.onnx.TypeProto.Sequence.encode(r.sequenceType, n.uint32(34).fork()).ldelim(),
                r.mapType != null &&
                  Object.hasOwnProperty.call(r, "mapType") &&
                  m.onnx.TypeProto.Map.encode(r.mapType, n.uint32(42).fork()).ldelim(),
                r.denotation != null &&
                ...
                r.sparseTensorType != null &&
                  ...
                  m.onnx.TypeProto.SparseTensor.encode(
                    r.sparseTensorType,
                    n.uint32(66).fork()
                  ).ldelim(),
                r.optionalType != null &&
                  Object.hasOwnProperty.call(r, "optionalType") &&
                  m.onnx.TypeProto.Optional.encode(r.optionalType, n.uint32(74).fork()).ldelim(),
                n
              );
            }),
            ...
            (t.decode = function (r, n) {
              r instanceof N || (r = N.create(r));
              for (
                var s = n === void 0 ? r.len : r.pos + n, i = new m.onnx.TypeProto();
                r.pos < s;
            ...
            (t.toObject = function (r, n) {
              ...
              return (
                ...
                r.tensorType != null &&
                  ...
                  ((s.tensorType = m.onnx.TypeProto.Tensor.toObject(r.tensorType, n)),
                  n.oneofs && (s.value = "tensorType")),
                r.sequenceType != null &&
                  r.hasOwnProperty("sequenceType") &&
                  ((s.sequenceType = m.onnx.TypeProto.Sequence.toObject(r.sequenceType, n)),
                  n.oneofs && (s.value = "sequenceType")),
                r.mapType != null &&
                  r.hasOwnProperty("mapType") &&
                  ((s.mapType = m.onnx.TypeProto.Map.toObject(r.mapType, n)),
                ...
                r.sparseTensorType != null &&
                  ...
                  ((s.sparseTensorType = m.onnx.TypeProto.SparseTensor.toObject(
                    r.sparseTensorType,
                    n
                  )),
                ...
                r.optionalType != null &&
                  ...
                  ((s.optionalType = m.onnx.TypeProto.Optional.toObject(r.optionalType, n)),
            ...
            (t.Tensor = (function () {
              ...
              return (
                ...
                (e.encode = function (n, s) {
                  return (
                    ...
                    n.shape != null &&
                      ...
                      m.onnx.TensorShapeProto.encode(n.shape, s.uint32(18).fork()).ldelim(),
                    s
                  );
                }),
                ...
                (e.decode = function (n, s) {
                  n instanceof N || (n = N.create(n));
                  for (
                    var i = s === void 0 ? n.len : n.pos + s, u = new m.onnx.TypeProto.Tensor();
                    n.pos < i;
                ...
                (e.toObject = function (n, s) {
                  ...
                  return (
                    ...
                    n.elemType != null && n.hasOwnProperty("elemType") && (i.elemType = n.elemType),
                    n.shape != null &&
                      n.hasOwnProperty("shape") &&
                      (i.shape = m.onnx.TensorShapeProto.toObject(n.shape, s)),
                    i
                  );
                }),
              ...
              return (
                ...
                (e.encode = function (n, s) {
                  return (
                    ...
                    n.elemType != null &&
                      Object.hasOwnProperty.call(n, "elemType") &&
                      m.onnx.TypeProto.encode(n.elemType, s.uint32(10).fork()).ldelim(),
                    s
                  );
                }),
                (e.encodeDelimited = function (n, s) {
                ...
                (e.decode = function (n, s) {
                  n instanceof N || (n = N.create(n));
                  for (
                    var i = s === void 0 ? n.len : n.pos + s, u = new m.onnx.TypeProto.Sequence();
                    n.pos < i;
                ...
                (e.toObject = function (n, s) {
                  ...
                  return (
                    ...
                    n.elemType != null &&
                      n.hasOwnProperty("elemType") &&
                      (i.elemType = m.onnx.TypeProto.toObject(n.elemType, s)),
                    i
                  );
                }),
                (e.prototype.toJSON = function () {
                ...
                (e.getTypeUrl = function (n) {
                  return (
                    n === void 0 && (n = "type.googleapis.com"), n + "/onnx.TypeProto.Sequence"
                  );
                }),
                e
              );
            ...
            (t.Map = (function () {
              ...
              return (
                ...
                (e.encode = function (n, s) {
                  return (
                    ...
                    n.valueType != null &&
                      ...
                      m.onnx.TypeProto.encode(n.valueType, s.uint32(18).fork()).ldelim(),
                    s
                  );
                }),
                (e.encodeDelimited = function (n, s) {
                ...
                (e.decode = function (n, s) {
                  n instanceof N || (n = N.create(n));
                  for (
                    var i = s === void 0 ? n.len : n.pos + s, u = new m.onnx.TypeProto.Map();
                    n.pos < i;
                ...
                (e.verify = function (n) {
                  if (typeof n != "object" || n === null) return "object expected";
                  if (n.keyType != null && n.hasOwnProperty("keyType") && !y.isInteger(n.keyType))
                ...
                (e.toObject = function (n, s) {
                  ...
                  return (
                    ...
                    n.keyType != null && n.hasOwnProperty("keyType") && (i.keyType = n.keyType),
                    n.valueType != null &&
                      n.hasOwnProperty("valueType") &&
                      (i.valueType = m.onnx.TypeProto.toObject(n.valueType, s)),
                    i
                  );
                }),
                (e.prototype.toJSON = function () {
            ...
            (t.Optional = (function () {
              ...
              return (
                ...
                (e.decode = function (n, s) {
                  n instanceof N || (n = N.create(n));
                  for (
                    var i = s === void 0 ? n.len : n.pos + s, u = new m.onnx.TypeProto.Optional();
                    n.pos < i;
            ...
            (t.SparseTensor = (function () {
              ...
              return (
                ...
                (e.decode = function (n, s) {
                  ...
                  for (
                    var i = s === void 0 ? n.len : n.pos + s,
                      u = new m.onnx.TypeProto.SparseTensor();
                    n.pos < i;
                ...
                (e.getTypeUrl = function (n) {
                  return (
                    n === void 0 && (n = "type.googleapis.com"), n + "/onnx.TypeProto.SparseTensor"
                  );
                }),
                e
              );
        ...
        (a.OperatorSetIdProto = (function () {
          ...
          return (
            (t.prototype.domain = ""),
            (t.prototype.version = y.Long ? y.Long.fromBits(0, 0, !1) : 0),
            (t.create = function (e) {
              return new t(e);
            }),
            (t.encode = function (e, r) {
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.OperatorSetIdProto();
                e.pos < n;
            ...
            (t.verify = function (e) {
              return typeof e != "object" || e === null
                ? "object expected"
                : e.domain != null && e.hasOwnProperty("domain") && !y.isString(e.domain)
                  ? "domain: string expected"
                  : e.version != null &&
                      e.hasOwnProperty("version") &&
                      !y.isInteger(e.version) &&
                      !(e.version && y.isInteger(e.version.low) && y.isInteger(e.version.high))
            ...
            (t.fromObject = function (e) {
              ...
              return (
                ...
                e.version != null &&
                  (y.Long
                    ? ((r.version = y.Long.fromValue(e.version)).unsigned = !1)
                    : typeof e.version == "string"
                      ? (r.version = parseInt(e.version, 10))
                      : typeof e.version == "number"
                        ? (r.version = e.version)
                        : typeof e.version == "object" &&
                          (r.version = new y.LongBits(
                            e.version.low >>> 0,
                            e.version.high >>> 0
                          ).toNumber())),
                r
            ...
            (t.toObject = function (e, r) {
              ...
              return (
                ...
                e.version != null &&
                  e.hasOwnProperty("version") &&
                  (typeof e.version == "number"
                    ? (n.version = r.longs === String ? String(e.version) : e.version)
                    : (n.version =
                        r.longs === String
                          ? y.Long.prototype.toString.call(e.version)
                          : r.longs === Number
                            ? new y.LongBits(e.version.low >>> 0, e.version.high >>> 0).toNumber()
                            : e.version)),
                n
              );
            }),
        ...
        (a.FunctionProto = (function () {
          ...
          return (
            ...
            (t.prototype.output = y.emptyArray),
            (t.prototype.attribute = y.emptyArray),
            (t.prototype.attributeProto = y.emptyArray),
            (t.prototype.node = y.emptyArray),
            (t.prototype.docString = ""),
            (t.prototype.opsetImport = y.emptyArray),
            (t.prototype.domain = ""),
            ...
            (t.encode = function (e, r) {
              if (
                ...
                for (var n = 0; n < e.input.length; ++n) r.uint32(34).string(e.input[n]);
              if (e.output != null && e.output.length)
                for (var n = 0; n < e.output.length; ++n) r.uint32(42).string(e.output[n]);
              if (e.attribute != null && e.attribute.length)
                for (var n = 0; n < e.attribute.length; ++n) r.uint32(50).string(e.attribute[n]);
              if (e.node != null && e.node.length)
                for (var n = 0; n < e.node.length; ++n)
                  m.onnx.NodeProto.encode(e.node[n], r.uint32(58).fork()).ldelim();
              if (
                (e.docString != null &&
                  Object.hasOwnProperty.call(e, "docString") &&
                ...
                for (var n = 0; n < e.opsetImport.length; ++n)
                  m.onnx.OperatorSetIdProto.encode(e.opsetImport[n], r.uint32(74).fork()).ldelim();
              if (
                (e.domain != null &&
                  Object.hasOwnProperty.call(e, "domain") &&
                ...
                for (var n = 0; n < e.attributeProto.length; ++n)
                  m.onnx.AttributeProto.encode(e.attributeProto[n], r.uint32(90).fork()).ldelim();
              return r;
            }),
            (t.encodeDelimited = function (e, r) {
              return this.encode(e, r).ldelim();
            ...
            (t.decode = function (e, r) {
              e instanceof N || (e = N.create(e));
              for (
                var n = r === void 0 ? e.len : e.pos + r, s = new m.onnx.FunctionProto();
                e.pos < n;
                ...
                switch (i >>> 3) {
                  ...
                  case 11: {
                    (s.attributeProto && s.attributeProto.length) || (s.attributeProto = []),
                      s.attributeProto.push(m.onnx.AttributeProto.decode(e, e.uint32()));
                    break;
                  }
                  case 7: {
                    (s.node && s.node.length) || (s.node = []),
            ...
            (t.verify = function (e) {
              ...
              if (e.attribute != null && e.hasOwnProperty("attribute")) {
                if (!Array.isArray(e.attribute)) return "attribute: array expected";
                for (var r = 0; r < e.attribute.length; ++r)
                  if (!y.isString(e.attribute[r])) return "attribute: string[] expected";
              }
              ...
              return e.domain != null && e.hasOwnProperty("domain") && !y.isString(e.domain)
                ? "domain: string expected"
                : null;
            }),
            (t.fromObject = function (e) {
            ...
            (t.toObject = function (e, r) {
              ...
              if (
                ((r.arrays || r.defaults) &&
                  ...
                  (n.opsetImport = []),
                  (n.attributeProto = [])),
                r.defaults && ((n.name = ""), (n.docString = ""), (n.domain = "")),
                e.name != null && e.hasOwnProperty("name") && (n.name = e.name),
                e.input && e.input.length)
              ) {
                n.input = [];
              ...
              if (
                ...
                for (var s = 0; s < e.opsetImport.length; ++s)
                  n.opsetImport[s] = m.onnx.OperatorSetIdProto.toObject(e.opsetImport[s], r);
              }
              if (
                (e.domain != null && e.hasOwnProperty("domain") && (n.domain = e.domain),
                ...
                for (var s = 0; s < e.attributeProto.length; ++s)
                  n.attributeProto[s] = m.onnx.AttributeProto.toObject(e.attributeProto[s], r);
              }
              return n;
            }),
            (t.prototype.toJSON = function () {
      ...
      (hr = class {
        ...
        (Ke = class a {
          static calcShape(t, o, e = !1) {
            ...
            if (e) {
              if (r < 2 || n < 2) return;
              let u = mi.calcMatMulShape([t[r - 2], t[r - 1]], [o[n - 2], o[n - 1]]);
              if (u === void 0) return;
              [i[s - 2], i[s - 1]] = u;
            }
            ...
            if (s) {
              ...
              if (s.length === 0) u.set([], e(t.get([]), o.get([])));
                ...
                let l = new Array(s.length),
                  ...
                  v = !1,
                  w = !1;
                t.dims.length === 0 && ((d = t.get([])), (v = !0)),
                  o.dims.length === 0 && ((T = o.get([])), (w = !0));
                let I;
                for (let L = 0; L < i; L++) {
                  I = L;
                  for (let F = s.length - 1; F >= 0; F--)
                    (l[F] = I % s[F]), (I = Math.floor(I / s[F]));
                  v || (a.fillIndex(l, t.dims, f), (d = t.get(f))),
                    w || (a.fillIndex(l, o.dims, p), (T = o.get(p))),
                    u.set(l, e(d, T));
                }
              }
              return u;
        ...
        (Xn = class {
          static getShapeOfGemmResult(t, o, e, r, n) {
            ...
            if (n && !Ke.isValidBroadcast(n, [s, u]))
        ...
        (Ve = class a {
          ...
          static tensorValueTypeFromProto(t) {
            return {
              ...
              shape: { dims: a.tensorDimsFromProto(t.shape.dim.map((o) => o.dimValue)) },
            };
          }
        ...
        (nt = class {
          static longToNumber(t, o) {
            return Wt.isLong(t)
              ? t.toNumber()
              : t instanceof O.Long
                ? Wt.fromValue({ low: t.low, high: t.high, unsigned: o ?? !1 }).toNumber()
                : t;
          }
          static isLong(t) {
          ...
          static computeShapeHelper(t, o, e, r, n, s, i, u) {
            if (t) for (let l = 0; l < o.length - 2; l++) e.push(1);
              ...
              for (let l = 0; l < o.length - 2; l++)
                e.push(
                  a.adjustPadAndReturnShape(o[l + 2], r[l], n[l], s[l], i, l, l + o.length - 2, u)
                );
          }
              ...
              switch (u) {
                ...
                case "SAME_UPPER":
                    ...
                    throw new Error("Dilation not supported for SAME_UPPER or SAME_LOWER");
                  {
                    ...
                    return (
                      (n[s] = Math.floor(u === "SAME_LOWER" ? (p + 1) / 2 : p / 2)),
                      (n[i] = p - n[s]),
  ...
  function Nu(a) {
    switch (a) {
      ...
      case re.onnx.TensorProto.DataType.UINT64:
        return 8;
      default:
        throw new Error(`cannot calculate sizeof() on type ${re.onnx.TensorProto.DataType[a]}`);
    }
  }
  function Yd(a, t) {
    return new (Gu(t))(a);
  ...
  function gi(a, t) {
    if (t === re.onnx.TensorProto.DataType.INT64 || t === bi.TensorDataType.INT64) {
      if (a.greaterThanOrEqual(2147483648) || a.lessThan(-2147483648))
        throw new TypeError("int64 is not supported");
    } else if (
      t === re.onnx.TensorProto.DataType.UINT32 ||
      t === bi.TensorDataType.UINT32 ||
      t === re.onnx.TensorProto.DataType.UINT64 ||
      t === bi.TensorDataType.UINT64
    ) {
  ...
  function Ru(a, t, o) {
    switch (t) {
      ...
      case re.onnx.TensorProto.DataType.INT64:
        return gi(Wt.fromBits(a.getUint32(o, !0), a.getUint32(o + 4, !0), !1), t);
      case re.onnx.TensorProto.DataType.DOUBLE:
        return a.getFloat64(o, !0);
      case re.onnx.TensorProto.DataType.UINT64:
        return gi(Wt.fromBits(a.getUint32(o, !0), a.getUint32(o + 4, !0), !0), t);
      default:
  ...
  var Mu,
    ...
    yr = E(() => {
      ...
      re = Dr($r());
      fe();
      (bi = W.experimental.fbs),
        (Ce = class a {
          constructor(t, o, e, r, n, s = Mu.Guid.create()) {
            this.dims = t;
            this.type = o;
            this.dataProvider = e;
            ...
            if (o === "string") {
              if (n !== void 0 && (!Array.isArray(n) || !n.every((l) => typeof l == "string")))
          ...
          static fromProto(t) {
            ...
            let o = Ve.tensorDataTypeFromProto(t.dataType),
              e = Ve.tensorDimsFromProto(t.dims),
              r = new a(e, o);
            if (o === "string")
              ...
              let n = r.data,
                s = new DataView(t.rawData.buffer, t.rawData.byteOffset, t.rawData.byteLength),
                i = Nu(t.dataType),
              ...
              for (let i = 0; i < n.length; i++) {
                let u = n[i];
                Wt.isLong(u) ? (s[i] = gi(u, t.dataType)) : (s[i] = u);
              }
            }
            return r;
          }
          ...
          static fromOrtTensor(t) {
            if (!t) throw new Error("cannot construct Value from an empty tensor");
            let o = Ve.tensorDimsFromORTFormat(t),
              e = Ve.tensorDataTypeFromProto(t.dataType()),
              r = new a(o, e);
            if (e === "string")
              for (let n = 0; n < t.stringDataLength(); n++) r.data[n] = t.stringData(n);
            else if (
              t.rawDataArray() &&
  ...
  function Kn(a) {
    return (
      kr(typeof a < "u" && a.length !== 0, () => "empty string found for sampler name"),
  ...
  var Hu,
    ...
    ju = E(() => {
      ...
      kt();
      Tr();
      (Hu = { name: "pack", inputNames: ["A"], inputTypes: [1] }),
        (Zd = (a, t) => {
          let o = q(a.session.backend.glContext.version),
            e = t.dims,
            r = e.length,
            n = t.dims.length,
            s = Je(n),
            i = Rr("rc", n),
            u = th(n, i, e[e.length - 2], e[e.length - 1]),
            l;
    ...
    return (
      a.length === 0 || t.length === 0
        ...
        : a.length < 2 || t.length < 2
          ...
          : (o = a[a.length - 1] === t[t.length - 1] && a[a.length - 2] === t[t.length - 2]),
      o
    );
  }
  function oh(a) {
...
`;
  ...
  var rh,
    ...
    Ku = E(() => {
      ...
      `;
          ...
          let i = q(a.session.backend.glContext.version),
            u = `
      ${oh(r)}
      ${ih(n)}
      ${Bt()}
  ...
  var xi,
    Ju = E(() => {
      ...
      xi = (a, t) => {
        let o = t.shape,
          e = q(a.session.backend.glContext.version),
          r = `
  ...
  var Zu,
    ...
    el = E(() => {
      ...
      kt();
      Tr();
      (Zu = { name: "unpack", inputNames: ["A"], inputTypes: [2] }),
        (ah = (a, t) => {
          let o = t.dims.length,
            e = Rr("rc", o),
            r = e.slice(-2),
            n = Je(o),
            s = Bt(),
            u = t.dims.length === 0 ? "" : sh(o, e),
            l = o <= 1 ? "rc" : `vec2(${r.join(",")})`,
            f = q(a.session.backend.glContext.version),
            p = `
    ${s}
    void main() {
        ...
        encode(t, o) {
          ...
          return (
            t.constructor !== Float32Array &&
              (ce.warning("Encoder", "data was not of type Float32; creating new Float32Array"),
              (r = new Float32Array(t))),
            o * this.channelSize > t.length
              ? (ce.warning("Encoder", "Source data too small. Allocating larger array"),
                (r = t),
    ...
    rl = E(() => {
      ...
      (pn = (a, t, o) => {
        let e = o === 0 || o === 1 ? 1 : 4,
          ...
          i = o === 4 ? t.map((u, l) => (l === t.length - 1 ? u * 4 : u)) : void 0;
        return wi(a, t, e, i, { isPacked: r, reverseWH: n, breakAxis: s });
      }),
        (tl = (a, t, o) => {
          let e = pn(a, t, o);
  ...
  var lh,
    ...
    ol = E(() => {
      ...
      ae();
      (lh = (a, t) => {
        let o = t.map((r) => `${r.unpackedShape.join(",")};${r.width}x${r.height}`).join("_"),
          e = a.name;
        ...
        (Qn = class {
          ...
          calculateTextureWidthAndHeight(t, o) {
            return tl(this.session.layoutStrategy, t, o);
          }
          executeProgram(t, o) {
            ...
            let r = lh(t, e),
              ...
              i = pn(this.session.layoutStrategy, s.output.dims, s.output.textureType),
          ...
          getOrCreateTextureData(t, o) {
            ...
            if (!e) {
              ...
              if (o === 4) {
                ...
                if (i.length === 4) {
                  let u = [i[0], Math.ceil((i[1] * i[2] * i[3]) / 4)],
                    l = pn(this.session.layoutStrategy, u, o),
                    f = t.numberData;
                  if ((i[1] * i[2] * i[3]) % 4 !== 0) {
                    let p = i[0],
                      d = i[1] * i[2] * i[3],
              ...
              if (o === 2) {
                let n = wi(this.session.layoutStrategy, t.dims, 1, [], { reverseWH: !0 }),
          ...
          setTextureData(t, o, e = !1) {
            this.session.isInitializer(t)
              ...
              : (e ? this.packedTextureDataCache : this.unpackedTextureDataCache).set(t, o);
          }
          ...
          readTexture(t) {
            return t.isPacked
              ...
              : this.session.backend.glContext.isFloat32DownloadSupported
                ...
                : this.session.textureManager.readUint8TextureAsFloat(xi(this, t));
          }
          ...
          pack(t) {
            return this.executeProgram(qu(this, t.tensor), [t.tensor]);
          }
          unpack(t) {
            return this.executeProgram(Qu(this, t.tensor), [t.tensor]);
          }
  ...
  var il,
    ...
    ul = E(() => {
      ...
      (il = {
        ...
        (al = (a, t, o) => (
          ch(t), [a.run({ ...il, cacheHint: o.cacheKey, get: () => fh(a, t, o) }, t)]
        )),
        (sl = (a) => {
          let t = a.attributes.getFloat("epsilon", 1e-5),
            o = a.attributes.getFloat("momentum", 0.9),
            e = a.attributes.getInt("spatial", 1);
          return ee({ epsilon: t, momentum: o, spatial: e });
        }),
        (fh = (a, t, o) => {
          let e = q(a.session.backend.glContext.version),
            r = t[0].dims.length,
  ...
  var ct,
    ...
    wl = E(() => {
        ...
        (Sh = (a, t, o, e = t[0].type) => {
          ...
          if (n) {
            ...
            let p = s.length,
              ...
              I = q(a.session.backend.glContext.version),
              L = i
                ? `
      ${o.body}
      void main() {
      ...
      float process(int indices[${p}]) {
        ...
        return ${o.name}(_A(aindices), _B(bindices));
          ...
          let u = q(a.session.backend.glContext.version),
            l = `
    ${o.body}
    void main() {
    ...
    `;
        ...
        (ll = (a, t) => [a.run(ct(a, t, dh()), t)]),
        (fl = (a, t) => [a.run(ct(a, t, xh(), "bool"), t)]),
        (cl = (a, t) => [a.run(ct(a, t, hh()), t)]),
        (pl = (a, t) => [a.run(ct(a, t, gh(), "bool"), t)]),
        (dl = (a, t) => [a.run(ct(a, t, yh(), "bool"), t)]),
        (hl = (a, t) => [a.run(ct(a, t, Th(), "bool"), t)]),
        (ml = (a, t) => [a.run(ct(a, t, mh()), t)]),
        (bl = (a, t) => [a.run(ct(a, t, wh(), "bool"), t)]),
        (gl = (a, t) => [a.run(ct(a, t, _h()), t)]),
        (yl = (a, t) => [a.run(ct(a, t, Oh()), t)]),
        (Tl = (a, t) => [a.run(ct(a, t, bh()), t)]),
        (xl = (a, t) => [a.run(ct(a, t, vh(), "bool"), t)]);
    });
  var vl,
    _l,
    Ph,
    Ol = E(() => {
      "use strict";
      fe();
      (vl = (a, t, o) => (Ph(t), [a.cast(t[0], o)])),
        (_l = (a) => Ve.tensorDataTypeFromProto(a.attributes.getInt("to"))),
        (Ph = (a) => {
        ...
        return getChannel(
          ...
          I += `
            return getChannel(
              getX${L}(${ro(p, T, F)}),
              vec2(${ro(v, T, F)}));`;
          let C = q(a.session.backend.glContext.version),
            Y = `
          ${l}
  ...
  var Al,
    ...
    Dl = E(() => {
      ...
      (Al = (a, t, o) => (
        Nh(t),
        a.session.pack && t[0].dims.length > 1 ? [a.run(Il(a, t, o), t)] : [a.run(Ch(a, t, o), t)]
      )),
        (Lh = (a, t) => ({
          name: "Concat",
          inputNames: Array.from({ length: a }, (o, e) => `X${e}`),
        ...
        (Ch = (a, t, o) => {
          ...
          return { ...e, get: () => Fh(a, e, t, o.axis) };
        }),
        (Pl = (a) => `int getTextureWhereDataResides(int index) {
      ${a
        .map(
          ...
          for (let e = 0; e < a; ++e)
            e === 0
              ...
              : e === a - 1
                ...
                : o.push(`	else if (textureIndex == ${e}) { return _X${e}(indices); }`);
          return (
            o.push("	}"),
            o.join(`
`)
...
`)
        ...
        (El = (a) => ee({ axis: a.attributes.getInt("axis") })),
        (Nh = (a) => {
  ...
  var rm,
    ...
    Pi = E(() => {
      ...
      (rm = (a, t, o, e) => {
        let r = a.session.pack ? 2 : 0,
          n = q(a.session.backend.glContext.version);
        return {
          ...t,
     ...
     `,
        ...
        (De = (a, t, o, e) => {
          let r = a.session.pack ? 2 : 0,
            n = { name: o.name, inputTypes: [r], inputNames: ["A"], cacheHint: e };
          return { ...n, get: () => rm(a, n, t, o) };
        }),
        (Ll = (a, t) => [a.run(De(a, t[0], Rh()), t)]),
        (Fl = (a, t) => [a.run(De(a, t[0], Mh()), t)]),
        (Cl = (a, t) => [a.run(De(a, t[0], Gh()), t)]),
        ($l = (a, t) => [a.run(De(a, t[0], Uh()), t)]),
        (Si = (a, t, o) => [a.run(De(a, t[0], _i(o.min, o.max), o.cacheKey), t)]),
        (kl = (a) =>
          ee({ min: a.attributes.getFloat("min", br), max: a.attributes.getFloat("max", gr) })),
        (Bl = (a, t) => {
          let o = nm(a, t);
          return Si(a, [t[0]], o);
        }),
        (nm = (a, t) => {
          if (
            t.length >= 3 &&
            (!a.session.isInitializer(t[1].dataId) || !a.session.isInitializer(t[2].dataId))
          )
            throw new Error("dynamic clip attributes are not allowed");
          let o = t.length >= 3 ? t[1].numberData[0] : br,
            e = t.length >= 3 ? t[2].numberData[0] : gr;
          return ee({ min: o, max: e });
        }),
        (Nl = (a, t) => [a.run(De(a, t[0], zh()), t)]),
        (Rl = (a, t) => [a.run(De(a, t[0], Vh()), t)]),
        (Ml = (a, t, o) => [a.run(De(a, t[0], Wh(o.alpha), o.cacheKey), t)]),
        (Gl = (a) => ee({ alpha: a.attributes.getFloat("alpha", 1) })),
        (Ul = (a, t) => [a.run(De(a, t[0], Hh()), t)]),
        (zl = (a, t) => [a.run(De(a, t[0], qh()), t)]),
        (Ai = (a, t) => [a.run(De(a, t[0], jh()), t)]),
        (Vl = (a, t, o) => [a.run(De(a, t[0], Yh(o.alpha), o.cacheKey), t)]),
        (Wl = (a) => ee({ alpha: a.attributes.getFloat("alpha", 0.01) })),
        (Hl = (a, t) => [a.run(De(a, t[0], Xh()), t)]),
        (ql = (a, t) => [a.run(De(a, t[0], Kh()), t)]),
        (jl = (a, t) => [a.run(De(a, t[0], Jh()), t)]),
        (Yl = (a, t) => [a.run(De(a, t[0], Oi()), t)]),
        (Xl = (a, t) => [a.run(De(a, t[0], Ii()), t)]),
        (Kl = (a, t) => [a.run(De(a, t[0], Zh()), t)]),
        (Jl = (a, t) => [a.run(De(a, t[0], Qh()), t)]),
        (Zl = (a, t) => [a.run(De(a, t[0], em()), t)]),
        (Ql = (a, t) => [a.run(De(a, t[0], tm()), t)]);
    });
  function Nt(a) {
    let t;
    switch (a.activation) {
    ...
    tf = E(() => {
      ...
      (im = (a, t) => ({
        ...
        (am = (a, t, o, e) => {
          ...
          let l = Gr(s, i, e.dilations, e.pads, e.strides),
            f = q(a.session.backend.glContext.version),
            { activationFunction: p, applyActivation: d } = Nt(e),
            T = `
...
`;
  ...
  var sm,
    ...
    nf = E(() => {
      ...
      ae();
      Tr();
      (sm = (a) => ({ name: "Im2Col (packed)", inputNames: ["A"], inputTypes: [2], cacheHint: a })),
        (um = (a, t, o, e, r, n) => {
          let s = o.dims,
            i = e.dims,
            u = 2,
            ...
            d = i[2] * i[3],
            T = Bt(),
            v = q(a.session.backend.glContext.version),
            w = "";
          for (let L = 0; L <= 1; L++)
            for (let F = 0; F <= 1; F++)
              w += `
      ...
      void main() {
        ...
        (rf = (a, t, o, e, r) => {
          let n = sm(r.cacheKey);
          return { ...n, get: () => um(a, n, t, o, e, r) };
        });
    });
  function fm(a, t, o) {
    let e = t[0].dims,
      r = t[1].dims,
      n = Ke.calcShape(e, r, !0);
    if (!n) throw new Error("Can't use matmul on the given tensors");
    let s = Je(n.length),
      i = Ot(),
      { activationFunction: u, applyActivation: l } = Nt(o),
      f = t.length > 2,
      p = f ? "value += getBiasForMatmul();" : "",
      d = f ? `${Di(s, i, t[2].dims, n, !1)}` : "",
      T = n.length,
      v = e.length,
      w = r.length,
      I = e[e.length - 1],
    ...
    return { ...a, output: { dims: n, type: t[0].type, textureType: 0 }, shaderSource: L };
  }
  function Ei(a, t) {
    let o = lm(a.length > 2, t.activationCacheKey);
    return { ...o, get: () => fm(o, a, t) };
  }
  function Di(a, t, o, e, r) {
    let n = "",
      s = o.length,
      i = e.length,
      u = i - s;
...
float getBiasForMatmul() {
  ...
  var of,
    ...
    oo = E(() => {
      ...
      xr();
      Li();
      (of = (a, t, o) => (cm(t), a.session.pack ? [a.run(io(a, t, o), t)] : [a.run(Ei(t, o), t)])),
        (af = (a) => Mr(a.attributes)),
        (lm = (a, t) => ({
          name: "MatMul",
  ...
  function hm(a, t, o, e) {
    let r = [],
      ...
      p = f - u,
      d = f - l;
    (r = s.map((C, Y) => `coords.${t[Y + p]}`)),
      (r[u - 1] = "i*2"),
      r.join(", "),
      (n = i.map((C, Y) => `coords.${t[Y + d]}`)),
      (n[l - 2] = "i*2"),
      n.join(", ");
    let T = Ke.getBroadcastDims(s, e),
      v = Ke.getBroadcastDims(i, e),
      w = T.map((C) => `coords.${t[C + p]} = 0;`).join(`
`),
...
vec4 getBAtOutCoordsMatmul(int i) {
      ...
      (pm = (a, t) => ({
        ...
        (dm = (a, t, o, e) => {
          ...
          let f = s[s.length - 1],
            ...
            I = u.length,
            L = Ot(),
            { activationFunction: F, applyActivation: C } = Nt(e),
            Y = r ? `${Di(w, L, o[2].dims, u, !0)}` : "",
            j = l ? `${hm(w, L, o, u)}` : "",
            M = l ? "getAAtOutCoordsMatmul(i)" : `getA(${mm(L, d)})`,
            ie = l ? "getBAtOutCoordsMatmul(i)" : `getB(${bm(L, T)})`,
            ot = l
              ? ""
              : `${w} rc =
  ...
  var sf,
    uf = E(() => {
      ...
      sf = (a, t, o) => {
        let e = t[0].dims,
          r = t[1].dims,
          n = Gr(e, r, o.dilations, o.pads, o.strides),
          s = a.run(rf(a, t[0], t[1], n, o), [t[0]]),
  ...
  var gm,
    ...
    Ci = E(() => {
      "use strict";
      ae();
      (gm = (a) => ({ name: "Im2Col", inputNames: ["X"], inputTypes: [0], cacheHint: a })),
        (ym = (a, t, o, e, r, n) => {
          let s = o.dims,
            i = e.dims,
            u = r.length,
        ...
        `;
          return { ...t, output: { dims: l, type: o.type, textureType: 4 }, shaderSource: f };
        }),
        (lf = (a, t, o, e, r) => {
          let n = gm(r.cacheKey);
          return { ...n, get: () => ym(a, n, t, o, e, r) };
        }),
        (Fi = (a, t, o, e = 4) => [o[0], o[2], o[3], Math.ceil((a[1] * t[2] * t[3]) / e)]);
    });
  var Tm,
    xm,
    ff,
      ...
      (Tm = (a, t) => ({
        ...
        (xm = (a, t, o, e, r) => {
          let n = o[0].dims,
            ...
            u = Fi(n, s, e),
            [l, f] = a.calculateTextureWidthAndHeight(i, 4),
            p = U.computeStrides(u),
            [d, T] = a.calculateTextureWidthAndHeight(u, 4),
            v = e.length,
            w = o.length < 3 ? "0.0" : "_B(b)",
            I = Math.ceil((n[1] * s[2] * s[3]) / 4),
            { activationFunction: L, applyActivation: F } = Nt(r),
            C = q(a.session.backend.glContext.version),
            Y = `
${L}
float process(int indices[${v}]) {
  ...
  return value;
          ...
          return { ...t, output: { dims: e, type: o[0].type, textureType: 0 }, shaderSource: Y };
        }),
        (ff = (a, t, o, e) => {
          let r = Tm(t.length > 2, e);
          return { ...r, get: () => xm(a, r, t, o, e) };
        });
    });
  var Gr,
    $i,
    ...
    no = E(() => {
      ...
      (Gr = (a, t, o, e, r) => {
        let n = a[0],
          ...
          i = s.length,
          u = t[0],
          f = t.slice(2).map((v, w) => v + (v - 1) * (o[w] - 1)),
          d = s
            .map((v, w) => v + e[w] + e[w + i])
            .map((v, w) => Math.floor((v - f[w] + r[w]) / r[w]));
        return [n, u].concat(...d);
      }),
        ($i = (a, t, o) => (Im(t, o), wm(a, t, o))),
        (wm = (a, t, o) => {
          let e = Om(o, t),
            r = a.session.pack,
        ...
        (_m = (a, t, o) => {
          let e = t[0].dims,
            r = t[1].dims,
            n = Gr(e, r, o.dilations, o.pads, o.strides),
            s = a.run(lf(a, t[0], t[1], n, o), [t[0]]),
            i = t.length === 3 ? [s, t[1], t[2]] : [s, t[1]];
          return a.run(ff(a, t, n, o), i);
        }),
        (Om = (a, t) => {
  ...
  var Sm,
    ...
    hf = E(() => {
      ...
      ae();
      xr();
      (Sm = (a, t, o, e, r, n) => (a - 1) * t + o + (e - 1) * r + 1 - n),
        (Am = (a, t, o, e, r) => {
        ...
        (Pm = (a, t, o, e, r, n, s, i) => {
          let u = a.length - 2,
            l = i.length === 0;
          for (let f = 0; f < u; ++f) {
            let p = l ? a[f + 2] * n[f] : i[f],
              d = Sm(a[f + 2], n[f], r[f], t[f], o[f], p);
            Am(d, e, r, f, f + u),
              l && i.push(n[f] * (a[f + 2] - 1) + s[f] + (t[f] - 1) * o[f] + 1 - r[f] - r[f + u]);
          }
        }),
        (pf = (a, t, o) => (km(t, o), Em(a, t, o))),
        (Em = (a, t, o) => {
          let e = $m(o, t);
          return [Cm(a, t, e)];
        }),
        ...
        (Lm = (a, t, o, e) => {
          let n = t.length > 2 ? "getB(output_channel)" : "0.0",
            ...
            u = i[1],
            l = i[0] / e.group,
            f = [t[0].dims[0], t[1].dims[1] * e.group, ...e.outputShape],
            p = q(a.session.backend.glContext.version),
            { activationFunction: d, applyActivation: T } = Nt(e),
            v = `
  const ivec2 strides = ivec2(${e.strides[0]}, ${e.strides[1]});
  const ivec2 pads = ivec2(${e.pads[0]}, ${e.pads[1]});
  ${d}
...
`;
          return {
            ...o,
            output: { dims: f, type: t[0].type, textureType: 0 },
            shaderSource: v,
            hasMain: !0,
          };
        }),
        (Fm = (a, t, o) => {
          ...
          return { ...e, get: () => Lm(a, t, e, o) };
        }),
        (Cm = (a, t, o) => a.run(Fm(a, t, o), t)),
        ($m = (a, t) => {
          let o = a.kernelShape.slice();
          if (a.kernelShape.length === 0)
          ...
          let e = a.pads.slice(),
            ...
            n = t[0].dims;
          Pm(n, o, a.dilations, a.autoPad, e, a.strides, a.outputPadding, r);
          let s = Object.assign({}, a);
          return (
            Object.assign(s, { kernelShape: o, pads: e, outputShape: r, cacheKey: a.cacheKey }), s
          );
        }),
        (df = (a) => {
          let t = a.attributes,
  ...
  var mf,
    ...
    ao = E(() => {
      ...
      fe();
      ae();
      (mf = { name: "Transpose", inputNames: ["A"], inputTypes: [0] }),
        (wr = (a, t, o) => (
          Mm(t), [a.run({ ...mf, cacheHint: o.cacheKey, get: () => Bm(a, t[0], o.perm) }, t)]
        )),
        (bf = (a) => ee({ perm: a.attributes.getInts("perm", []) })),
        (Bm = (a, t, o) => {
          let e = t.dims;
          o = gf(e, o);
          let r = Nm(e, o),
      ...
      float process(int indices[${n}]) {
        ...
        return _A(a);
          ...
          return { ...mf, output: { dims: r, type: t.type, textureType: 0 }, shaderSource: s };
        }),
        (gf = (a, t) => (t && t.length !== a.length && (t = [...a.keys()].reverse()), t)),
        (Nm = (a, t) => ((t = gf(a, t)), U.sortBasedOnPerm(a, t))),
        (Rm = (a, t, o) => {
          let e = [];
...
`)
    ...
    xf = E(() => {
      ...
      (yf = (a, t, o) => {
        ...
        let e = o.blocksize,
          ...
          u = { perm: n, cacheKey: `${n}` },
          [l] = wr(a, [i], u),
          f = [t[0].dims[0], t[0].dims[1] / r, t[0].dims[2] * e, t[0].dims[3] * e];
        return [a.reshapeUnpacked(l, f)];
      }),
        (Tf = (a) => {
  ...
  var wf,
    ...
    _f = E(() => {
      ...
      (wf = (a, t, o) => {
        ...
        (vf = (a) => a.attributes.getInt("axis", 1)),
        (Um = (a, t) => {
  ...
  var Of,
    ...
    Sf = E(() => {
      ...
      fe();
      ae();
      (Of = (a, t, o) => (Hm(t, o.axis), [a.run(Wm(a, t, o), t)])),
        (If = (a) => ee({ axis: a.attributes.getInt("axis", 0) })),
        (zm = { name: "Gather", inputNames: ["A", "B"], inputTypes: [0, 0] }),
        (Vm = (a, t, o, e) => {
          let r = o[0].dims.slice(),
            n = o[1].dims.slice(),
          ...
          for (let d = 0; d < s.length; d++)
            d < e
              ...
              : d < e + n.length
                ? ((s[d] = n[d - e]), i.push(`indexDataIdx[${d - e}] = outputIdx[${d}];`))
                : ((s[d] = r[d - n.length + 1]),
      ...
      float process(int outputIdx[${u}]) {
        ...
        (Wm = (a, t, o) => {
          let e = { ...zm, cacheHint: o.cacheKey };
          return { ...e, get: () => Vm(a, e, t, o.axis) };
        }),
        (Hm = (a, t) => {
          ...
          if (er.indexOf(a[0].type) === -1) throw new Error("Invaid input type.");
  ...
  var Bi,
    ...
    Df = E(() => {
      ...
      fe();
      ae();
      (Bi = (a, t, o) => (Ym(t, o), [a.run(qm(t, o), t)])),
        (Af = (a, t) => {
          ...
          return ee({ transA: o, transB: e, alpha: r, beta: n, isOptionalC: t });
        }),
        (Pf = (a) => Af(a, !1)),
        (Ef = (a) => Af(a, !0)),
        (qm = (a, t) => {
          ...
          return { ...o, get: () => jm(o, a, t) };
        }),
        (jm = (a, t, o) => {
          let e = t[0].dims.slice(),
            r = t[1].dims.slice(),
            [n, s] = Xn.getShapeOfGemmResult(
              e,
              o.transA,
              r,
              o.transB,
  ...
  var Lf,
    ...
    Cf = E(() => {
      ...
      Ge();
      ae();
      (Lf = (a, t, o) => (Qm(t), [a.run(Jm(a, t, o), t)])),
        (Ff = (a) => {
          let t = a.attributes.getFloat("scale"),
            o = a.attributes.getFloats("bias");
          return ee({ scale: t, bias: o });
        }),
        (Xm = { name: "ImageScaler", inputNames: ["X"], inputTypes: [0] }),
        (Km = (a, t, o, e) => {
          let r = o[0].dims.slice(),
            n = r.length,
            i = `
      ...
      float process(int indices[${n}]) {
        ...
        (Jm = (a, t, o) => {
          let e = { ...Xm, cacheHint: o.cacheKey };
          return { ...e, get: () => Km(a, e, t, o) };
        }),
        (Zm = (a) => {
...
`)
  ...
  var kf,
    ...
    Nf = E(() => {
      ...
      (kf = (a, t, o) => {
        ib(t);
        let e = a.run(tb(t[0]), t);
        return [a.run(ob(a, t[0], o, e.dims), [t[0], e, t[1], t[2]])];
      }),
        (Bf = (a) => a.attributes.getFloat("epsilon", 1e-5)),
        ($f = {
      ...
      vec4 process(int[2] indices) {
        ...
        (nb = (a, t, o, e, r) => {
          let n = q(a.session.backend.glContext.version),
      ...
      float process(int[4] indices) {
        ...
        (ob = (a, t, o, e) => {
          let r = { ...rb, cacheHint: `${o}` };
          return { ...r, get: () => nb(a, r, t, o, e) };
        }),
        (ib = (a) => {
  ...
  function sb(a, t) {
    return { ...Gf, cacheHint: t.cacheKey, get: () => ab(a, t) };
  }
  var Rf,
    Mf,
    Gf,
    ...
    Uf = E(() => {
      ...
      (Rf = (a, t, o) => (ub(t), [a.run(sb(t, o), t)])),
        (Mf = (a) => {
          ...
          return ee({ alpha: t, beta: o, bias: e, size: r });
        }),
  ...
  var lb,
    ...
    Hf = E(() => {
      ...
      xe();
      ae();
      (lb = { name: "Pad", inputNames: ["A"], inputTypes: [0] }),
        (Ni = (a, t, o) => (
          pb(t), [a.run({ ...lb, cacheHint: o.cacheKey, get: () => cb(a, t[0], o) }, t)]
        )),
        (zf = (a) => {
          let t = a.attributes.getString("mode", "constant"),
            o = a.attributes.getFloat("value", 0),
            e = a.attributes.getInts("pads");
          return ee({ mode: t, value: o, pads: e });
        }),
        (Vf = (a, t, o) => {
          db(t);
          let e = fb(a, t, o);
        ...
        (Wf = (a) => a.attributes.getString("mode", "constant")),
        (fb = (a, t, o) => {
          if (
          ...
          return ee({ mode: o, pads: e, value: r });
        }),
        (cb = (a, t, o) => {
  ...
  var jf,
    ...
    oc = E(() => {
      ...
      (jf = (a, t, o) => {
        ...
        return [a.run({ ...e, get: () => Xf(t, e, !1, o) }, t)];
      }),
        (Yf = (a) => {
      ...
      `;
          return { ...t, output: { dims: n, type: a[0].type, textureType: 0 }, shaderSource: f };
        }),
        (Kf = (a, t, o) => {
          uo(t);
          let e = {
          ...
          return [a.run({ ...e, get: () => Xf(t, e, !0, o) }, t)];
        }),
        (Jf = (a) => {
        ...
        (Zf = (a, t, o) => {
          ...
          return [a.run({ ...e, get: () => ec(t, e, !1, o) }, t)];
        }),
        (Qf = (a) => {
          let t = a.attributes.getString("auto_pad", "NOTSET"),
            o = a.attributes.getInt("ceil_mode", 0),
    ...
    `;
        ...
        (tc = (a, t, o) => {
          ...
          return (
            r
              ...
              : Object.assign(f, { kernelShape: n, strides: s, pads: u, cacheKey: t.cacheKey }),
            [f, l]
          );
        }),
        (yb = {
        ...
        (rc = (a, t) => (uo(t), [a.run({ ...qf, get: () => ec(t, qf, !0, yb) }, t)])),
        (uo = (a) => {
        ...
        (nc = (a, t, o, e, r) => {
          ...
          for (int i = 0; i < ${s}; i++) {
            ...
            ${o}
              ...
              let w = t.kernelShape[t.kernelShape.length - 2],
                I = t.strides[t.strides.length - 2],
                L = t.pads[t.pads.length / 2 - 2],
                F = t.pads[t.pads.length - 2],
                C = a[n - 2];
              L + F !== 0
                ? (d = `
            for (int j = 0; j < ${w}; j++) {
      ...
      `;
            ...
            let s = U.size(t.kernelShape),
              ...
              p = so(a, "inputDims"),
              d = so(t.pads, "pads"),
              T = so(i, "kernelStrides"),
              v = so(t.strides, "strides"),
              w = t.pads.reduce((F, C) => F + C),
              I = "";
            return (
              w
                ? (I = `
  ...
  var vr,
    ...
    pc = E(() => {
      ...
      (vr = (a, t, o, e, r) => {
        ...
        return [a.run({ ...n, cacheHint: o.cacheKey, get: () => xb(a, t, o, e, r, n) }, t)];
      }),
        (tr = (a) => {
          let t = a.attributes.getInts("axes", []),
            o = a.attributes.getInt("keepdims", 1) === 1;
          return ee({ axes: t, keepDims: o });
        }),
        (xb = (a, t, o, e, r, n) => {
          let s = [],
            i = t[0].dims.length || 1,
            ...
            f = r(t, l),
            p = f[1];
          for (let v = 0; v < t[0].dims.length; v++)
            l.indexOf(v) >= 0 || l.length === 0
              ? (o.keepDims && s.push(1),
                (p = `
...
`)}
        ...
        (wb = (a) => {
          ...
          if (er.indexOf(a[0].type) === -1) throw new Error("Invalid input type.");
        }),
        (ic = (a, t, o) =>
          vr(a, t, o, "ReduceSum", () => ["value = 0.0;", "value += _A(inputIdx);", ""])),
        (ac = (a, t, o) =>
...
value = _A(inputIdx);`,
        ...
        (lc = (a, t, o) =>
          vr(a, t, o, "ReduceProd", () => ["value = 1.0;", "value *= _A(inputIdx);", ""])),
        (fc = (a, t, o) =>
  ...
  var mc,
    ...
    Gi = E(() => {
      ...
      xe();
      ae();
      (mc = { name: "Upsample", inputNames: ["X"], inputTypes: [0] }),
        (Ri = (a, t, o) => (
          Mi(t, o), [a.run({ ...mc, cacheHint: o.cacheKey, get: () => vb(a, t, o) }, t)]
        )),
        (bc = (a) => mn(a, 7)),
        (gc = (a) => mn(a, 9)),
        (mn = (a, t) => {
          ...
          let r = [];
          t < 9 && ((r = a.attributes.getFloats("scales")), lo(r, e, o));
          let n = a.attributes.getFloat("extrapolation_value", 0),
            s =
              t > 10
                ? a.attributes.getString("coordinate_transformation_mode", "half_pixel")
                : "asymmetric";
          if (
            [
              "asymmetric",
          ...
          let f = a.attributes.getFloat("cubic_coeff_a", -0.75),
            p = a.attributes.getInt("exclude_outside", 0) !== 0;
          if (p && e !== "cubic")
            throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");
          let d = t < 11 ? !0 : e === "nearest" && s === "asymmetric" && l === "floor",
            T = 0,
            v = 0,
            w = 0;
          return (
        ...
        (vb = (a, t, o) => {
          let e = q(a.session.backend.glContext.version),
            ...
            s = t[0].dims.map((w, I) => Math.floor(w * o.scales[I])),
      ...
      `;
          for (let w = l - 1; w >= 0; w--)
            (f[w] = w === l - 1 ? 1 : f[w + 1] * s[w + 1]),
              (p[w] = w === l - 1 ? 1 : p[w + 1] * t[0].dims[w + 1]),
              (d += `
      ...
      return y0 + float(x_offset) * (y1 - y0) / float(scales[1]);
        ...
        (lo = (a, t, o) => {
          ...
          if (
            ...
            throw new Error(
              `'Linear' mode and 'Cubic' mode only support 2-D inputs ('Bilinear', 'Bicubic')         or 4-D inputs with the corresponding outermost 2 scale values being 1         in the ${o ? "Resize" : "Upsample"} opeartor.`
            );
        });
    });
  var Ui,
    ...
    xc = E(() => {
      ...
      Tr();
      Gi();
      (Ui = { name: "Resize", inputNames: ["A"], inputTypes: [2] }),
        (zi = (a, t, o) => (
          Mi(t, o), [a.run({ ...Ui, cacheHint: o.cacheKey, get: () => _b(a, t, o) }, t)]
        )),
        (yc = (a) => mn(a, 10)),
        (Tc = (a) => mn(a, 11)),
        (_b = (a, t, o) => {
          let e = q(a.session.backend.glContext.version),
            [r, n] = Ob(t, o);
          if (r.every((C) => C === 1) && o.coordinateTransformMode !== "tf_crop_and_resize")
            return {
              ...Ui,
          ...
          let u = n[i - 2],
            ...
            f = t[0].dims;
          if (i !== f.length)
            throw new Error(`output dimension should match input ${f.length}, but got ${i}`);
          let p = f[i - 2],
            d = f[i - 1],
            T = r[i - 2],
            v = r[i - 1],
  ...
  var wc,
    ...
    vc = E(() => {
      ...
      yr();
      (wc = (a, t) => (
        Ab(t), [new Ce([t[0].dims.length], "int32", void 0, void 0, new Int32Array(t[0].dims))]
      )),
        (Ab = (a) => {
  ...
  var Vi,
    ...
    Ac = E(() => {
      ...
      fe();
      ae();
      (Vi = { name: "Slice", inputNames: ["A"], inputTypes: [0] }),
        (_c = (a, t, o) => (
          Pb(t), [a.run({ ...Vi, cacheHint: o.cacheKey, get: () => Ic(a, t[0], o) }, t)]
        )),
        (Oc = (a) => {
          let t = a.attributes.getInts("starts"),
            o = a.attributes.getInts("ends"),
            e = a.attributes.getInts("axes", []);
          return ee({ starts: t, ends: o, axes: e });
        }),
        (Ic = (a, t, o) => {
          let e = o.axes.length === 0 ? t.dims.slice(0).map((p, d) => d) : o.axes,
            r = U.normalizeAxes(e, t.dims.length),
            n = o.starts.map((p, d) =>
              p > t.dims[r[d]] - 1 ? t.dims[r[d]] : U.normalizeAxis(p, t.dims[r[d]])
            ),
            s = o.ends.map((p, d) =>
              p > t.dims[r[d]] - 1 ? t.dims[r[d]] : U.normalizeAxis(p, t.dims[r[d]])
            ),
      ...
      `)}
        return _A(outputIdx);
          ...
          return { ...Vi, output: { dims: i, type: t.type, textureType: 0 }, shaderSource: f };
        }),
        (Pb = (a) => {
        ...
        (Sc = (a, t) => {
          Db(t);
          let o = Eb(a, t);
          return [a.run({ ...Vi, cacheHint: o.cacheKey, get: () => Ic(a, t[0], o) }, [t[0]])];
        }),
        (Eb = (a, t) => {
          if (
            !a.session.isInitializer(t[1].dataId) ||
  ...
  var Pc,
    ...
    Nc = E(() => {
      ...
      ae();
      ao();
      (Pc = { name: "SoftmaxComputeMax", inputNames: ["A"], inputTypes: [0] }),
        (Ec = { name: "SoftmaxComputeScale", inputNames: ["A", "Max"], inputTypes: [0, 0] }),
        (Dc = { name: "SoftMax", inputNames: ["A", "Max", "Norm"], inputTypes: [0, 0, 0] }),
        (Lc = (a, t, o) => {
          Bc(t);
          let e = t[0].dims.slice(),
        ...
        (Fc = (a) => ee({ axis: a.attributes.getInt("axis", 1) })),
        (Cc = (a) => ee({ axis: a.attributes.getInt("axis", -1) })),
        ($c = (a, t, o) => {
          Bc(t);
          let e = t[0].dims.slice(),
            r = U.normalizeAxis(o.axis, e.length),
            ...
            f;
          s &&
            ((u = Array.from({ length: n }).map((v, w) => w)),
            (u[r] = n - 1),
            (u[n - 1] = r),
            u.map((v) => i.push(e[v])),
            (f = ee({ perm: u })),
        ...
        (kc = (a, t, o, e, r) => {
          let n = Lb(a, t[0], e, r, [e]),
            s = a.run({ ...Pc, cacheHint: o.cacheKey, get: () => n }, t),
            i = Fb(a, t[0], e, r, n.output.dims, [e]),
            u = a.run({ ...Ec, cacheHint: o.cacheKey, get: () => i }, [t[0], s]),
            l = Cb(a, t[0], e, r, n.output.dims, i.output.dims);
          return [a.run({ ...Dc, cacheHint: o.cacheKey, get: () => l }, [t[0], s, u])];
        }),
        (Lb = (a, t, o, e, r) => {
      ...
      float process(int[${i}] indices) {
        ...
        return max;
          ...
          return { ...Pc, output: { dims: r, type: t.type, textureType: 0 }, shaderSource: l };
        }),
        (Fb = (a, t, o, e, r, n) => {
          ...
          let l = q(a.session.backend.glContext.version),
            f = `
      float process(int[${u}] indices) {
        ...
        return norm_factor;
          ...
          return { ...Ec, output: { dims: n, type: t.type, textureType: 0 }, shaderSource: f };
        }),
        (Cb = (a, t, o, e, r, n) => {
          let [s, i] = a.calculateTextureWidthAndHeight(t.dims, 0),
            u = t.dims.length;
      ...
      return exp(_A(indices) - _Max(logical_row_index)) / norm_factor;
          ...
          return { ...Dc, output: { dims: t.dims, type: t.type, textureType: 0 }, shaderSource: l };
        }),
        (Bc = (a) => {
  ...
  var Rc,
    ...
    Uc = E(() => {
      ...
      fe();
      ae();
      (Rc = { name: "Split", inputNames: ["A"], inputTypes: [0] }),
        (Mc = (a, t, o) => {
          Bb(t);
          ...
          for (let s = 0; s < r; ++s)
            n.push(
              a.run({ ...Rc, cacheHint: `${o.cacheKey};${s}`, get: () => kb(a, t[0], o, e, s) }, t)
            );
          return n;
        }),
        (Gc = (a) => {
          let t = a.attributes.getInt("axis", 0),
            ...
            e = a.outputs.length;
          return ee({ axis: t, split: o, numOutputs: e });
        }),
        ($b = (a, t, o, e) => {
        ...
        (kb = (a, t, o, e, r) => {
          let [n, s] = un.splitShape(t.dims, e, o.split, o.numOutputs),
            i = s[r],
            u = n[r],
            f = `
  ...
  var Wi,
    ...
    Wc = E(() => {
      ...
      (Wi = (a, t, o) => {
        ...
        (zc = (a, t) => (Rb(t), Wi(a, [t[0]], Array.from(t[1].integerData)))),
        (Vc = (a) => a.attributes.getInts("axes")),
        (Nb = (a) => {
    ...
    `;
        ...
        (Gb = (a) => {
          ...
          for (let o = 1; o < a.length; o++) {
            ...
            for (let e = 0; e < t; e++)
              if (a[0].dims[e] !== a[o].dims[e]) throw new Error("Input shapes are not matched.");
          }
          if (a[0].type !== "float32" && a[0].type !== "float64")
            throw new Error("Invalid input type.");
          for (let o = 1; o < a.length; o++)
            if (a[0].type !== a[o].type) throw new Error("Input types are not matched.");
        });
    });
  var jc,
    Ub,
        ...
        (Ub = (a, t, o) => {
          ...
          for (let u = 0; u < e.length; u++)
            (r[u] = e[u] * t[1].numberData[u]),
              n.push(`inputIdx[${u}] = int(mod(float(outputIdx[${u}]), ${e[u]}.));`);
          let s = r.length,
            i = `
  ...
  var Hi,
    ...
    Jc = E(() => {
      ...
      (Hi = (a, t, o) => {
        ...
        (Xc = (a, t) => (Wb(t), Hi(a, [t[0]], Array.from(t[1].integerData)))),
        (Kc = (a) => a.attributes.getInts("axes")),
        (Vb = (a) => {
  ...
  var Zc,
    Qc = E(() => {
      ...
      Zc = [
        ...
        ["Concat", "", "4+", Al, El],
        ["Conv", "", "1+", $i, ki],
        ["ConvTranspose", "", "1+", pf, df],
        ["Cos", "", "7+", Rl],
        ["Div", "", "7+", cl],
        ["Dropout", "", "7+", Ai],
        ["DepthToSpace", "", "1+", yf, Tf],
        ["Equal", "", "7+", pl],
        ["Elu", "", "6+", Ml, Gl],
        ["Exp", "", "6+", Ul],
        ["Flatten", "", "1+", wf, vf],
        ["Floor", "", "6+", zl],
        ["FusedConv", "com.microsoft", "1+", $i, ki],
        ["Gather", "", "1+", Of, If],
        ["Gemm", "", "7-10", Bi, Pf],
        ["Gemm", "", "11+", Bi, Ef],
        ["GlobalAveragePool", "", "1+", Kf, Jf],
        ["GlobalMaxPool", "", "1+", rc],
        ["Greater", "", "7+", dl],
        ["Identity", "", "1+", Ai],
        ["ImageScaler", "", "1+", Lf, Ff],
        ["InstanceNormalization", "", "6+", kf, Bf],
        ["LeakyRelu", "", "6+", Vl, Wl],
        ["Less", "", "7+", hl],
        ["LRN", "", "1+", Rf, Mf],
        ["Log", "", "6+", Hl],
        ...
        ["Pow", "", "7+", gl],
        ["PRelu", "", "7+", yl],
        ["ReduceLogSum", "", "1+", fc, tr],
        ["ReduceMax", "", "1+", sc, tr],
        ["ReduceMean", "", "1+", ac, tr],
        ["ReduceMin", "", "1+", uc, tr],
        ["ReduceProd", "", "1+", lc, tr],
        ["ReduceSum", "", "1-12", ic, tr],
        ["ReduceSumSquare", "", "1+", cc, tr],
        ["Relu", "", "6+", Yl],
        ["Reshape", "", "5+", dc],
        ["Resize", "", "10", zi, yc],
        ["Resize", "", "11+", zi, Tc],
 ...
 ${f}`),
  ...
  var ep,
    ...
    rp = E(() => {
      "use strict";
      (ep = /@inline[\s\n\r]+(\w+)[\s\n\r]+([0-9a-zA-Z_]+)\s*\(([^)]*)\)\s*{(([^}]|[\n\r])*)}/gm),
        (Hb = "(\\w+)?\\s+([_0-9a-zA-Z]+)\\s+=\\s+__FUNC__\\((.*)\\)\\s*;");
    });
  function Ur(a, t) {
    let o = [],
      e = [],
      r = t != null && Array.isArray(t) && t.length === 0,
      n = t == null || r ? null : qb(t, a).sort(),
      s = 0;
  ...
  function qb(a, t) {
    ...
    return (
      ...
      kr(a.every(jb), () => `All values in axis param must be integers but got axis ${a}`),
      a.map((e) => (e < 0 ? o + e : e))
    );
  }
  function jb(a) {
      ...
      fo = class {
        ...
        computeTexture(t, o) {
          ...
          if (o && o.breakAxis !== void 0) {
            let i = o.breakAxis >= t.length ? 1 : t.slice(o.breakAxis).reduce((l, f) => l * f),
              u = o.breakAxis <= 0 ? 1 : t.slice(0, o.breakAxis).reduce((l, f) => l * f);
            if (i > r || u > r)
              ce.verbose(
                "TextureLayout",
          ...
          e &&
            ((r = r * 2),
            (n = n.map((i, u) => (u >= n.length - 2 ? (n[u] % 2 === 0 ? n[u] : n[u] + 1) : n[u]))),
            n.length === 1 && (n = [2, n[0]])),
      ...
      `;
        ...
        getOutputUnpacked3DCoords(o, e) {
          ...
          let i = ["r", "c", "d"],
            u = s
              .map((l, f) => {
                let p = `int ${i[f]} = index / ${l}`,
                  d =
                    f === s.length - 1
                      ? `int ${i[f + 1]} = index - ${i[f]} * ${l}`
                      : `index -= ${i[f]} * ${l}`;
                return `${p}; ${d};`;
              })
              .join("");
      ...
      `)),
        ...
        getPackedSamplerAtOutputCoords(o, e, r, n) {
          ...
          f === 0
            ...
            : p < 2 && d.length >= 1
              ? (w = "coords = 0;")
              : (w = d.map((We) => `coords.${I[We + v]} = 0;`).join(`
`));
          let L = "";
          p < 2 && f > 0
            ? (L = "coords")
            : (L = s.map((We, Fe) => `coords.${I[Fe + v]}`).join(", "));
    ...
    `;
          return new R(ot, ["coordinates.getOutputCoords"]);
        }
        ...
        `;
            return new R(Y, ["coordinates.sampleTexture"]);
          }
          let T = Je(l),
            v = Ke.getBroadcastDims(f, p),
            w = l - u,
            I,
            L = Ot();
          u === 0
            ...
            : l < 2 && v.length >= 1
              ? (I = "coords = 0;")
              : (I = v.map((Y) => `coords.${L[Y + w]} = 0;`).join(`
`));
          let F = "";
          l < 2 && u > 0
            ? (F = "coords")
            : (F = e.unpackedShape.map((Y, j) => `coords.${L[j + w]}`).join(", "));
          let C = `
        float ${o}() {
          ${T} coords = getOutputCoords();
          ${I}
      ...
      `;
          return new R(C, ["coordinates.getOutputCoords"]);
        }
        ...
        getPackedSampler1D(o, e, r) {
          let n = [r.width, r.height],
            s = [n[1], n[0]],
            i = q(this.context.glContext.version),
            l = `vec4 ${o}(int index) {
      ...
      return ${i.texture2D}(${e}, uv);
        ...
        getPackedSampler3D(o, e, r) {
          ...
          if (n[0] === 1) {
            ...
            C.unpackedShape = L;
            let Y = this.getPackedSamplerFromInput(o, e, C),
              M = `${Y.routineBody}
      vec4 ${o}(int b, int row, int col) {
        return ${o}(${Nr(F, I)});
          ...
          let l = i[0],
            ...
            p = Math.ceil(n[2] / 2),
            d = p * Math.ceil(n[1] / 2),
            v = `vec4 ${o}(int b, int row, int col) {
      vec2 uv = packedUVfrom3D(
        ${f}, ${l}, ${d}, ${p}, b, row, col);
      return ${u.texture2D}(${e}, uv);}`;
          return new R(v, ["coordinates.packedUVfrom3D"]);
        }
        getPackedSamplerND(o, e, r) {
          let n = r.unpackedShape,
            ...
            v = "int b, int row, int col",
            w = `b * ${T} + (row / 2) * ${d} + (col / 2)`;
          for (let F = 2; F < s - 1; F++)
            (v = `int b${F}, ` + v), (T *= n[s - F - 1]), (w = `b${F} * ${T} + ` + w);
          let L = `vec4 ${o}(${v}) {
      int index = ${w};
      int texR = index / ${p};
      ...
      `;
        ...
        `;
            return new R(w, ["coordinates.sampleTexture"]);
          }
          let { newShape: i, keptDims: u } = Ur(n),
            l = i;
        ...
        `;
            return new R(I, ["coordinates.sampleTexture"]);
          }
          let f = s[1],
            p = s[0];
          if (p === 1) {
      ...
      `;
        ...
        getUnpackedSampler3D(o, e, r) {
          ...
          if (f.length < n.length) {
            ...
            I.unpackedShape = v;
            let L = this.getUnpackedSamplerFromInput(o, e, I),
              F = l.reverse(),
              C = `
          ${L.routineBody}
      ...
      `;
        ...
        getUnpackedSampler5D(o, e, r) {
          let n = r.unpackedShape,
            ...
            u = n[2] * i,
            l = n[1] * u,
            { newShape: f, keptDims: p } = Ur(n);
          if (f.length < n.length) {
            let w = Br(n, f),
              I = ["row", "col", "depth", "depth2", "depth3"],
      ...
      `;
          return new R(v, ["coordinates.sampleTexture", "coordinates.uvFromFlat"]);
        }
          ...
          return (
            this.context.programInfo.inputNames.forEach((e, r) => {
              let n = this.context.inputTextureLayouts[r],
                i = (n.unpackedShape.length > 0 ? n.unpackedShape : n.shape).length,
                u = `_${e}`;
              (o[u] = new R(this.getValueFromSingle(e, i, n.width, n.height, !1), [
                ...
                (u = u + "_T"),
                (o[u] = new R(this.getValueFromSingle(e, i, n.width, n.height, !0), [
                  `shapeUtils.indicesToOffset${u}`,
                  "coordinates.offsetToCoords",
                  "fragcolor.getColorAsFloat",
                ]));
          ...
          return (
            this.context.programInfo.inputNames.forEach((o, e) => {
              ...
              (t[i] = new R(a.offsetToIndicesSingle(i, s, n))),
                ...
                (t[i] = new R(a.offsetToIndicesSingle(i, s, n.slice().reverse())));
            }),
            t
          );
        }
    ...
    fp = E(() => {
      ...
      go = class {
        constructor(t, o, e, r) {
          ...
          (this.context = new eo(t, o, e, r)),
            Object.keys(ji).forEach((s) => {
              let i = new ji[s](this.context);
              this.libs[s] = i;
            });
          ...
          for (let s in this.libs) {
            ...
            for (let l in u) {
              ...
              n[f]
                ...
                : ((p = new dn(f, u[l].routineBody)), (n[f] = p));
        ...
        preprocess() {
          ...
          return (
            this.context.programInfo.hasMain ||
              (o = `${o}
      ${Vu(this.context.glContext.version, this.context.outputTextureLayout.shape.length)}`),
            (o = tp(o)),
            `${zu(this.context.glContext.version)}
      ...
      yo = class {
            ...
            () => {
              ...
              try {
                this.bindOutput(e),
                  ...
                  this.bindUniforms(t.uniformLocations, t.programInfo.variables ?? [], o);
              } catch (s) {
        ...
        build(t, o, e) {
          return this.profiler.event("backend", "ProgramManager.build", () => {
            let r = new go(this.glContext, t, o, e),
              n = r.preprocess(),
              s = this.compile(n);
            return {
              programInfo: t,
        ...
        compile(t) {
          if (!this.vertexShader) {
            ...
            let r = Uu(this.glContext.version);
...
`
          ...
          let o = this.glContext.compileShader(t, this.glContext.gl.FRAGMENT_SHADER),
    ...
    pp = E(() => {
      ...
      To = class {
        ...
        createTextureFromLayout(t, o, e, r) {
          ...
          if (this.config.reuseTextures) {
            ...
            if (d && d.length > 0) {
              ...
              return (
                f.push(T),
                r === 1 && this.glContext.updateTexture(T, i, u, s, this.toTextureData(t, e)),
                T
              );
            }
          }
        ...
        readUint8TextureAsFloat(t) {
          return this.profiler.event("backend", "TextureManager.readUint8TextureAsFloat", () => {
            let o = t.shape.reduce((r, n) => r * n),
              e = this.glContext.readTexture(t.texture, t.width, t.height, o * 4, "byte", 4);
        ...
        releaseTexture(t, o) {
          ...
          (!e || o) &&
            (ce.verbose("TextureManager", `Deleting texture of size ${t.width}x${t.height}`),
    ...
    dp = E(() => {
      ...
      xo = class {
        constructor(t, o) {
          this.backend = t;
          this.context = o;
          (this.layoutStrategy = new fo(t.glContext.maxTextureSize)),
            (this.programManager = new yo(this.context.profiler, t.glContext, this.layoutStrategy)),
            (this.textureManager = new To(t.glContext, this.layoutStrategy, this.context.profiler, {
        ...
        setTextureData(t, o, e = !1) {
          ce.verbose("WebGLSessionHandler", "Storing Texture data in cache"),
            e ? this.packedTextureDataCache.set(t, o) : this.unpackedTextureDataCache.set(t, o);
        }
        dispose() {
    ...
    hp = E(() => {
      ...
      bn = class {
        ...
        allocateTexture(t, o, e, r) {
          ...
          return (
            n.texImage2D(n.TEXTURE_2D, 0, e.internalFormat, t, o, 0, e.format, e.textureType, i),
            this.checkError(),
            s
          );
        }
        updateTexture(t, o, e, r, n) {
          ...
          s.texSubImage2D(s.TEXTURE_2D, 0, 0, 0, o, e, r.format, r.textureType, i),
            this.checkError();
        }
        ...
        setVertexAttributes(t, o) {
          ...
          e.vertexAttribPointer(t, 3, e.FLOAT, !1, 20, 0),
            ...
            o !== -1 &&
              (e.vertexAttribPointer(o, 2, e.FLOAT, !1, 20, 12), e.enableVertexAttribArray(o)),
            this.checkError();
        }
        createProgram(t, o) {
          let e = this.gl,
...
${t}`);
          ...
          switch (t) {
            case "float":
              return e === 1 || this.isRenderFloat32Supported
                ? new fn(this.gl, o)
                : new fn(this.gl, o, this.textureHalfFloatExtension.HALF_FLOAT_OES);
            case "int":
        ...
        checkFloat32Blend() {
          ...
          try {
            ...
            return (
              ...
              !n) ||
              (t.shaderSource(n, "precision highp float;void main(){gl_FragColor=vec4(0.5);}"),
              t.compileShader(n),
              (s = t.createProgram()),
              !s)
                ? !1
        ...
        async waitForQueryAndGetTime(t) {
          return await yi(() => this.isTimerResultAvailable(t)), this.getTimerResult(t);
        }
        ...
        async addItemToPoll(t, o) {
          this.itemsToPoll.push({ isDoneFn: t, resolveFn: o }),
            !(this.itemsToPoll.length > 1) &&
              (await yi(() => (this.pollItems(), this.itemsToPoll.length === 0)));
        }
      };
    });
  function Yi(a) {
    let t;
    if (
      ((!a || a === "webgl2") && "webgl2" in zr
        ? (t = zr.webgl2)
        : (!a || a === "webgl") && "webgl" in zr && (t = zr.webgl),
      !t)
    )
      try {
        let e = Jb();
        ...
        initialize() {
          try {
            return (
              ...
              ce.setWithEnv(Z),
              Z.webgl.context ||
                Object.defineProperty(Z.webgl, "context", { value: this.glContext.gl }),
              ce.verbose(
                "WebGLBackend",
  ...
  async function Xi(a) {
    ...
    } else return Xi(["webgl"]);
    throw new Error("no available backend to use");
  }
  async function Qb(a) {
    let t = Zb;
    if (typeof t[a] < "u" && eg(t[a])) {
      let o = t[a],
        e = o.initialize();
      if ((typeof e == "object" && "then" in e && (e = await e), e)) return yp.set(a, o), o;
    }
  }
  function eg(a) {
    let t = a;
        ...
        (vo = class {
          ...
          initialize(t) {
            this.profiler.event("session", "ExecutionPlan.initialize", () => {
              ...
              (this._ops = t.map((e, r) => new Ki(e, o[r]))),
                this.reset(),
                (this._starter = []),
          ...
          async execute(t, o) {
            return this.profiler.event("session", "ExecutionPlan.execute", async () => {
              ...
              for (; u < n.length; ) {
                let f = n[u++],
                  p = this._ops[f],
                  d = p.node.inputs.map((I) => this._values[I]);
                if (d.indexOf(void 0) !== -1)
                  throw new Error(`unresolved input detected: op: ${p.node}`);
                let T = d;
                ce.verbose(
                  "ExecPlan",
                  `Runing op:${p.node.name} (${T.map((I, L) => `'${p.node.inputs[L]}': ${I.type}[${I.dims.join(",")}]`).join(", ")})`
                );
                let v = await this.profiler.event("node", p.node.name, async () =>
                  p.op.impl(e, T, p.op.context)
                );
                if (v.length !== p.node.outputs.length)
                  throw new Error("the size of output does not match model definition.");
                v.forEach((I, L) => {
                  let F = p.node.outputs[L];
                  if (this._values[F])
                    throw new Error(`output [${F}] already has value: op:${p.node.name}`);
                  this._values[F] = I;
                });
                let w = new Set();
                v.forEach((I, L) => {
      ...
      (dt = W.experimental.fbs),
        (gn = class a {
          ...
          static getValue(t) {
            ...
            if (o === oe.onnx.AttributeProto.AttributeType.INT && nt.isLong(e))
              return nt.longToNumber(e);
            ...
            if (o === oe.onnx.AttributeProto.AttributeType.TENSOR)
              return t instanceof oe.onnx.AttributeProto ? Ce.fromProto(e) : Ce.fromOrtTensor(e);
          ...
          static getValueNoCheckFromOnnxFormat(t) {
            switch (t.type) {
              ...
              default:
                throw new Error(
                  `unsupported attribute type: ${oe.onnx.AttributeProto.AttributeType[t.type]}`
                );
            }
          }
  ...
  var Zi,
    ...
    vp = E(() => {
      ...
      yr();
      fe();
      (_o = W.experimental.fbs),
        (Qi = { from: (a, t) => new Ji(a, t) }),
        (Rt = class {
          constructor(t) {
            (this._from = void 0),
              (this._to = []),
              (this.tensor = void 0),
              (this.type = void 0),
              t && (this.type = Ve.tensorValueTypeFromProto(t.type.tensorType));
          }
          get from() {
            return this._from;
          }
        ...
        (Oo = class {
          constructor(t, o) {
            t instanceof Zi.onnx.NodeProto
              ? ((this.name = t.name),
                (this.opType = t.opType),
                (this.attributes = new gn(t.attribute)))
              : t instanceof _o.Node &&
                ((this.name = o ?? t.name()),
                (this.opType = t.opType()),
                (this.attributes = new gn(Ve.tensorAttributesFromORTFormat(t)))),
              (this.inputs = []),
              (this.outputs = []),
              (this.executeNode = !0);
          }
        ...
        (Ji = class {
          ...
          buildGraph(t) {
            if (t instanceof Zi.onnx.GraphProto) this.buildGraphFromOnnxFormat(t);
          ...
          buildGraphFromOnnxFormat(t) {
            ...
            for (let n of t.initializer) {
              ...
              if (s === void 0) {
                let i = new Rt();
                (i.type = {
                  shape: { dims: Ve.tensorDimsFromProto(n.dims) },
            ...
            for (let n = 0; n < this._nodes.length; n++) {
              ...
              for (let u of i.output) {
                let l = o.get(u);
                if (
                  (typeof l > "u" && ((l = this._allData.push(new Rt()) - 1), o.set(u, l)),
                  s.outputs.push(l),
                ...
                if (((this._allData[l]._from = n), i.opType === "Constant")) {
                  ...
                  s.outputs.pop(),
                    ...
                    (this._allData[l].tensor = Ce.fromProto(i.attribute[0].t));
                }
              }
            }
            for (let n = 0; n < this._nodes.length; n++) {
          ...
          buildGraphFromOrtFormat(t) {
            ...
            for (let n = 0; n < t.inputsLength(); n++) {
              ...
              for (let i = 0; i < t.nodeArgsLength(); i++)
                if (t.nodeArgs(i)?.name() === s) {
                  let u = new Rt();
                  if (t.nodeArgs(i)?.type()?.valueType() !== _o.TypeInfoValue.tensor_type)
                    throw new Error("Unexpected value type for the nodeArg.");
                  let f = t.nodeArgs(i).type().value(new _o.TensorTypeAndShape()),
                    p = Ve.tensorDataTypeFromProto(f.elemType()),
                    d = f.shape(),
                    T = [];
                  for (let w = 0; w < d.dimLength(); w++)
                    T.push(nt.longToNumber(d.dim(w).value().dimValue()));
            ...
            for (let n = 0; n < t.initializersLength(); n++) {
              ...
              if (i === void 0) {
                let u = new Rt(),
                  l = Ve.tensorDimsFromORTFormat(s),
                  f = Ve.tensorDataTypeFromProto(s.dataType());
            ...
            for (let n = 0; n < this._nodes.length; n++) {
              ...
              for (let u = 0; u < i?.outputsLength(); u++) {
                let l = i?.outputs(u),
                  f = o.get(l);
                if (
                  (typeof f > "u" && ((f = this._allData.push(new Rt()) - 1), o.set(l, f)),
                  s.outputs.push(f),
                  this._allData[f]._from !== void 0)
                )
                  throw new Error(`multiple nodes output to one data value: ${f}`);
                if (((this._allData[f]._from = n), i.opType() === "Constant")) {
                  ...
                  s.outputs.pop(),
                    ...
                    (this._allData[f].tensor = Ce.fromOrtTensor(i.attributes(0).t()));
                }
              }
            }
            for (let n = 0; n < this._nodes.length; n++) {
            ...
            for (let r = 0; r < this._allData.length; r++) {
              ...
              if (t > 0) {
                ...
                this._allData[r].from !== void 0 && this._allData[r].from !== -1
                  ? ((n = this._nodes[this._allData[r].from].outputs.indexOf(r + t)),
                    n !== -1 && (this._nodes[this._allData[r].from].outputs[n] = r))
      ...
      (tg = W.experimental.fbs),
        (Io = class {
          ...
          loadFromOnnxFormat(t, o) {
            let e = _p.onnx.ModelProto.decode(t);
            if (nt.longToNumber(e.irVersion) < 3)
              throw new Error("only support ONNX model with IR_VERSION>=3");
            (this._opsets = e.opsetImport.map((n) => ({
              domain: n.domain,
              version: nt.longToNumber(n.version),
            }))),
              (this._graph = Qi.from(e.graph, o));
          }
          loadFromOrtFormat(t, o) {
            let e = new O.ByteBuffer(t),
              r = tg.InferenceSession.getRootAsInferenceSession(e).model();
            if (nt.longToNumber(r.irVersion()) < 3)
              throw new Error("only support ONNX model with IR_VERSION>=3");
            this._opsets = [];
            for (let s = 0; s < r.opsetImportLength(); s++) {
              let i = r.opsetImport(s);
              this._opsets.push({ domain: i?.domain(), version: nt.longToNumber(i.version()) });
            }
            this._graph = Qi.from(r.graph(), o);
          }
          get graph() {
            return this._graph;
          }
      ...
      So = class {
        ...
        async loadModel(t, o, e) {
          await this.profiler.event("session", "Session.loadModel", async () => {
            let r = await Xi(this.backendHint);
            if (
        ...
        initialize(t, o) {
          ...
          this.profiler.event("session", "Session.initialize", () => {
            ...
            this._model.load(t, e, o),
              ...
              (this._executionPlan = new vo(this._model.graph, this._ops, this.profiler));
          }),
            (this._initialized = !0);
        }
        async run(t) {
        ...
        validateInputTensorDims(t, o, e) {
          for (let r = 0; r < o.length; r++) {
            ...
            if (!this.compareTensorDims(n, s, e))
              throw new Error(
                `input tensor[${r}] check failed: expected shape '[${n.join(",")}]' but got [${s.join(",")}]`
              );
          }
        }
    ...
    Sp = E(() => {
      ...
      Ao = class {
        ...
        async run(t, o, e) {
          ...
          return (
            n.forEach((i, u) => {
              s[u] = new Be(i.type, i.data, i.dims);
            }),
            s
          );
        }
      ...
      return (
        ...
        function (t = {}) {
          ...
          if (l) {
            var v = (ra(), jt(ta)),
              w = (oa(), jt(na));
            (f = u ? w.dirname(f) + "/" : __dirname + "/"),
              (p = (b, x) => (
                (b = St(b) ? new URL(b) : w.normalize(b)), v.readFileSync(b, x ? void 0 : "utf8")
              )),
              (T = (b) => ((b = p(b, !0)), b.buffer || (b = new Uint8Array(b)), b)),
              (d = (b, x, _, D = !0) => {
                (b = St(b) ? new URL(b) : w.normalize(b)),
                  v.readFile(b, D ? void 0 : "utf8", (G, X) => {
          ...
          function We() {
            var b = F.buffer;
            (o.HEAP8 = Y = new Int8Array(b)),
              (o.HEAP16 = new Int16Array(b)),
              (o.HEAPU8 = j = new Uint8Array(b)),
              (o.HEAPU16 = new Uint16Array(b)),
              (o.HEAP32 = M = new Int32Array(b)),
              (o.HEAPU32 = ie = new Uint32Array(b)),
              (o.HEAPF32 = new Float32Array(b)),
              (o.HEAPF64 = ot = new Float64Array(b));
          }
          var Fe = [],
            V = [],
            Ae = [],
          ...
          var bt = (b) => b.startsWith("data:application/octet-stream;base64,"),
            St = (b) => b.startsWith("file://"),
            He;
          ...
          function Pt(b, x) {
            ...
            return typeof WebAssembly.instantiateStreaming != "function" ||
              ...
              ? rr(_, b, x)
              : fetch(_, { credentials: "same-origin" }).then((D) =>
                  WebAssembly.instantiateStreaming(D, b).then(x, function (G) {
                    return (
          ...
          var Qe = 0,
            ...
            Xr = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
          function Ar(b) {
            var x = Array(qe(b) + 1);
          ...
          function vn(b, x, _, D) {
            function G(A, pe, Te) {
              for (A = typeof A == "number" ? A.toString() : A || ""; A.length < pe; )
                A = Te[0] + A;
              return A;
            }
            function X(A, pe) {
            ...
            function ne(A, pe) {
              ...
              var Lt;
              return (
                (Lt = Te(A.getFullYear() - pe.getFullYear())) === 0 &&
                  (Lt = Te(A.getMonth() - pe.getMonth())) === 0 &&
                  (Lt = Te(A.getDate() - pe.getDate())),
                Lt
              );
            }
            function ke(A) {
            ...
            function Ye(A) {
              ...
              return (
                (Te = new Date(A.getFullYear() + 1, 0, 4)),
                (pe = ke(new Date(A.getFullYear(), 0, 4))),
                (Te = ke(Te)),
                0 >= ne(pe, A)
                  ? 0 >= ne(Te, A)
                    ? A.getFullYear() + 1
            ...
            var Zr = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
              Qr =
...
`,
              ...
              "%V": (A) => {
                ...
                if ((2 >= (A.oa + 371 - A.ta - 2) % 7 && pe++, pe))
                  pe == 53 &&
                    ((Te = (A.oa + 371 - A.ta) % 7), Te == 4 || (Te == 3 && Dt(A.ua)) || (pe = 1));
                else {
                  pe = 52;
            ...
            return (
              (_ = _.replace(/\0\0/g, "%")),
              (ze = Ar(_)),
              ze.length > x ? 0 : (Y.set(ze, b >>> 0), ze.length - 1)
            );
          }
          var he = {
              a: function (b, x, _) {
                throw ((b >>>= 0), new nr(b).Aa(x >>> 0, _ >>> 0), (Qe = b), Et++, Qe);
              },
              e: function () {
                return 0;
              },
              ...
              n: function (b, x, _) {
                (b = (x + 2097152) >>> 0 < 4194305 - !!b ? (b >>> 0) + 4294967296 * x : NaN),
                  (_ >>>= 0),
                  (b = new Date(1e3 * b)),
                  (M[(_ >>> 2) >>> 0] = b.getUTCSeconds()),
                  (M[((_ + 4) >>> 2) >>> 0] = b.getUTCMinutes()),
                  (M[((_ + 8) >>> 2) >>> 0] = b.getUTCHours()),
                  (M[((_ + 12) >>> 2) >>> 0] = b.getUTCDate()),
                  (M[((_ + 16) >>> 2) >>> 0] = b.getUTCMonth()),
                  (M[((_ + 20) >>> 2) >>> 0] = b.getUTCFullYear() - 1900),
                  (M[((_ + 24) >>> 2) >>> 0] = b.getUTCDay()),
                  (M[((_ + 28) >>> 2) >>> 0] =
                    ((b.getTime() - Date.UTC(b.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5) | 0);
              },
              o: function (b, x, _) {
                (b = (x + 2097152) >>> 0 < 4194305 - !!b ? (b >>> 0) + 4294967296 * x : NaN),
                  (_ >>>= 0),
                  (b = new Date(1e3 * b)),
                  (M[(_ >>> 2) >>> 0] = b.getSeconds()),
                  (M[((_ + 4) >>> 2) >>> 0] = b.getMinutes()),
                  (M[((_ + 8) >>> 2) >>> 0] = b.getHours()),
                  (M[((_ + 12) >>> 2) >>> 0] = b.getDate()),
                  (M[((_ + 16) >>> 2) >>> 0] = b.getMonth()),
                  (M[((_ + 20) >>> 2) >>> 0] = b.getFullYear() - 1900),
                  (M[((_ + 24) >>> 2) >>> 0] = b.getDay()),
                  (M[((_ + 28) >>> 2) >>> 0] =
                    ((Dt(b.getFullYear()) ? jr : wn)[b.getMonth()] + b.getDate() - 1) | 0),
                  (M[((_ + 36) >>> 2) >>> 0] = -(60 * b.getTimezoneOffset())),
                  (x = new Date(b.getFullYear(), 6, 1).getTimezoneOffset());
              ...
              p: function (b) {
                ...
                var x = new Date(
                  ...
                  G = new Date(x.getFullYear(), 6, 1).getTimezoneOffset(),
                  X = new Date(x.getFullYear(), 0, 1).getTimezoneOffset(),
                  ne = Math.min(X, G);
                return (
                  0 > _
                    ? (M[((b + 32) >>> 2) >>> 0] = +(G != X && ne == D))
                    : 0 < _ != (ne == D) &&
                      ((G = Math.max(X, G)), x.setTime(x.getTime() + 6e4 * ((0 < _ ? ne : G) - D))),
                  (M[((b + 24) >>> 2) >>> 0] = x.getDay()),
                  (M[((b + 28) >>> 2) >>> 0] =
                    ((Dt(x.getFullYear()) ? jr : wn)[x.getMonth()] + x.getDate() - 1) | 0),
                  (M[(b >>> 2) >>> 0] = x.getSeconds()),
                  (M[((b + 4) >>> 2) >>> 0] = x.getMinutes()),
                  (M[((b + 8) >>> 2) >>> 0] = x.getHours()),
                  (M[((b + 12) >>> 2) >>> 0] = x.getDate()),
                  (M[((b + 16) >>> 2) >>> 0] = x.getMonth()),
                  (M[((b + 20) >>> 2) >>> 0] = x.getYear()),
                  (b = x.getTime()),
                  isNaN(b) ? ((M[(Pr() >>> 2) >>> 0] = 61), (b = -1)) : (b /= 1e3),
                  Kr(
                    ((gt = b),
                    1 <= +Math.abs(gt)
                      ? 0 < gt
                        ? +Math.floor(gt / 4294967296) >>> 0
                        : ~~+Math.ceil((gt - +(~~gt >>> 0)) / 4294967296) >>> 0
                      : 0)
                  ),
                  b >>> 0
                );
              ...
              t: function (b, x, _) {
                ...
                (ie[((b >>> 0) >>> 2) >>> 0] = 60 * Math.max(G, ke)),
                  ...
                  (x = Ut(x)),
                  ke < G
                    ? ((ie[(_ >>> 2) >>> 0] = b), (ie[((_ + 4) >>> 2) >>> 0] = x))
                    : ((ie[(_ >>> 2) >>> 0] = x), (ie[((_ + 4) >>> 2) >>> 0] = b));
              },
              d: () => {
                te("");
              },
              B: function (b, x, _) {
                (b >>>= 0), (x >>>= 0), (_ >>>= 0), (Or.length = 0);
                for (var D; (D = j[x++ >>> 0]); ) {
                  var G = D != 105;
                  (G &= D != 112),
                    (_ += G && _ % 8 ? 4 : 0),
              ...
              s: function (b) {
                ...
                for (var _ = 1; 4 >= _; _ *= 2) {
                  ...
                  e: {
                    G =
                      (G.min.call(G, 4294901760, D + ((65536 - (D % 65536)) % 65536)) -
                        F.buffer.byteLength +
                        65535) /
                      65536;
                    try {
              ...
              C: function (b, x) {
                ...
                return (
                  Ir().forEach((D, G) => {
                    var X = x + _;
                    for (G = ie[((b + 4 * G) >>> 2) >>> 0] = X, X = 0; X < D.length; ++X)
                      Y[(G++ >>> 0) >>> 0] = D.charCodeAt(X);
            ...
            Q = (function () {
              function b(_) {
                return (
                  ...
                  It--,
                  It == 0 &&
                    (mt !== null && (clearInterval(mt), (mt = null)),
                    Ne && ((_ = Ne), (Ne = null), _())),
                  Q
                );
              }
              var x = { a: he };
              if ((It++, o.instantiateWasm))
                try {
          ...
          (o._OrtInit = (b, x) => (o._OrtInit = Q.M)(b, x)),
            (o._OrtGetLastError = (b, x) => (o._OrtGetLastError = Q.N)(b, x)),
            (o._OrtCreateSessionOptions = (b, x, _, D, G, X, ne, ke, Ye, Ue) =>
              (o._OrtCreateSessionOptions = Q.O)(b, x, _, D, G, X, ne, ke, Ye, Ue)),
            (o._OrtAppendExecutionProvider = (b, x) => (o._OrtAppendExecutionProvider = Q.P)(b, x)),
            (o._OrtAddFreeDimensionOverride = (b, x, _) =>
              (o._OrtAddFreeDimensionOverride = Q.Q)(b, x, _)),
            (o._OrtAddSessionConfigEntry = (b, x, _) =>
              (o._OrtAddSessionConfigEntry = Q.R)(b, x, _)),
            (o._OrtReleaseSessionOptions = (b) => (o._OrtReleaseSessionOptions = Q.S)(b)),
            (o._OrtCreateSession = (b, x, _) => (o._OrtCreateSession = Q.T)(b, x, _)),
            (o._OrtReleaseSession = (b) => (o._OrtReleaseSession = Q.U)(b)),
            (o._OrtGetInputOutputCount = (b, x, _) => (o._OrtGetInputOutputCount = Q.V)(b, x, _)),
            (o._OrtGetInputName = (b, x) => (o._OrtGetInputName = Q.W)(b, x)),
            (o._OrtGetOutputName = (b, x) => (o._OrtGetOutputName = Q.X)(b, x)),
            (o._OrtFree = (b) => (o._OrtFree = Q.Y)(b)),
            (o._OrtCreateTensor = (b, x, _, D, G, X) =>
              (o._OrtCreateTensor = Q.Z)(b, x, _, D, G, X)),
            (o._OrtGetTensorData = (b, x, _, D, G) => (o._OrtGetTensorData = Q._)(b, x, _, D, G)),
            (o._OrtReleaseTensor = (b) => (o._OrtReleaseTensor = Q.$)(b)),
            (o._OrtCreateRunOptions = (b, x, _, D) => (o._OrtCreateRunOptions = Q.aa)(b, x, _, D)),
            (o._OrtAddRunConfigEntry = (b, x, _) => (o._OrtAddRunConfigEntry = Q.ba)(b, x, _)),
            (o._OrtReleaseRunOptions = (b) => (o._OrtReleaseRunOptions = Q.ca)(b)),
            (o._OrtCreateBinding = (b) => (o._OrtCreateBinding = Q.da)(b)),
            (o._OrtBindInput = (b, x, _) => (o._OrtBindInput = Q.ea)(b, x, _)),
            (o._OrtBindOutput = (b, x, _, D) => (o._OrtBindOutput = Q.fa)(b, x, _, D)),
            (o._OrtClearBoundOutputs = (b) => (o._OrtClearBoundOutputs = Q.ga)(b)),
            (o._OrtReleaseBinding = (b) => (o._OrtReleaseBinding = Q.ha)(b)),
            (o._OrtRunWithBinding = (b, x, _, D, G) =>
              (o._OrtRunWithBinding = Q.ia)(b, x, _, D, G)),
            (o._OrtRun = (b, x, _, D, G, X, ne, ke) =>
              (o._OrtRun = Q.ja)(b, x, _, D, G, X, ne, ke)),
            (o._OrtEndProfiling = (b) => (o._OrtEndProfiling = Q.ka)(b));
          var Pr = () => (Pr = Q.la)(),
            _n = (o._malloc = (b) => (_n = o._malloc = Q.ma)(b));
          ...
          (o.stackAlloc = ir),
            ...
            (o.stackRestore = J),
            (o.UTF8ToString = ve),
            (o.stringToUTF8 = (b, x, _) => Gt(b, j, x, _)),
            (o.lengthBytesUTF8 = qe);
          var zt;
          Ne = function b() {
            zt || Jr(), zt || (Ne = b);
          };
    ...
    typeof Lp == "object" && typeof ia == "object"
      ? (ia.exports = Dp)
      : typeof define == "function" && define.amd && define([], () => Dp);
  });
  var Cp = me(() => {});
  var $p = me(() => {});
  var kp = {};
      ...
      return (
        ...
        function (t = {}) {
          ...
          if (w) {
            var M = (ra(), jt(ta)),
              ie = (oa(), jt(na));
            (L = v ? ie.dirname(L) + "/" : __dirname + "/"),
              (C = (h, g) => (
                (h = ve(h) ? new URL(h) : ie.normalize(h)), M.readFileSync(h, g ? void 0 : "utf8")
              )),
              (j = (h) => ((h = C(h, !0)), h.buffer || (h = new Uint8Array(h)), h)),
              (Y = (h, g, S, k = !0) => {
                (h = ve(h) ? new URL(h) : ie.normalize(h)),
                  M.readFile(h, k ? void 0 : "utf8", (B, z) => {
          ...
          w && typeof performance > "u" && (global.performance = $p().performance);
          var ot = console.log.bind(console),
...
`
          ...
          function we() {
            var c = Ae.buffer;
            (i.HEAP8 = te = new Int8Array(c)),
              (i.HEAP16 = new Int16Array(c)),
              (i.HEAPU8 = bt = new Uint8Array(c)),
              (i.HEAPU16 = new Uint16Array(c)),
              (i.HEAP32 = St = new Int32Array(c)),
              (i.HEAPU32 = He = new Uint32Array(c)),
              (i.HEAPF32 = new Float32Array(c)),
              (i.HEAPF64 = At = new Float64Array(c));
          }
          var Ze = 16777216;
          if (I) Ae = i.wasmMemory;
          else if (i.wasmMemory) Ae = i.wasmMemory;
          else if (
            ((Ae = new WebAssembly.Memory({ initial: Ze / 65536, maximum: 65536, shared: !0 })),
          ...
          var rr = [],
            ...
            Qe = null;
          function Et() {
            if ((yt--, yt == 0 && (nr !== null && (clearInterval(nr), (nr = null)), Qe))) {
              var c = Qe;
              (Qe = null), c();
            }
          }
          ...
          var $e = (c) => c.startsWith("data:application/octet-stream;base64,"),
            ve = (c) => c.startsWith("file://"),
            qe;
          ...
          function jr(c, h, g) {
            return Dt(c)
              .then((S) => WebAssembly.instantiate(S, h))
              .then((S) => S)
              .then(g, (S) => {
          ...
          function wn(c, h) {
            ...
            return typeof WebAssembly.instantiateStreaming != "function" ||
              ...
              typeof fetch != "function"
              ? jr(g, c, h)
              : fetch(g, { credentials: "same-origin" }).then((S) =>
                  WebAssembly.instantiateStreaming(S, c).then(h, function (k) {
                    return (
                      V(`wasm streaming compile failed: ${k}`),
          ...
          var Ir = (c) => {
            ...
            Sr = (c) => {
              ...
              var g = { cmd: "run", start_routine: c.kb, arg: c.hb, pthread_ptr: c.Oa };
              return w && h.unref(), h.postMessage(g, c.qb), 0;
            },
            or = 0,
            Yr = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0,
            Xr = (c, h, g) => {
              h >>>= 0;
              var S = h + g;
              for (g = h; c[g] && !(g >= S); ) ++g;
              if (16 < g - h && c.buffer && Yr)
                return Yr.decode(
                  c.buffer instanceof SharedArrayBuffer ? c.slice(h, g) : c.subarray(h, g)
                );
              for (S = ""; h < g; ) {
                var k = c[h++];
                if (k & 128) {
          ...
          function Q(c) {
            ...
            (Ne = c), 0 < or || (J.lb(), i.onExit?.(c), (mt = !0)), d(c, new qt(c));
          }
          var Pr = (c) => {
            if (((Ne = c), I)) throw (In(c), "unwind");
            Q(c);
          };
          function _n() {
          ...
          var J = {
            ...
            Wa() {
              I
                ? ((J.receiveObjectTransfer = J.jb),
                  (J.threadInitTLS = J.ab),
                  (J.setExitStatus = J.$a))
                : _n();
            },
            $a: (c) => (Ne = c),
              ...
              new Promise((h) => {
                (c.onmessage = (B) => {
                  ...
                  if (B.targetThread && B.targetThread != An()) {
                    ...
                    Ie
                      ? Ie.postMessage(B, B.transferList)
                      : V(
                          `Internal error! Worker sent a message "${z}" to target pthread ${B.targetThread}, but that thread no longer exists!`
                        );
                  } else
                    z === "checkMailbox"
                      ? Sn()
                        ...
                        : z === "cleanupThread"
                          ...
                          : z === "killThread"
                            ? ((B = B.thread),
                              ...
                              Ir(z),
                              Uo(B),
                              J.Qa.splice(J.Qa.indexOf(z), 1),
                              (z.Oa = 0))
                            : z === "cancelThread"
                              ? J.Ma[B.thread].postMessage({ cmd: "cancel" })
                              : z === "loaded"
                                ? ((c.loaded = !0), w && !c.Oa && c.unref(), h(c))
                                : z === "alert"
                                  ? alert(`Thread ${B.threadId}: ${B.text}`)
                                  : B.target === "setimmediate"
                                    ? c.postMessage(B)
                                    : z === "callHandler"
                                      ? i[B.handler](...B.args)
                                      : z && V(`worker sent an unknown command ${z}`);
                }),
                  (c.onerror = (B) => {
                    throw (V(`worker sent an error! ${B.filename}:${B.lineno}: ${B.message}`), B);
                  }),
                  w &&
                    (c.on("message", (B) => c.onmessage({ data: B })),
          ...
          i.invokeEntryPoint = (c, h) => {
            var g = zt[c];
            g || (c >= zt.length && (zt.length = c + 1), (zt[c] = g = Jr.get(c))),
              (c = g(h)),
              0 < or ? J.$a(c) : zo(c);
          };
          function b(c) {
          ...
          function G(c, h, g, S) {
            if (((c >>>= 0), (h >>>= 0), (g >>>= 0), (S >>>= 0), typeof SharedArrayBuffer > "u"))
              return (
                V(
            ...
            return I && k.length === 0
              ? D(c, h, g, S)
              : ((c = { kb: g, Oa: c, hb: S, qb: k }),
                I ? ((c.sb = "spawnThread"), postMessage(c, k), 0) : Sr(c));
          }
          function X(c, h, g) {
          ...
          function Bo(c) {
            (c >>>= 0),
              typeof Atomics.rb == "function" &&
                (Atomics.rb(r(), c >>> 2, c).value.then(Sn),
                (c += 128),
                Atomics.store(r(), c >>> 2, 1));
          }
          ...
          function Sa(c, h) {
            ...
            return (
              Ia().forEach((S, k) => {
                var B = h + g;
                for (k = n()[((c + 4 * k) >>> 2) >>> 0] = B, B = 0; B < S.length; ++B)
                  o()[(k++ >>> 0) >>> 0] = S.charCodeAt(B);
          ...
          var Fa = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
          ...
          function $a(c, h, g, S) {
            function k(P, de, Se) {
              for (P = typeof P == "number" ? P.toString() : P || ""; P.length < de; )
                P = Se[0] + P;
              return P;
            }
            function B(P, de) {
            ...
            function z(P, de) {
              ...
              var ar;
              return (
                (ar = Se(P.getFullYear() - de.getFullYear())) === 0 &&
                  (ar = Se(P.getMonth() - de.getMonth())) === 0 &&
                  (ar = Se(P.getDate() - de.getDate())),
                ar
              );
            }
            function Ie(P) {
            ...
            function Ft(P) {
              ...
              return (
                (Se = new Date(P.getFullYear() + 1, 0, 4)),
                (de = Ie(new Date(P.getFullYear(), 0, 4))),
                (Se = Ie(Se)),
                0 >= z(de, P)
                  ? 0 >= z(Se, P)
                    ? P.getFullYear() + 1
            ...
            for (var et in Re) g = g.replace(new RegExp(et, "g"), Re[et]);
            ...
            (Re = {
              "%a": (P) => Va[P.Na].substring(0, 3),
              "%A": (P) => Va[P.Na],
              "%b": (P) => Wa[P.Ua].substring(0, 3),
              "%B": (P) => Wa[P.Ua],
              ...
              "%j": (P) => {
                for (var de = 0, Se = 0; Se <= P.Ua - 1; de += (Er(P.Sa + 1900) ? Fa : Ca)[Se++]);
                return B(P.Xa + de, 3);
              },
              "%m": (P) => B(P.Ua + 1, 2),
              "%M": (P) => B(P.nb, 2),
...
`,
              ...
              "%V": (P) => {
                ...
                if ((2 >= (P.Na + 371 - P.Ra - 2) % 7 && de++, de))
                  de == 53 &&
                    ((Se = (P.Na + 371 - P.Ra) % 7), Se == 4 || (Se == 3 && Er(P.Sa)) || (de = 1));
                else {
                  de = 52;
                  var Se = (P.Na + 7 - P.Ra - 1) % 7;
                  (Se == 4 || (Se == 5 && Er((P.Sa % 400) - 1))) && de++;
                }
                return B(de, 2);
              },
              "%w": (P) => P.Na,
              ...
              (g = g.replace(/%%/g, "\0\0"));
            for (et in Re) g.includes(et) && (g = g.replace(new RegExp(et, "g"), Re[et](S)));
            return (
              (g = g.replace(/\0\0/g, "%")),
              (et = wd(g)),
              et.length > h ? 0 : (vd(et, c), et.length - 1)
            );
          }
          J.Wa();
          var _d = [
            ...
            Od = {
              ...
              L: function (c) {
                Na(c >>> 0, !v, 1, !T, 131072, !1), J.ab();
              },
              j: function (c) {
                (c >>>= 0), I ? postMessage({ cmd: "cleanupThread", thread: c }) : J.Za(J.Ma[c]);
              },
              H: G,
              h: X,
              S: ne,
                ...
                (c >>>= 0),
                  c == h >>> 0
                    ...
                    : I
                      ...
                      : (c = J.Ma[c]) && c.postMessage({ cmd: "checkMailbox" });
              },
              I: function (c, h, g, S) {
              ...
              s: function (c, h, g) {
                (c = (h + 2097152) >>> 0 < 4194305 - !!c ? (c >>> 0) + 4294967296 * h : NaN),
                  (g >>>= 0),
                  (c = new Date(1e3 * c)),
                  (r()[(g >>> 2) >>> 0] = c.getUTCSeconds()),
                  (r()[((g + 4) >>> 2) >>> 0] = c.getUTCMinutes()),
                  (r()[((g + 8) >>> 2) >>> 0] = c.getUTCHours()),
                  (r()[((g + 12) >>> 2) >>> 0] = c.getUTCDate()),
                  (r()[((g + 16) >>> 2) >>> 0] = c.getUTCMonth()),
                  (r()[((g + 20) >>> 2) >>> 0] = c.getUTCFullYear() - 1900),
                  (r()[((g + 24) >>> 2) >>> 0] = c.getUTCDay()),
                  (c =
                    ((c.getTime() - Date.UTC(c.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5) | 0),
                  (r()[((g + 28) >>> 2) >>> 0] = c);
              },
              t: function (c, h, g) {
                (c = (h + 2097152) >>> 0 < 4194305 - !!c ? (c >>> 0) + 4294967296 * h : NaN),
                  (g >>>= 0),
                  (c = new Date(1e3 * c)),
                  (r()[(g >>> 2) >>> 0] = c.getSeconds()),
                  (r()[((g + 4) >>> 2) >>> 0] = c.getMinutes()),
                  (r()[((g + 8) >>> 2) >>> 0] = c.getHours()),
                  (r()[((g + 12) >>> 2) >>> 0] = c.getDate()),
                  (r()[((g + 16) >>> 2) >>> 0] = c.getMonth()),
                  (r()[((g + 20) >>> 2) >>> 0] = c.getFullYear() - 1900),
                  (r()[((g + 24) >>> 2) >>> 0] = c.getDay()),
                  (h = ((Er(c.getFullYear()) ? xa : wa)[c.getMonth()] + c.getDate() - 1) | 0),
                  (r()[((g + 28) >>> 2) >>> 0] = h),
                  (r()[((g + 36) >>> 2) >>> 0] = -(60 * c.getTimezoneOffset())),
                  (h = new Date(c.getFullYear(), 6, 1).getTimezoneOffset());
                var S = new Date(c.getFullYear(), 0, 1).getTimezoneOffset();
                (c = (h != S && c.getTimezoneOffset() == Math.min(S, h)) | 0),
                  (r()[((g + 32) >>> 2) >>> 0] = c);
              },
              u: function (c) {
                c >>>= 0;
                ...
                return (
                  0 > g
                    ? (r()[((c + 32) >>> 2) >>> 0] = +(k != B && z == S))
                    : 0 < g != (z == S) &&
                      ((k = Math.max(B, k)), h.setTime(h.getTime() + 6e4 * ((0 < g ? z : k) - S))),
                  (r()[((c + 24) >>> 2) >>> 0] = h.getDay()),
                  (g = ((Er(h.getFullYear()) ? xa : wa)[h.getMonth()] + h.getDate() - 1) | 0),
                  (r()[((c + 28) >>> 2) >>> 0] = g),
                  (r()[(c >>> 2) >>> 0] = h.getSeconds()),
                  (r()[((c + 4) >>> 2) >>> 0] = h.getMinutes()),
                  (r()[((c + 8) >>> 2) >>> 0] = h.getHours()),
                  (r()[((c + 12) >>> 2) >>> 0] = h.getDate()),
                  (r()[((c + 16) >>> 2) >>> 0] = h.getMonth()),
                  (r()[((c + 20) >>> 2) >>> 0] = h.getYear()),
                  (c = h.getTime()),
                  isNaN(c) ? ((r()[(ka() >>> 2) >>> 0] = 61), (c = -1)) : (c /= 1e3),
                  Ga(
                    ((Ut = c),
                    1 <= +Math.abs(Ut)
                      ? 0 < Ut
                        ? +Math.floor(Ut / 4294967296) >>> 0
                        : ~~+Math.ceil((Ut - +(~~Ut >>> 0)) / 4294967296) >>> 0
                      : 0)
                  ),
                  c >>> 0
                );
              ...
              y: function (c, h, g) {
                function S(Re) {
                  return (Re = Re.toTimeString().match(/\(([A-Za-z ]+)\)$/)) ? Re[1] : "GMT";
                }
                (c >>>= 0), (h >>>= 0), (g >>>= 0);
                ...
                (n()[(c >>> 2) >>> 0] = 60 * Ft),
                  ...
                  (h = Oa(h)),
                  Ie < k
                    ? ((n()[(g >>> 2) >>> 0] = c), (n()[((g + 4) >>> 2) >>> 0] = h))
                    : ((n()[(g >>> 2) >>> 0] = h), (n()[((g + 4) >>> 2) >>> 0] = c));
              },
              c: () => {
                Mt("");
              },
              ...
              f: () => (w ? (Bp(), jt(kp)).cpus().length : navigator.hardwareConcurrency),
              x: function (c) {
                c >>>= 0;
                var h = e().length;
                ...
                for (var g = 1; 4 >= g; g *= 2) {
                  ...
                  e: {
                    k =
                      (k.min.call(k, 4294901760, S + ((65536 - (S % 65536)) % 65536)) -
          ...
          (i._OrtInit = (c, h) => (i._OrtInit = K.W)(c, h)),
            (i._OrtGetLastError = (c, h) => (i._OrtGetLastError = K.X)(c, h)),
            (i._OrtCreateSessionOptions = (c, h, g, S, k, B, z, Ie, Ft, Re) =>
              (i._OrtCreateSessionOptions = K.Y)(c, h, g, S, k, B, z, Ie, Ft, Re)),
            (i._OrtAppendExecutionProvider = (c, h) => (i._OrtAppendExecutionProvider = K.Z)(c, h)),
            (i._OrtAddFreeDimensionOverride = (c, h, g) =>
              (i._OrtAddFreeDimensionOverride = K._)(c, h, g)),
            (i._OrtAddSessionConfigEntry = (c, h, g) =>
              (i._OrtAddSessionConfigEntry = K.$)(c, h, g)),
            (i._OrtReleaseSessionOptions = (c) => (i._OrtReleaseSessionOptions = K.aa)(c)),
            (i._OrtCreateSession = (c, h, g) => (i._OrtCreateSession = K.ba)(c, h, g)),
            (i._OrtReleaseSession = (c) => (i._OrtReleaseSession = K.ca)(c)),
            (i._OrtGetInputOutputCount = (c, h, g) => (i._OrtGetInputOutputCount = K.da)(c, h, g)),
            (i._OrtGetInputName = (c, h) => (i._OrtGetInputName = K.ea)(c, h)),
            (i._OrtGetOutputName = (c, h) => (i._OrtGetOutputName = K.fa)(c, h)),
            (i._OrtFree = (c) => (i._OrtFree = K.ga)(c)),
            (i._OrtCreateTensor = (c, h, g, S, k, B) =>
              (i._OrtCreateTensor = K.ha)(c, h, g, S, k, B)),
            (i._OrtGetTensorData = (c, h, g, S, k) => (i._OrtGetTensorData = K.ia)(c, h, g, S, k)),
            (i._OrtReleaseTensor = (c) => (i._OrtReleaseTensor = K.ja)(c)),
            (i._OrtCreateRunOptions = (c, h, g, S) => (i._OrtCreateRunOptions = K.ka)(c, h, g, S)),
            (i._OrtAddRunConfigEntry = (c, h, g) => (i._OrtAddRunConfigEntry = K.la)(c, h, g)),
            (i._OrtReleaseRunOptions = (c) => (i._OrtReleaseRunOptions = K.ma)(c)),
            (i._OrtCreateBinding = (c) => (i._OrtCreateBinding = K.na)(c)),
            (i._OrtBindInput = (c, h, g) => (i._OrtBindInput = K.oa)(c, h, g)),
            (i._OrtBindOutput = (c, h, g, S) => (i._OrtBindOutput = K.pa)(c, h, g, S)),
            (i._OrtClearBoundOutputs = (c) => (i._OrtClearBoundOutputs = K.qa)(c)),
            (i._OrtReleaseBinding = (c) => (i._OrtReleaseBinding = K.ra)(c)),
            (i._OrtRunWithBinding = (c, h, g, S, k) =>
              (i._OrtRunWithBinding = K.sa)(c, h, g, S, k)),
            (i._OrtRun = (c, h, g, S, k, B, z, Ie) => (i._OrtRun = K.ta)(c, h, g, S, k, B, z, Ie)),
            (i._OrtEndProfiling = (c) => (i._OrtEndProfiling = K.ua)(c));
          var ka = () => (ka = K.va)(),
            An = (i._pthread_self = () => (An = i._pthread_self = K.wa)()),
            Ba = (i._malloc = (c) => (Ba = i._malloc = K.xa)(c));
          (i._free = (c) => (i._free = K.ya)(c)),
            (i.__emscripten_tls_init = () => (i.__emscripten_tls_init = K.za)());
          var Na = (i.__emscripten_thread_init = (c, h, g, S, k, B) =>
            (Na = i.__emscripten_thread_init = K.Ba)(c, h, g, S, k, B));
          i.__emscripten_thread_crashed = () => (i.__emscripten_thread_crashed = K.Ca)();
          var Ra = (c, h, g, S) => (Ra = K.Da)(c, h, g, S),
            Uo = (c) => (Uo = K.Ea)(c),
            zo = (i.__emscripten_thread_exit = (c) => (zo = i.__emscripten_thread_exit = K.Fa)(c)),
            Ma = () => (Ma = K.Ga)(),
            Ga = (c) => (Ga = K.Ha)(c),
            Ua = (c, h) => (Ua = K.Ia)(c, h),
            Vo = () => (Vo = K.Ja)(),
          ...
          function Id() {
            ...
            return (
              ...
              (c.wa = h(c.wa)),
              (c.xa = g(c.xa)),
              (c.emscripten_main_runtime_thread_id = h(c.emscripten_main_runtime_thread_id)),
              (c.Ja = h(c.Ja)),
              (c.La = g(c.La)),
              c
            );
          ...
          (i.wasmMemory = Ae),
            ...
            (i.stackSave = Vo),
            (i.stackRestore = Pn),
            (i.keepRuntimeAlive = () => 0 < or),
            (i.UTF8ToString = Ar),
            (i.stringToUTF8 = Ue),
            (i.lengthBytesUTF8 = ke),
            (i.ExitStatus = qt),
            (i.PThread = J);
          var En;
          Qe = function c() {
          ...
          function za() {
            if (!(0 < yt))
              if (I) u(i), I || ir(Pt), startWorker(i);
              else {
                if (i.preRun)
                  for (typeof i.preRun == "function" && (i.preRun = [i.preRun]); i.preRun.length; )
                    rr.unshift(i.preRun.shift());
                ir(rr),
                  0 < yt ||
                    En ||
                    ((En = !0), (i.calledRun = !0), mt || (I || ir(Pt), u(i), I || ir(gt)));
              }
          }
          return za(), t.ready;
        }
    ...
    typeof Rp == "object" && typeof aa == "object"
      ? (aa.exports = Np)
      : typeof define == "function" && define.amd && define([], () => Np);
  });
  var Gp = me((fO, ug) => {
    ug.exports =
    ...
    Vr = E(() => {
      ...
      (lg = Mp()),
        ...
        (Vp = async (a) => {
          ...
          if (Up) throw new Error("previous call to 'initializeWebAssembly()' failed.");
          Po = !0;
          let t = a.initTimeout,
            o = a.numThreads,
            e = a.simd,
            ...
            p.push(
              new Promise((d, T) => {
                let v = r ? lg : zp,
                  w = {
                    locateFile: (I, L) =>
                      r && I.endsWith(".worker.js") && typeof Blob < "u"
                        ? URL.createObjectURL(new Blob([Gp()], { type: "text/javascript" }))
                        : I.endsWith(".wasm")
                          ? l || (i ?? L) + u
                          : L + I,
                  };
                if (r)
                  if (((w.numThreads = o), typeof Blob > "u"))
                    w.mainScriptUrlOrBlob = (void 0)(__dirname, "ort-wasm-threaded.js");
                  else {
                    let I = `var ortWasmThreaded=${v.toString()};`;
                    w.mainScriptUrlOrBlob = new Blob([I], { type: "text/javascript" });
                  }
                v(w).then(
                  (I) => {
                    (Po = !1), (ua = !0), (sa = I), d();
    ...
    Hp = E(() => {
      ...
      Wp = (a) => {
        ...
        try {
          ...
          let n = 0;
          return (
            a?.tag !== void 0 && (n = _e(a.tag, e)),
            (o = t._OrtCreateRunOptions(r.logSeverityLevel, r.logVerbosityLevel, !!r.terminate, n)),
            o === 0 && Oe("Can't create run options."),
            a?.extra !== void 0 &&
              yn(a.extra, "", new WeakSet(), (s, i) => {
                let u = _e(s, e),
                  l = _e(i, e);
                t._OrtAddRunConfigEntry(o, u, l) !== 0 &&
                  Oe(`Can't set a run config entry: ${s} - ${i}.`);
              }),
            [o, e]
          );
        } catch (n) {
      ...
      (dg = (a) => {
        ...
        (mg = (a) => {
          ...
          t.use_ort_model_bytes_directly || (t.use_ort_model_bytes_directly = "1"),
            a.executionProviders &&
              a.executionProviders.some((o) => (typeof o == "string" ? o : o.name) === "webgpu") &&
        ...
        (bg = (a, t, o) => {
          for (let e of t) {
            ...
            switch (r) {
              case "webnn":
                if (((r = "WEBNN"), typeof e != "string")) {
                  let s = e;
                  if (s?.deviceType) {
                    let i = _e("deviceType", o),
                      u = _e(s.deviceType, o);
                    Le()._OrtAddSessionConfigEntry(a, i, u) !== 0 &&
                      Oe(`Can't set a session config entry: 'deviceType' - ${s.deviceType}.`);
                  }
                  if (s?.numThreads) {
                    let i = s.numThreads;
                    (typeof i != "number" || !Number.isInteger(i) || i < 0) && (i = 0);
                    let u = _e("numThreads", o),
                      l = _e(i.toString(), o);
                    Le()._OrtAddSessionConfigEntry(a, u, l) !== 0 &&
                      Oe(`Can't set a session config entry: 'numThreads' - ${s.numThreads}.`);
                  }
                  if (s?.powerPreference) {
                    let i = _e("powerPreference", o),
                      u = _e(s.powerPreference, o);
                    Le()._OrtAddSessionConfigEntry(a, i, u) !== 0 &&
                      Oe(
              ...
              case "webgpu":
                if (((r = "JS"), typeof e != "string")) {
                  ...
                  if (s?.preferredLayout) {
                    ...
                    let i = _e("preferredLayout", o),
                      u = _e(s.preferredLayout, o);
                    Le()._OrtAddSessionConfigEntry(a, i, u) !== 0 &&
                      Oe(
            ...
            let n = _e(r, o);
            Le()._OrtAppendExecutionProvider(a, n) !== 0 &&
              Oe(`Can't append execution provider: ${r}.`);
          }
        }),
        (qp = (a) => {
          let t = Le(),
          ...
          mg(r);
          try {
            let n = dg(r.graphOptimizationLevel ?? "all"),
              s = hg(r.executionMode ?? "sequential"),
              i = typeof r.logId == "string" ? _e(r.logId, e) : 0,
            ...
            let f =
              typeof r.optimizedModelFilePath == "string" ? _e(r.optimizedModelFilePath, e) : 0;
            if (
              ...
              o === 0 && Oe("Can't create session options."),
              r.executionProviders && bg(o, r.executionProviders, e),
              ...
              let p = _e("enableGraphCapture", e),
                d = _e(r.enableGraphCapture.toString(), e);
            ...
            if (r.freeDimensionOverrides)
              for (let [p, d] of Object.entries(r.freeDimensionOverrides)) {
                ...
                t._OrtAddFreeDimensionOverride(o, T, d) !== 0 &&
                  Oe(`Can't set a free dimension override: ${p} - ${d}.`);
              }
            return (
              r.extra !== void 0 &&
                yn(r.extra, "", new WeakSet(), (p, d) => {
                  let T = _e(p, e),
                    v = _e(d, e);
                  t._OrtAddSessionConfigEntry(o, T, v) !== 0 &&
                    Oe(`Can't set a session config entry: ${p} - ${d}.`);
                }),
              [o, e]
            );
          } catch (n) {
  ...
  var la,
    ...
    ca = E(() => {
      ...
      (la = (a) => {
        ...
        (fa = (a) =>
          [void 0, 4, 1, 1, 2, 2, 4, 8, void 0, 1, 2, 8, 4, 8, void 0, void 0, void 0][a]),
        (Xp = (a) => {
          switch (a) {
            case "float16":
  ...
  var gg,
    ...
    ad = E(() => {
      ...
      pa();
      (gg = (a, t) => {
        Le()._OrtInit(a, t) !== 0 && Oe("Can't initialize onnxruntime.");
      }),
        (Qp = async (a) => {
          gg(a.wasm.numThreads, Kp(a.logLevel));
        }),
        (ed = async (a, t) => {}),
        (Wr = new Map()),
        (yg = (a) => {
          ...
          try {
            ...
            return (
              t._OrtGetInputOutputCount(a, e, e + 4) !== 0 &&
                Oe("Can't get session input/output count."),
        ...
        (td = async (a, t) => {
          ...
          let n = 0,
            ...
            f = [];
          try {
            if ((([s, u] = qp(t)), t?.externalData && r.mountExternalData)) {
              let F = [];
              for (let C of t.externalData) {
                let Y = typeof C == "string" ? C : C.path;
                F.push(
                  Tn(typeof C == "string" ? C : C.data).then((j) => {
            ...
            let L = null;
            return Wr.set(n, [n, l, f, L, T, !1]), [n, v, w];
          } catch (p) {
            throw (
        ...
        (rd = (a) => {
          ...
          let [e, r, n, s, i] = o;
          s && (i && t._OrtClearBoundOutputs(s.handle), t._OrtReleaseBinding(s.handle)),
        ...
        (Zp = (a, t, o, e, r, n = !1) => {
          ...
          if (l === "gpu-buffer") {
            ...
            if (Array.isArray(v)) {
              ...
              (p = v.byteLength),
                (f = s._malloc(p)),
                o.push(f),
                s.HEAPU8.set(new Uint8Array(v.buffer, v.byteOffset, p), f);
          }
          let d = s.stackSave(),
          ...
          try {
            ...
            let w = s._OrtCreateTensor(la(i), f, p, T, u.length, Jp(l));
            w === 0 && Oe(`Can't create tensor for input/output. session=${e}, index=${r}.`),
              t.push(w);
          } finally {
            s.stackRestore(d);
          }
        }),
        (nd = async (a, t, o, e, r, n) => {
          let s = Le(),
            i = Wr.get(a);
          ...
          try {
            [I, L] = Wp(n);
            for (let te = 0; te < v; te++) Zp(o[te], F, Y, a, t[te], d);
            for (let te = 0; te < w; te++) Zp(r[te], C, Y, a, v + e[te], d);
            let Fe = M / 4,
              V = ie / 4,
              Ae = ot / 4,
              It = We / 4;
            ...
            s.jsepOnRunStart?.(u);
            let mt;
            (mt = await s._OrtRun(u, ie, M, v, We, w, ot, I)),
              mt !== 0 && Oe("failed to call OrtRun().");
            let Ne = [];
            for (let te = 0; te < w; te++) {
              ...
              let St = s.stackSave(),
                ...
                Ze = 0;
              try {
                s._OrtGetTensorData(bt, He, He + 4, He + 8, He + 12) !== 0 &&
                  Oe(`Can't access output tensor data on index ${te}.`);
                let Pt = He / 4,
                  gt = s.HEAPU32[Pt++];
                Ze = s.HEAPU32[Pt++];
                let yt = s.HEAPU32[Pt++],
                  nr = s.HEAPU32[Pt++],
                  Qe = [];
                for (let $e = 0; $e < nr; $e++) Qe.push(s.HEAPU32[yt / 4 + $e]);
                s._OrtFree(yt);
                ...
                if (we === "string") {
                  ...
                  for (let qe = 0; qe < Et; qe++) {
                    let Gt = s.HEAPU32[ve++],
                      Dt = qe === Et - 1 ? void 0 : s.HEAPU32[ve] - Gt;
                  ...
                  let $e = Xp(we),
                    ve = new $e(Et);
                  new Uint8Array(ve.buffer, ve.byteOffset, ve.byteLength).set(
                    s.HEAPU8.subarray(Ze, Ze + ve.byteLength)
                  ),
                    Ne.push([we, Qe, ve, "cpu"]);
                }
              } finally {
                s.stackRestore(St),
                  we === "string" && Ze && s._free(Ze),
                  At || s._OrtReleaseTensor(bt);
              }
            }
            return (
              p && !d && (s._OrtClearBoundOutputs(p.handle), Wr.set(a, [u, l, f, p, d, !1])), Ne
            );
          } finally {
            s.stackRestore(j),
              F.forEach((Fe) => s._OrtReleaseTensor(Fe)),
              C.forEach((Fe) => s._OrtReleaseTensor(Fe)),
              Y.forEach((Fe) => s._free(Fe)),
              I !== 0 && s._OrtReleaseRunOptions(I),
              L.forEach((Fe) => s._free(Fe));
          }
        }),
        (od = (a) => {
          let t = Le(),
    ...
    ba = E(() => {
      ...
      (_r = () => !!Z.wasm.proxy && typeof document < "u"),
        ...
        (wg = (a) => {
          switch (a.data.type) {
            case "init-wasm":
              (xn = !1), a.data.err ? ((Co = !0), ha[1](a.data.err)) : ((Fo = !0), ha[0]());
              break;
            case "init-ep":
            case "copy-from":
            case "create":
        ...
        (Lo = typeof document < "u" ? document?.currentScript?.src : void 0),
        (ud = async () => {
          if (!Fo) {
            ...
            if (((xn = !0), _r()))
              return (
                Z.wasm.wasmPaths === void 0 &&
                  Lo &&
                  Lo.indexOf("blob:") !== 0 &&
                  (Z.wasm.wasmPaths = Lo.substr(0, +Lo.lastIndexOf("/") + 1)),
                new Promise((a, t) => {
                  ht?.terminate();
                  let o = URL.createObjectURL(new Blob([sd()], { type: "text/javascript" }));
                  (ht = new Worker(o, { name: "ort-wasm-proxy-worker" })),
                    (ht.onerror = (r) => t(r)),
                    (ht.onmessage = wg),
            ...
            try {
              await Vp(Z.wasm), await Qp(Z), (Fo = !0);
            } catch (a) {
              throw ((Co = !0), a);
            } finally {
              xn = !1;
            ...
            return (
              ...
              new Promise((o, e) => {
                ...
                let r = { type: "create", in: { model: a, options: { ...t } } },
                  n = [];
                a instanceof Uint8Array && n.push(a.buffer), ht.postMessage(r, n);
              })
            );
          } else return td(a, t);
        }),
            ...
            return (
              ...
              new Promise((s, i) => {
                ...
                let u = o,
                  l = {
                    type: "run",
                    in: { sessionId: a, inputIndices: t, inputs: u, outputIndices: e, options: n },
                  };
                ht.postMessage(l, id(u));
              })
            );
          } else return nd(a, t, o, e, r, n);
        }),
        (hd = async (a) => {
          if (_r())
            return (
        ...
        ($o = class {
          ...
          async loadModel(t, o) {
            ...
            typeof t == "string"
              ...
              : (e = t),
              ([this.sessionId, this.inputNames, this.outputNames] = await cd(e, o)),
              Xt();
          }
          async dispose() {
          ...
          async run(t, o, e) {
            ...
            Object.entries(o).forEach((d) => {
              let T = d[0],
                v = d[1],
                w = this.outputNames.indexOf(T);
              if (w === -1) throw new Error(`invalid output '${T}'`);
              s.push(v), i.push(w);
            });
            let u = r.map((d, T) => md(d, () => `input "${this.inputNames[n[T]]}"`)),
              l = s.map((d, T) => (d ? md(d, () => `output "${this.outputNames[i[T]]}"`) : null)),
              f = await dd(this.sessionId, n, u, i, l, e),
              p = {};
  ...
  var Ig = Xo;
  {
    let a = (Pp(), jt(Ap)).onnxjsBackend;
    lr("webgl", a, -10);
  }
  {
    let a = (Td(), jt(yd)).wasmBackend;
    lr("cpu", a, 10), lr("wasm", a, 10);
  }
  Object.defineProperty(Z.versions, "web", { value: _s, enumerable: !0 });
  return jt(Sg);
})();
