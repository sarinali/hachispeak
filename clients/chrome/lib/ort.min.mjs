  ...
  Wu = (e, t, n, r) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let o of Nu(t))
        !Lu.call(e, o) &&
          o !== n &&
          wn(e, o, { get: () => t[o], enumerable: !(r = Vu(t, o)) || r.enumerable });
    return e;
  };
...
var Sn,
  ...
  Pr = k(() => {
    ...
    (Sn = (e, t) => {
      ...
      (kr = (e, t, n) =>
        new me({ location: "cpu-pinned", type: e, data: t, dims: n ?? [t.length] }));
  });
var Ze,
  dt,
  zr,
      ...
      (Br = () => {
        if (!zr) {
          ...
          e && (Ze.set("int64", BigInt64Array), dt.set(BigInt64Array, "int64")),
            t && (Ze.set("uint64", BigUint64Array), dt.set(BigUint64Array, "uint64")),
            r ? (Ze.set("float16", n), dt.set(n, "float16")) : Ze.set("float16", Uint16Array);
        }
      });
  });
var Or,
  ...
  Vr = k(() => {
    ...
    Tt = class e {
      ...
      async run(t, n, r) {
        ...
        let o = {},
          i = {};
        if (typeof t != "object" || t === null || t instanceof Se || Array.isArray(t))
          throw new TypeError(
        ...
        if (typeof n == "object") {
          ...
          if (n instanceof Se) throw new TypeError("'fetches' cannot be a Tensor");
          if (Array.isArray(n)) {
            ...
            for (let c of this.outputNames)
              if (l.indexOf(c) !== -1) {
                let p = n[c];
                (p === null || p instanceof Se) && ((d = !0), (s = !1), (o[c] = p));
              }
            if (d) {
              if (typeof r == "object" && r !== null) i = r;
              else if (typeof r < "u") throw new TypeError("'options' must be an object.");
        ...
        for (let d in a)
          if (Object.hasOwnProperty.call(a, d)) {
            let l = a[d];
            l instanceof Se ? (u[d] = l) : (u[d] = new Se(l.type, l.data, l.dims));
          }
  ...
  We = k(() => {
    ...
    (Pn = !1),
      ...
      (At = async (e) => {
        ...
        if (Ut) throw new Error("multiple calls to 'initializeWebAssembly()' detected.");
        ...
        if (
          ...
          m.push(
            new Promise((h, b) => {
              ...
              p(y).then(
                (g) => {
                  (Ut = !1), (Pn = !0), (kn = g), h(), c && URL.revokeObjectURL(c);
                },
                (g) => {
                  (Ut = !1), (no = !0), b(g);
                }
      ...
      (Ft = class {
        ...
        async ensureTensor(t, n, r, o) {
          ...
          if (!i.opSupportLimits().input.dataTypes.includes(n)) {
            if (((s = ud.get(n)), !s || !i.opSupportLimits().input.dataTypes.includes(s)))
          ...
          if (this.wrapper) {
            if (this.wrapper.fallbackType)
              if (this.wrapper.fallbackType === "int32")
                (n = Un(t, this.wrapper.type)), this.wrapper.setIsDataConverted(!0);
      ...
      (Mn = class {
        ...
        registerTensor(t, n, r, o) {
          let i = this.getMLContext(t),
            s = po(),
            a = new qt({ sessionId: t, context: i, tensor: n, dataType: r, shape: o });
...
var Ye,
  ...
  K = k(() => {
    ...
    (Ye = 64),
      ...
      (qn = (e = "f32", t, n = "0") => (!t || t === 1 ? `${e}(${n})` : `vec${t}<${e}>(${n})`)),
      (Je = (e, t, n) => (e === "f32" ? n : t === 1 ? `f32(${n})` : `vec${t}<f32>(${n})`)),
      (Te = (e, t) =>
        t === 4
          ? `(${e}.x + ${e}.y + ${e}.z + ${e}.w)`
          : t === 2
  ...
  fn o2i_${e}(offset: u32) -> ${p.indices} {
    ...
    return indices;
          ...
          v = [];
        if (s >= 2) for (let E = s - 1; E >= 0; E--) v.push(`${O(y, E, s)} * (indices[${E}])`);
        let $ =
            s < 2
              ? ""
              : `
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join("+")};
          ...
          I = (...E) => (s === 0 ? "0u" : `${p.indices}(${E.map(f).join(",")})`),
          A = (E, L) => (s < 2 ? `${E}` : `${O(E, L, s)}`),
  ...
  fn get_${e}(${E}) -> ${l} {
    return get_${e}ByIndices(${I(L)});
          ...
          Z = (E) =>
            s < 2
              ? B(E)
              : ((m.getByIndices = !0), (m.indicesToOffset = !0), `get_${e}ByIndices(${E})`),
          R =
            s < 2
              ? ""
              : `
...
`)
          ...
          setByIndices: (E, L) =>
            s < 2
              ? G(E, L)
              : ((m.setByIndices = !0), (m.indicesToOffset = !0), `set_${e}ByIndices(${E}, ${L});`),
          get: D,
          getByOffset: B,
          getByIndices: Z,
          usage: r,
...
var pd,
  ...
  Ue = k(() => {
    ...
    (pd = (e, t) => {
      ...
      (Io = (e, t) => (t.length !== 0 ? t : [...new Array(e).keys()].reverse())),
  ...
  Vo = k(() => {
    ...
    (yd = {
      ...
      (ze = (e, t, n, r) => {
        ...
        d.length > 0 &&
          ((u = e.compute(pe(e.inputs[0], d), { inputs: [0], outputs: [-1] })[0]),
          (a = $d(a.length, u.dims.length)));
        let [l, c] = vd(u.dims, a),
          p = l;
        o.keepDims && (p = xd(l, s)),
          e.compute(Id(t, o.cacheKey, [u], r, e.inputs[0].dataType, p, c), { inputs: [u] });
      }),
      (Eo = (e, t) => {
...
var Be,
  ...
  Yt = k(() => {
    ...
    (Be = (e) => {
      ...
      (Cd = (e) => ["", "", `var value = ${e.getByIndices("input_indices")};`, ""]),
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
      ...
      (rt = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
        ...
        e.compute(Vd(y, d.batchSize, d.numHeads, f, d.sequenceLength, m, l, c), {
          inputs: l && c ? [y, l, c] : [y],
          outputs: [],
        });
        let g = [y, r];
        p > 1 && a && x.size(a.dims) > 0 && g.push(a),
          l && g.push(l),
          c && g.push(c),
          e.compute(Ld(p, y, r, a, d, f, l, c), { inputs: g, outputs: p > 1 ? [0, 2] : [0] });
      }),
      (Wd = (e, t) => {
  ...
  ${c.mainStart([s, s, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      (ei = (e, t) => {
        let n = Rd(e.inputs, t),
          [r, o, i] = Wd(e, n);
        return rt(e, r, o, i, e.inputs[4], void 0, void 0, void 0, e.inputs[5], n);
      });
  });
var Gd,
  Hd,
...
`),
      ...
      (Ni = (e, t) => {
        let n = ce(e.inputs[0].dataType);
        e.compute(
          J(e.inputs[0], "QuickGelu", Xd, Qd(n, t.alpha), t.cacheKey, e.inputs[0].dataType)
        );
      });
  });
var Yd,
        ...
        let w = (v) => {
          ...
          if (h) {
            ...
            U.push(S("bias", e[2].dataType, e[2].dims.length, W)),
              (G = `${o ? `value += bias[col / ${W}];` : `value += ${A.type.value}(bias[row + i]);`}`);
          }
          let B = [
  ...
  ds = k(() => {
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h ? `vec4<${R}>` : R}) {
        ...
        ${h ? Xn(_, g, R, void 0, !d, I) : Yn(_, g, R, void 0, !d, I, !1, void 0, a)}`;
        };
        return {
          name: "Conv2DMatMul",
          shaderCache: {
    ...
    (pl = (e) => {
      ...
      (ps = (e, t, n, r, o, i = !1, s = "channelsLast") => {
        ...
        let [p, , f, m, h] = t,
          ...
          T = dn(m, w),
          I = dn(h, v),
          { padInfo: A, outDepth: z, outHeight: M, outWidth: U } = fl(o, u, d, l, b, y, g, $, T, I),
          G = i ? p * c : p,
          B = [0, 0, 0, 0, 0];
        return (
          s === "channelsFirst"
    ...
    (hl = (e, t, n, r, o, i) => {
        ...
        if (n.group !== 1) {
          ...
          if (o) {
            let I =
              ...
              e.compute(pe(t[1], Jn), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
      ...
      (yl = (e, t) => {
        ...
        let o = [0, t.pads[0], 0, t.pads[1]],
          ...
          u = er({ ...t, pads: o, strides: i, dilations: s, kernelShape: a }, r);
      ...
      (ir = class {
        ...
        processTerm(t, n, r, o = -1) {
          let i = r.length,
            ...
            a = [],
            u = 0;
          if (!t.match(RegExp(Bs)) && !n && t !== "") throw new Error("Invalid LHS term");
      ...
      (kl = (e, t, n, r) => {
        let i = e.map((l) => l.length).map((l, c) => S(`input${c}`, t, l)),
          ...
          d = (l) => {
            ...
            n.symbolToInfo.forEach((v, $) => {
              if (n.rhs.symbolToIndices.has($)) {
                ...
                n.lhs.forEach((T, I) => {
                  ...
                  b.push(`for(var ${$}: u32 = 0; ${$} < uniforms.${Ds($)}; ${$}++) {`),
                  y.push("}");
            });
            let w = _
              ? [
            ...
            return `
            ${l
              .registerUniforms(u.map((v) => ({ name: `${Ds(v)}`, type: "u32" })))
...
var Dl,
  ...
  Ws = k(() => {
    ...
    ${s.mainStart(Ye)}
      ...
      (Ls = (e) => {
        e.inputs.length < 2 || x.size(e.inputs[1].dims) === 0 ? Ui(e) : e.compute(Dl(e.inputs));
      });
  });
var Ol,
  Ml,
  ...
  ${c.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
      ...
      (yt = (e, t, n, r, o, i, s, a) => {
        ...
        if (s && x.size(s.dims) > 0) {
          ...
          return (
            ...
            (u = u.reshape([t, r, n, o])),
            n === 1 || r === 1 ? u : e.compute(pe(u, aa.perm), { inputs: [u], outputs: [-1] })[0]
          );
        } else
          return (
      ...
      (da = (e, t) => {
        ...
        let f = yt(e, n.batchSize, n.numHeads, n.kvSequenceLength, n.headSize, o, s, n.hiddenSize),
          m = yt(
            e,
            n.batchSize,
            n.numHeads,
  ...
  `;
      ...
      (fa = (e, t) => {
        ...
        let r = e.inputs[0],
          ...
          [p, f, m] =
            !o && !i ? e.compute(ar([r], c), { inputs: [r], outputs: [-1, -1, -1] }) : [r, o, i],
          h,
          b;
        if (t.doRotary) {
...
var ga,
  ...
  ${b.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      (cc = (e, t, n) => {
        ...
        p = p && r[r.length - 1] !== 1;
        let m = p
            ? e.compute(pe(e.inputs[0], f), { inputs: [e.inputs[0]], outputs: [-1] })[0]
      ...
      (gc = (e, t) => {
        ...
        let T = (I) => {
          let A = w.length,
            ...
            G = [z, M, U],
            B = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
          B && G.push(B);
          let ee = $.length,
          ...
          `;
            ...
            b_dequantized_values = ${
              p === 1
                ? `${Z}(${Array.from({ length: 8 }, (E, L) => `(b_quantized_values[${L}] - ${B ? `zero_point${H}` : "zero_point"}) * scale${H}`).join(", ")});`
...
var pn,
  ...
  Ha = k(() => {
    ...
    (pn = (e) => {
      ...
      (Pa = (e) => `${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`),
      ...
      (Ba = (e, t, n, r) => {
        ...
        return {
          ...
          getShaderSource: (b) => ka(b, s, t.dims.length, i.length, o, u, d, 0, c, p, f, m),
        };
      }),
      (Da = (e) => {
...
${a}`,
        ...
        return (
          fe(t.name), { programInfo: t, computePipeline: l, uniformVariablesInfo: s.variablesInfo }
        );
      }
      ...
      (cp = (e, t, n) => {
        ...
        return (
          ...
          (r +=
            ":" +
            n +
            `:${lp(t, e.shaderCache?.inputDependencies ?? new Array(t.length).fill("dims"))}`),
          r
        );
      }),
      (lr = class {
      ...
      (cr = class {
        ...
        async initialize(t, n) {
          ...
          i("chromium-experimental-timestamp-query-inside-passes") || i("timestamp-query"),
            ...
            (this.adapterInfo = new lr(n.info || (await n.requestAdapterInfo()))),
                ...
                for (let o = 0; o < n.length / 2; o++) {
                  ...
                  if (this.env.webgpu.profiling?.ondata)
                    this.env.webgpu.profiling.ondata({
                      version: 1,
                      inputsMetadata: c.map((y) => ({ dims: y.dims, dataType: Ee(y.dataType) })),
                      outputsMetadata: p.map((y) => ({ dims: y.dims, dataType: Ee(y.dataType) })),
                      kernelId: s,
                      kernelType: u,
                      kernelName: d,
                      programName: l,
    ...
    (mp = (e, t) => {
      ...
      (Pt = async (e, t) => {
        ...
        let i = 0,
          ...
          l = [];
        try {
          if ((([s, u] = await io(t)), t?.externalData && o.mountExternalData)) {
            let w = [];
      ...
      (Bt = async (e, t, n, r, o, i) => {
        ...
        try {
          ...
          for (let B = 0; B < b; B++) await Iu(o[B], w, v, e, c[r[B]], h + r[B], f);
          ...
          for (let B = 0; B < b; B++) {
            ...
            try {
              ...
              let E = s.getValue(D + a * 2, "*"),
                ...
                oe = [];
              for (let ue = 0; ue < L; ue++) oe.push(Number(s.getValue(E + ue * a, se)));
              ...
              if (R === "string") {
                ...
                let ae = ue(Q),
                  Ve = He(H, $e);
                if (Ve === void 0 || !Nt(R)) throw new Error(`Unsupported data type: ${R}`);
                (Z = !0),
                  U.push([
                    R,
                    oe,
                ...
                if (He(H, $e) === void 0 || !Lt(R)) throw new Error(`Unsupported data type: ${R}`);
                if (!ae(e, R, !1))
                  throw new Error(
    ...
    (tt = () => !!ne.wasm.proxy && typeof document < "u"),
      ...
      (gp = (e) => {
        switch (e.data.type) {
          case "init-wasm":
            (_t = !1),
              e.data.err ? ((yn = !0), mr[1](e.data.err)) : ((gn = !0), mr[0]()),
          ...
          if (((_t = !0), tt()))
            return new Promise((e, t) => {
              ve?.terminate(),
                eo().then(([n, r]) => {
                  try {
                    (ve = r), (ve.onerror = (i) => t(i)), (ve.onmessage = gp), (mr = [e, t]);
      ...
      (yp = (e) => {
        switch (e[3]) {
          ...
          case "gpu-buffer": {
            ...
            return Se.fromGpuBuffer(n, { dataType: t, dims: e[1], download: r, dispose: o });
          }
          case "ml-tensor": {
            let t = e[0];
            if (!Lt(t))
            ...
            return Se.fromMLTensor(n, { dataType: t, dims: e[1], download: r, dispose: o });
          }
          default:
    ...
    (Mu = () => {
      ...
      if (
        ...
        if (typeof self < "u" && !self.crossOriginIsolated) ne.wasm.numThreads = 1;
          ...
          let t =
            typeof navigator > "u" ? $n("node:os").cpus().length : navigator.hardwareConcurrency;
