  ...
  It = (e, t, n, o) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let r of Et(t))
        !St.call(e, r) &&
          r !== n &&
          pe(e, r, { get: () => t[r], enumerable: !(o = yt(t, r)) || o.enumerable });
    return e;
  };
    ...
    (De = $ || typeof location > "u" ? void 0 : location.origin),
      ...
      (Lt = () => {
        if (!$) {
          if (Ot) {
            let e = URL;
            return new URL(new e("ort.node.min.mjs", import.meta.url).href, De).href;
          }
...
import { TRACE_EVENT_BEGIN as je, TRACE_EVENT_END as ze } from "onnxruntime-common";
var kt,
  qe,
  Je,
  Y,
    ...
    (kt = (e, t) => {
      ...
      (Ve = async (e, t, n, o, r, a, s = !1) => {
        ...
        try {
          ...
          b === 0 && g(`Can't create tensor for input/output. session=${o}, index=${a}.`),
            t.push(b);
        } finally {
          i.stackRestore(I);
        }
      ...
      (Xe = async (e, t, n, o, r, a) => {
        ...
        try {
          ...
          for (let m = 0; m < I; m++)
            s.setValue(U + m * i, C[m], "*"), s.setValue(P + m * i, f[t[m]], "*");
          for (let m = 0; m < v; m++)
            s.setValue(z + m * i, E[m], "*"), s.setValue(Z + m * i, d[o[m]], "*");
...
import { Tensor as Te, TRACE_FUNC_BEGIN as ct, TRACE_FUNC_END as ft } from "onnxruntime-common";
var lt,
  Nt,
  ce,
  pt = M(() => {
    ...
    (lt = (e, t) => {
      ...
      (Nt = (e) => {
        switch (e[3]) {
          ...
          case "gpu-buffer": {
            ...
            return Te.fromGpuBuffer(n, { dataType: t, dims: e[1], download: o, dispose: r });
          }
          case "ml-tensor": {
            let t = e[0];
            if (!ue(t))
            ...
            return Te.fromMLTensor(n, { dataType: t, dims: e[1], download: o, dispose: r });
          }
          default:
      ...
      (ce = class {
        ...
        async run(t, n, o) {
          ...
          let u = r.map((c, p) => lt(c, () => `input "${this.inputNames[a[p]]}"`)),
            l = s.map((c, p) => (c ? lt(c, () => `output "${this.outputNames[i[p]]}"`) : null)),
...
var dt,
  ...
  bt = M(() => {
    ...
    pt();
    (dt = () => {
      (typeof D.wasm.initTimeout != "number" || D.wasm.initTimeout < 0) && (D.wasm.initTimeout = 0);
      let e = D.wasm.simd;
      if (
        (typeof e != "boolean" &&
          e !== void 0 &&
        ...
        if (typeof self < "u" && !self.crossOriginIsolated) D.wasm.numThreads = 1;
        else {
          let t =
