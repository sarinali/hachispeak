// Wrapper to make espeak-ng work in Chrome extension
(function() {
  var __extensionScriptDir = "";
  try {
    __extensionScriptDir = chrome.runtime.getURL('lib/');
  } catch(e) {
    __extensionScriptDir = "";
  }
  

var ESpeakNG = (() => {
  var _scriptDir = __extensionScriptDir;
...
if (ENVIRONMENT_IS_NODE) {
  ...
  /** @suppress{duplicate} */
  var require = createRequire(__extensionScriptDir);
  ...
  if (ENVIRONMENT_IS_WORKER) {
    ...
    // EXPORT_ES6 + ENVIRONMENT_IS_NODE always requires use of __extensionScriptDir,
    // since there's no way getting the current absolute path of the module when
    // support for that is not available.
    scriptDirectory = require('url').fileURLToPath(new URL('./', __extensionScriptDir)); // includes trailing slash
  }
...
if (Module['locateFile']) {
  ...
  // Use bundler-friendly `new URL(..., __extensionScriptDir)` pattern; works in browsers too.
  wasmBinaryFile = new URL('espeak-ng.wasm', __extensionScriptDir).href;
}
